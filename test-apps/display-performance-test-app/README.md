...
{iModel.filename} (e.g.: "<http://localhost:8080{iModel.key}-tiles/3dft/>" or "<http://localhost:8080/MshX/{iModel.filename}/>"). These will get replaced by the value of iModel.key or just the filename of
 that (no path or extension), correspondingly.
