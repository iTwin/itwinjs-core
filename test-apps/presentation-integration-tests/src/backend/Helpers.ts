...
*--------------------------------------------------------------------------------------------*/
import { Rule, RuleTypes } from "../../../../presentation/common/lib/rules/Rule";
import deepEqual from "deep-equal";
import { PropertyGroupingValue } from "../../../../presentation/common/lib/rules/customization/GroupingRule";
