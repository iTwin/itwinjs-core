  ...
  public provideToolbarButtonItems(
    ...
    if (
      ...
      const getDownstreamButton = ToolbarItemUtilities.createActionButton(
        ...
        IconSpecUtilities.createWebComponentIconSpec(`${IModelApp.publicPath}images/downstream-query.svg`),
      ...
      const getUpstreamButton = ToolbarItemUtilities.createActionButton(
        ...
        IconSpecUtilities.createWebComponentIconSpec(`${IModelApp.publicPath}images/upstream-query.svg`),
      ...
      const groupSpec = ToolbarItemUtilities.createGroupButton(
        ...
        IconSpecUtilities.createWebComponentIconSpec(`${IModelApp.publicPath}images/query-multi.svg`),
