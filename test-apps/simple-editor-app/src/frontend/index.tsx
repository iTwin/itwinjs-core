...
import {
  Config, BrowserAuthorizationCallbackHandler, BrowserAuthorizationClientConfiguration,
  BrowserAuthorizationClient, AccessToken, isBrowserAuthorizationClient, IFrontendAuthorizationClient,
