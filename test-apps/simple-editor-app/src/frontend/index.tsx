...
import {
  ...
  IModelAppOptions, SelectionTool, ViewState, FrontendLoggerCategory, ExternalServerExtensionLoader,
...
export class SampleAppIModelApp {
  ...
  public static startup(opts?: IModelAppOptions): void {
    ...
    IModelApp.extensionAdmin.addExtensionLoader(new ExternalServerExtensionLoader("http://localhost:4000"), 50);
  ...
  public static loggerCategory(obj: any): string {
    ...
    const category = `simple-editor-app.${className}`;
    return category;
  }
  ...
  public static async openIModelAndViews(projectId: string, iModelId: string, viewIdsSelected: Id64String[]) {
    ...
    const iModelConnection = await UiFramework.iModelServices.openIModel(projectId, iModelId, OpenMode.ReadWrite);
  ...
  public static async showIModelIndex(contextId: string, iModelId: string) {
    ...
    if (!currentConnection || (currentConnection.iModelId !== iModelId)) {
      ...
      const iModelConnection = await UiFramework.iModelServices.openIModel(contextId, iModelId, OpenMode.ReadWrite);
      SampleAppIModelApp.setIsIModelLocal(false, true);
