...
export class SampleTool extends PrimitiveTool {
  public static toolId = "SampleTool";
  ...
  // ------------- Enum based picklist ---------------
  private static enumAsPicklistMessage(str: string) { return SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Options." + str); }
  ...
  private static _getEnumAsPicklistDescription = (): PropertyDescription => {
    return {
      ...
      displayLabel: SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Prompts.Options"),
      typename: "enum",
      enum: {
        choices: [
  ...
  private static _getColorDescription = (): PropertyDescription => {
    return {
      ...
      displayLabel: SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Prompts.Color"),
      typename: "number",
      editor: {
        name: "color-picker",
        params: [{
  ...
  private static _getWeightDescription = (): PropertyDescription => {
    return {
      ...
      displayLabel: SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Prompts.Weight"),
      typename: "number",
      editor: {
        name: "weight-picker",
      },
  ...
  private static _getLockToggleDescription = (): PropertyDescription => {
    return {
      ...
      displayLabel: SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Prompts.Lock"),
      typename: "boolean",
      editor: { name: "toggle" },
    };
  }
  ...
  private static _getCityDescription = (): PropertyDescription => {
    return {
      ...
      displayLabel: SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Prompts.City"),
      typename: "string",
    };
  }
  ...
  private static _getStateDescription = (): PropertyDescription => {
    return {
      ...
      displayLabel: SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Prompts.State"),
      typename: "string",
      editor: {
        params: [{
  ...
  private static _getCoordinateDescription = (): PropertyDescription => {
    return {
      ...
      displayLabel: SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Prompts.Coordinate"),
      typename: "string",
    };
  }
  ...
  private static _getStationDescription = (): PropertyDescription => {
    return {
      ...
      displayLabel: SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Prompts.Station"),
      typename: "string",
    };
  }
  ...
  protected provideToolAssistance(): void {
    const mainInstruction = ToolAssistance.createInstruction(ToolAssistanceImage.CursorClick, SampleTool.i18n.translate("uiTestExtension:tools.SampleTool.Prompts.GetPoint"));
