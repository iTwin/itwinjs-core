...
import { DefaultDialogGridContainer, ModalDialogManager } from "@bentley/ui-framework";
import {
  DialogItemsManager, DialogItemValue,
  DialogPropertySyncItem, PropertyDescription,
...
export class UnitsPopup extends React.Component<UnitsPopupProps, UnitsPopupState> {
  ...
  public render(): JSX.Element {
    ...
    return (
      <Dialog
        title={UnitsPopup.i18n.translate("uiTestExtension:StatusBar.Units")}
  ...
  private static _getEnumAsPicklistDescription = (): PropertyDescription => {
    return {
      ...
      displayLabel: UnitsPopup.i18n.translate("uiTestExtension:StatusBar.Units"),
      typename: "enum",
      enum: {
        choices: [
          { label: UnitsPopup.i18n.translate("uiTestExtension:StatusBar.Metric"), value: UnitsOptions.Metric },
          { label: UnitsPopup.i18n.translate("uiTestExtension:StatusBar.Imperial"), value: UnitsOptions.Imperial },
        ],
      },
    };
  }
