...
async function main() {
  ...
  if (process.env.IMJS_GP_BACKEND) {
    rpcParams = { info: { title: "general-purpose-core-backend", version: "v2.0" }, uriPrefix: `https://${undefined === process.env.IMJS_URL_PREFIX ? "" : process.env.IMJS_URL_PREFIX}api.bentley.com` };
  } else {
