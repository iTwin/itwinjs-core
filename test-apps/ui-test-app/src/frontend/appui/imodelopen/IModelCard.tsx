...
export class IModelCard extends React.Component<IModelCardProps, IModelCardState> {
  ...
  private async startRetrieveThumbnail(arg: { iTwinId: string, id: string }) {
    ...
    this.props.iModel.thumbnail = await hubFrontend.hubClient.thumbnails.download((await IModelApp.authorizationClient?.getAccessToken())!, arg.id, { iTwinId: arg.iTwinId, size: "Small" });
