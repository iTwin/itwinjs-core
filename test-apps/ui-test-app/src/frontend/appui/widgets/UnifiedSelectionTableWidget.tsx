...
class UnifiedSelectionTableWidget extends React.PureComponent<UnifiedSelectionTableWidgetProps, UnifiedSelectionTableWidgetState> {
  ...
  private buildContextMenu(args: TableCellContextMenuArgs) {
    ...
    items.push({
      ...
      title: IModelApp.localizationClient.getLocalizedString("SampleApp:table.context-menu.sample-item.description"),
      label: IModelApp.localizationClient.getLocalizedString("SampleApp:table.context-menu.sample-item.label"),
    });
