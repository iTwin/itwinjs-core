...
class UnifiedSelectionTableWidget extends React.PureComponent<UnifiedSelectionTableWidgetProps, UnifiedSelectionTableWidgetState> {
  ...
  private buildContextMenu(args: TableCellContextMenuArgs) {
    ...
    items.push({
      ...
      title: IModelApp.localizationProvider.getLocalizedString("SampleApp:table.context-menu.sample-item.description"),
      label: IModelApp.localizationProvider.getLocalizedString("SampleApp:table.context-menu.sample-item.label"),
    });
