...
function VisibilityTreeComponent(props: VisibilityTreeComponentProps) {
  ...
  const selectLabel = IModelApp.localizationProvider.getLocalizedString("UiFramework:visibilityWidget.options");
  ...
  return (
    <div className="ui-test-app-visibility-widget">
      <SelectableContent defaultSelectedContentId="models-tree" selectAriaLabel={selectLabel}>
        {[{
          id: "models-tree",
          label: IModelApp.localizationProvider.getLocalizedString("UiFramework:visibilityWidget.modeltree"),
        ...
        {
          id: "categories-tree",
          label: IModelApp.localizationProvider.getLocalizedString("UiFramework:visibilityWidget.categories"),
          render: React.useCallback(
