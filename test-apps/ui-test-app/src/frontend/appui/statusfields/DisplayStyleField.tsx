...
export class DisplayStyleField extends React.Component<StatusFieldProps, DisplayStyleFieldState> {
  private _label = IModelApp.localizationClient.getLocalizedString("SampleApp:statusFields.displayStyle.label");
  private _tooltip = IModelApp.localizationClient.getLocalizedString("SampleApp:statusFields.displayStyle.tooltip");
  ...
  private async setStateFromActiveContent(contentControl?: ContentControl): Promise<void> {
    if (contentControl && contentControl.viewport) {
      const unnamedPrefix = IModelApp.localizationClient.getLocalizedString("SampleApp:statusFields.unnamedDisplayStyle");
