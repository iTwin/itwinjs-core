...
export class ComponentExamplesModalFrontstage implements ModalFrontstageInfo {
  public title: string = UiFramework.localizationClient.getLocalizedString("SampleApp:componentExamplesStage.examples");
...
export const ComponentExamplesPage: React.FC<ComponentExamplesPageProps> = (props: ComponentExamplesPageProps) => {
  const themeTitle: string = UiFramework.localizationClient.getLocalizedString("SampleApp:componentExamplesStage.themeTitle");
  const themeDescription: string = UiFramework.localizationClient.getLocalizedString("SampleApp:componentExamplesStage.themeDescription");
  ...
  const darkLabel = UiFramework.localizationClient.getLocalizedString("SampleApp:settingsStage.dark");
  const lightLabel = UiFramework.localizationClient.getLocalizedString("SampleApp:settingsStage.light");
