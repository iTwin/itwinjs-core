...
export class ComponentExamplesModalFrontstage implements ModalFrontstageInfo {
  public title: string = UiFramework.localizationProvider.getLocalizedString("SampleApp:componentExamplesStage.examples");
...
export const ComponentExamplesPage: React.FC<ComponentExamplesPageProps> = (props: ComponentExamplesPageProps) => {
  const themeTitle: string = UiFramework.localizationProvider.getLocalizedString("SampleApp:componentExamplesStage.themeTitle");
  const themeDescription: string = UiFramework.localizationProvider.getLocalizedString("SampleApp:componentExamplesStage.themeDescription");
  ...
  const darkLabel = UiFramework.localizationProvider.getLocalizedString("SampleApp:settingsStage.dark");
  const lightLabel = UiFramework.localizationProvider.getLocalizedString("SampleApp:settingsStage.light");
