          ...
          <Zone
            ...
            widgets={[
              ...
              <Widget id={MapLayersWidgetControl.id} label={MapLayersWidgetControl.label}
                ...
                applicationData={{ showEsriOAuthSettings:true, hideExternalMapLayers: false, mapTypeOptions: { supportTileUrl: true, supportWmsAuthentication: true }, fetchPublicMapLayerSources: true }} />,
