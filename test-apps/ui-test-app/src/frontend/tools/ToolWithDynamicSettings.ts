...
export class ToolWithDynamicSettings extends PrimitiveTool {
  ...
  private static enumAsPicklistMessage(str: string) { return IModelApp.localizationClient.getLocalizedString(`SampleApp:tools.ToolWithDynamicSettings.State.${str}`); }
  private static getStateDescription(): PropertyDescription {
    return {
      name: this._statePropertyName,
      displayLabel: IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithDynamicSettings.Prompts.State"),
      typename: "enum",
      enum: {
        choices: [
  ...
  private static getCityDescription(stateId: number): PropertyDescription {
    ...
    return {
      ...
      displayLabel: IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithDynamicSettings.Prompts.City"),
      typename: "enum",
      enum: {
  ...
  protected provideToolAssistance(): void {
    const mainInstruction = ToolAssistance.createInstruction(ToolAssistanceImage.CursorClick, IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithDynamicSettings.Prompts.GetPoint"));
