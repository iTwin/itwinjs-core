...
class PointOnePopupSettingsProvider extends DialogLayoutDataProvider {
  // ------------- Weight ---------------
  public weightProperty = new DialogProperty<number>(PropertyDescriptionHelper.buildWeightPickerDescription("weight", IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.Weight")), 3);
...
class PointTwoPopupSettingsProvider extends DialogLayoutDataProvider {
  ...
  public sourceProperty = new DialogProperty<string>(
    PropertyDescriptionHelper.buildTextEditorDescription("source", IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.Source")),
    "unknown", undefined);
...
export class ToolWithSettings extends PrimitiveTool {
  ...
  // ------------- Color Enum ---------------
  private enumAsPicklistMessage(str: string) { return IModelApp.localizationClient.getLocalizedString(`SampleApp:tools.ToolWithSettings.Options.${str}`); }
  ...
  public get colorOptionProperty() {
    if (!this._colorOptionProperty)
      this._colorOptionProperty = new DialogProperty<number>(PropertyDescriptionHelper.buildEnumPicklistEditorDescription(
        "colorOption", IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.Color"), this.getColorChoices()), ToolOptions.Blue as number);
  ...
  public get colorPickerProperty() {
    if (!this._colorPickerProperty)
      this._colorPickerProperty = new DialogProperty<number>(PropertyDescriptionHelper.buildColorPickerDescription("color", IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.Color"),
  ...
  public get lockProperty() {
    if (!this._lockProperty)
      this._lockProperty = new DialogProperty<boolean>(PropertyDescriptionHelper.buildToggleDescription("lockToggle",
        IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.Lock")), true, undefined, false);
  ...
  public get cityProperty() {
    if (!this._cityProperty)
      this._cityProperty = new DialogProperty<string>(PropertyDescriptionHelper.buildTextEditorDescription("city",
        IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.City")), "Exton", undefined);
  ...
  public get stateProperty() {
    if (!this._stateProperty)
      this._stateProperty = new DialogProperty<string>(
        PropertyDescriptionHelper.buildTextEditorDescription("state", IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.State"),
          [
            {
  ...
  public get coordinateProperty() {
    if (!this._coordinateProperty)
      this._coordinateProperty = new DialogProperty<string>(
        PropertyDescriptionHelper.buildTextEditorDescription("coordinate", IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.Coordinate")),
  ...
  public get numberProperty() {
    if (!this._numberProperty)
      this._numberProperty = new DialogProperty<number>(
        PropertyDescriptionHelper.buildNumberEditorDescription("numberVal", IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.Number"),
          {
  ...
  public get stationProperty() {
    if (!this._stationProperty)
      this._stationProperty = new DialogProperty<string>(
        PropertyDescriptionHelper.buildTextEditorDescription("station", IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.Station")),
  ...
  protected provideToolAssistance(): void {
    const mainInstruction = ToolAssistance.createInstruction(ToolAssistanceImage.CursorClick, IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.GetPoint"));
  ...
  public override async onKeyTransition(wentDown: boolean, keyEvent: KeyboardEvent): Promise<EventHandled> {
    if (wentDown && keyEvent.key === "1") {
      ...
      this.colorOptionProperty.description = PropertyDescriptionHelper.buildEnumPicklistEditorDescription("colorOption",
        IModelApp.localizationClient.getLocalizedString("SampleApp:tools.ToolWithSettings.Prompts.Color"), this.getColorChoices());
