    ...
    return (
      <div className={containerClassName}>
        <div className={className}>
          {IModelApp.localizationProvider.getLocalizedString("SampleApp:tools.AnalysisAnimation.ToolSettings.duration")}
          ...
          {IModelApp.localizationProvider.getLocalizedString("SampleApp:tools.AnalysisAnimation.ToolSettings.seconds")}
        </div>
        <div className={className}>
          <input id="animationLoop" type="checkbox" checked={this.state.isLooping} onChange={this._handleLoopChange} />
          {IModelApp.localizationProvider.getLocalizedString("SampleApp:tools.AnalysisAnimation.ToolSettings.loop")}
        </div>
                ...
                items={
                  <>
                    <Item
                      ...
                      title={IModelApp.localizationProvider.getLocalizedString("SampleApp:tools.AnalysisAnimation.ToolSettings.play")}
                      key="animationPlay"
                    ...
                    <Item
                      ...
                      title={IModelApp.localizationProvider.getLocalizedString("SampleApp:tools.AnalysisAnimation.ToolSettings.pause")}
                      key="animationPause"
                    ...
                    <Item
                      ...
                      title={IModelApp.localizationProvider.getLocalizedString("SampleApp:tools.AnalysisAnimation.ToolSettings.stop")}
                      key="animationStop"
