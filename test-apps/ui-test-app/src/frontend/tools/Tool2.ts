...
export class Tool2 extends PrimitiveTool {
  ...
  protected provideToolAssistance(): void {
    const mainInstruction = ToolAssistance.createInstruction(ToolAssistanceImage.CursorClick, IModelApp.localizationClient.getLocalizedString("SampleApp:tools.Tool2.Prompts.GetPoint"));
