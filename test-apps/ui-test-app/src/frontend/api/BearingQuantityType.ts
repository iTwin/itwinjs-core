...
import { CheckboxFormatPropEditorSpec, CustomFormatPropEditorSpec, CustomQuantityTypeDefinition, IModelApp, TextSelectFormatPropEditorSpec } from "@bentley/imodeljs-frontend";
import {
...
export class BearingQuantityType implements CustomQuantityTypeDefinition {
    ...
    return [
      {
        editorType: "select",
        selectOptions: [
          { value: "clockwise", label: IModelApp.localizationProvider.getLocalizedString("SampleApp:BearingQuantityType.bearingAngleDirection.clockwise") },
          { value: "counter-clockwise", label: IModelApp.localizationProvider.getLocalizedString("SampleApp:BearingQuantityType.bearingAngleDirection.counter-clockwise") },
        ],
        label: IModelApp.localizationProvider.getLocalizedString("SampleApp:BearingQuantityType.bearingAngleDirection.label"),
  ...
  public get primaryPropEditorSpecs(): CustomFormatPropEditorSpec[] {
    return [
      {
        editorType: "checkbox",
        label: IModelApp.localizationProvider.getLocalizedString("SampleApp:BearingQuantityType.bearingGap.label"),
