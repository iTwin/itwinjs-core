...
* `dta link imodel` - Adds a linked IModelConnection to be displayed in the active viewport. It opens a file open dialog from which you can select the iModel. All of the 3d models in the secondary iModel will be displayed in the viewport.
* `dta unlink imodels` - Remove any iModels linked by `dta link imodel` from the view.
