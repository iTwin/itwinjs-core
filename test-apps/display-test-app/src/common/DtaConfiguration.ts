...
export interface DtaStringConfiguration {
  ...
  mapLayerAuthHeader?: string; // default is undefined; a "Header-Name=value" pair injected into every map-layer request via a map-layer fetch handler. See README.md.
  mapLayerAuthQueryParams?: string; // default is undefined; comma-separated "name=value" pairs injected into every map-layer request via a map-layer fetch handler. See README.md.
