...
export class PlaceLineStringTool extends CreateElementTool {
  ...
  public static commandConnection = EditTools.connect<BasicManipulationCommandIpc>();
    ...
    try {
      ...
      if (this._testGeomJson) {
        ...
        if (this._testGeomParts) {
          ...
          const partId = await PlaceLineStringTool.commandConnection.insertGeometryPart(partProps);
        ...
        await PlaceLineStringTool.commandConnection.insertGeometricElement(elemProps);
        ...
        if (this._testGeomParts) {
          ...
          const partId = await PlaceLineStringTool.commandConnection.insertGeometryPart(partProps, { entryArray: partBuilder.entries });
        ...
        await PlaceLineStringTool.commandConnection.insertGeometricElement(elemProps, { entryArray: builder.entries });
        await this.saveChanges();
      }
    } catch (err: any) {
