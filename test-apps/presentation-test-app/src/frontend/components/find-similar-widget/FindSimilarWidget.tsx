    ...
    return (
      <div className="find-similar-widget">
        <div className="find-similar-header">
          <h3>{IModelApp.localizationProvider.getLocalizedString("Sample:controls.find-similar.results")}</h3>
          <button onClick={this._onDismissClicked}>
            {IModelApp.localizationProvider.getLocalizedString("Sample:controls.find-similar.dismiss-button.label")}
          </button>
        </div>
