...
export const loggerCategory = "Extensions.GeoPhoto";
...
/**
 * Information that is used by the geo-photo extension, and stored in the metadata of the panorama jpg files.
