...
class SectionLocation extends Marker implements PopupToolbarProvider {
  ...
  public toolbarProps: AbstractToolbarProps = {
    items: [
      { id: "toggle_section", itemPriority: 10, label: HyperModelingExtension.extension!.i18n.translate("HyperModeling:Message.ToggleSection"), icon: "icon-section-tool", badgeType: BadgeType.None, execute: () => { } },
      { id: "align_view", itemPriority: 20, label: HyperModelingExtension.extension!.i18n.translate("HyperModeling:Message.AlignSection"), icon: "icon-image", badgeType: BadgeType.None, execute: () => { } },
      { id: "open_section", itemPriority: 30, label: HyperModelingExtension.extension!.i18n.translate("HyperModeling:Message.OpenSection"), icon: "icon-import", badgeType: BadgeType.None, execute: () => { } },
    ],
  };
...
export class SectionLocationSetDecoration {
  ...
  private getMarkerTitle(props: SectionLocationProps): string {
    ...
    switch (props.sectionType) {
      case SectionType.Detail:
        return HyperModelingExtension.extension!.i18n.translate("HyperModeling:Message.DetailCallout");
      case SectionType.Elevation:
        return HyperModelingExtension.extension!.i18n.translate("HyperModeling:Message.ElevationCallout");
      case SectionType.Plan:
        return HyperModelingExtension.extension!.i18n.translate("HyperModeling:Message.PlanCallout");
      default:
        return HyperModelingExtension.extension!.i18n.translate("HyperModeling:Message.SectionCallout");
    }
  }
  ...
  private setMarkerVisibility(vp: Viewport): boolean {
    ...
    if (!SectionLocationSetDecoration.props.display.selectedOnly) {
      if (!haveVisibleCategory) {
        const msg = HyperModelingExtension.extension!.i18n.translate("HyperModeling:Error.NotFoundCategories");
        ...
        const msg = HyperModelingExtension.extension!.i18n.translate("HyperModeling:Error.NotFoundTypes");
        IModelApp.notifications.outputMessage(new NotifyMessageDetails(OutputMessagePriority.Info, msg, undefined, OutputMessageType.Toast));
      }
    }
  ...
  public static async show(vp: ScreenViewport, sync: boolean, update: boolean): Promise<void> {
    ...
    if (undefined === secLocPropList || 0 === secLocPropList.length) {
      const msg = HyperModelingExtension.extension.i18n.translate("HyperModeling:Error.NotFoundModels");
