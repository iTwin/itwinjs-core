...
export class SampleTool extends PrimitiveTool {
  ...
  protected provideToolAssistance(): void {
    const mainInstruction = ToolAssistance.createInstruction(ToolAssistanceImage.CursorClick, SampleTool.i18n.translate("dialogItemsSample:tools.SampleTool.Prompts.GetPoint"));
