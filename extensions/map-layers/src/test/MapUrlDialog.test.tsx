...
// import { ArcGisOAuth2Endpoint } from "../auth/ArcGisOAuth2Endpoint";
...
//     let endPoint: ArcGisOAuth2Endpoint | undefined;
//     if (authMethod === MapLayerAuthType.EsriOAuth2) {
//       endPoint = new ArcGisOAuth2Endpoint("https://test.com/authorize", false);
//     }
...
//     const expire = 3600;
//     const esriOAuth2InitStatus = EsriOAuth2.initialize(redirectUrl, expire);
//     EsriOAuth2.arcGisOnlineClientId = fakeClientId;
//     EsriOAuth2.setEnterpriseClientId(authorizeUrl, fakeClientId);
