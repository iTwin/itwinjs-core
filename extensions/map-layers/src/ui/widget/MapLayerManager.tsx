...
export function MapLayerManager(props: MapLayerManagerProps) {
  ...
  const [overlaysLabel] = React.useState(MapLayersUiItemsProvider.localizationProvider.getLocalizedString("mapLayers:Widget.OverlayLayers"));
  const [underlaysLabel] = React.useState(MapLayersUiItemsProvider.localizationProvider.getLocalizedString("mapLayers:Widget.BackgroundLayers"));
  ...
  */
    ...
    switch (action) {
      ...
      case "zoom-to-layer":
        activeViewport.displayStyle.viewMapLayerRange(indexInDisplayStyle, mapLayerSettings.isOverlay, activeViewport).then((status) => {
          if (!status) {
            const msg = MapLayersUiItemsProvider.localizationProvider.getLocalizedString("mapLayers:Messages.NoRangeDefined");
  ...
  const [baseMapPanelLabel] = React.useState(MapLayersUiItemsProvider.localizationProvider.getLocalizedString("mapLayers:Basemap.BaseMapPanelTitle"));
