...
export function MapLayerManager(props: MapLayerManagerProps) {
  ...
  const [overlaysLabel] = React.useState(MapLayersUiItemsProvider.localizationClient.getLocalizedString("mapLayers:Widget.OverlayLayers"));
  const [underlaysLabel] = React.useState(MapLayersUiItemsProvider.localizationClient.getLocalizedString("mapLayers:Widget.BackgroundLayers"));
  ...
  */
    ...
    switch (action) {
      ...
      case "zoom-to-layer":
        activeViewport.displayStyle.viewMapLayerRange(indexInDisplayStyle, mapLayerSettings.isOverlay, activeViewport).then((status) => {
          if (!status) {
            const msg = MapLayersUiItemsProvider.localizationClient.getLocalizedString("mapLayers:Messages.NoRangeDefined");
  ...
  const [baseMapPanelLabel] = React.useState(MapLayersUiItemsProvider.localizationClient.getLocalizedString("mapLayers:Basemap.BaseMapPanelTitle"));
