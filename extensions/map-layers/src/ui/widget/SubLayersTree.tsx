...
export function SubLayersPanel({ mapLayer, viewport }: { mapLayer: StyleMapLayerSettings, viewport: ScreenViewport | undefined }) {
  const [noneAvailableLabel] = React.useState(MapLayersUiItemsProvider.localizationProvider.getLocalizedString("mapLayers:SubLayers.NoSubLayers"));
...
export function SubLayersTree(props: { mapLayer: StyleMapLayerSettings }) {
  const [placeholderLabel] = React.useState(MapLayersUiItemsProvider.localizationProvider.getLocalizedString("mapLayers:SubLayers.SearchPlaceholder"));
  const [allOnLabel] = React.useState(MapLayersUiItemsProvider.localizationProvider.getLocalizedString("mapLayers:SubLayers.AllOn"));
  const [allOffLabel] = React.useState(MapLayersUiItemsProvider.localizationProvider.getLocalizedString("mapLayers:SubLayers.AllOff"));
