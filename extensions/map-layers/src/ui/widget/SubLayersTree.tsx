...
export function SubLayersPanel({ mapLayer, viewport }: { mapLayer: StyleMapLayerSettings, viewport: ScreenViewport | undefined }) {
  const [noneAvailableLabel] = React.useState(MapLayersUiItemsProvider.localizationClient.getLocalizedString("mapLayers:SubLayers.NoSubLayers"));
...
export function SubLayersTree(props: { mapLayer: StyleMapLayerSettings }) {
  const [placeholderLabel] = React.useState(MapLayersUiItemsProvider.localizationClient.getLocalizedString("mapLayers:SubLayers.SearchPlaceholder"));
  const [allOnLabel] = React.useState(MapLayersUiItemsProvider.localizationClient.getLocalizedString("mapLayers:SubLayers.AllOn"));
  const [allOffLabel] = React.useState(MapLayersUiItemsProvider.localizationClient.getLocalizedString("mapLayers:SubLayers.AllOff"));
