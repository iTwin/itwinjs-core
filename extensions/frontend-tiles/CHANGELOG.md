...
This log was last generated on Tue, 02 Dec 2025 16:14:15 GMT and should not be manually modified.

## 5.4.0
Tue, 02 Dec 2025 16:14:15 GMT
...
- support imodel draping
- Allow passing number of exports to createGraphicRepresentationsQueryUrl
- Update GraphicRepresentationFormat and GraphicRepresentationStatus to reflect Mesh Export API docs. Change GraphicRepresentationStatus from an enum to a string literal type. Change GraphicRepresentation from type to interface.
- Upgrade compile target to ES2023 and module to ES2022
- change frontend-tiles to pure esm
