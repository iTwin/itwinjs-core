...
export namespace esriPBuffer {
  export class FeatureCollectionPBuffer extends pb_1.Message {
    ...
    get queryResult() {
      return pb_1.Message.getWrapperField(
        ...
        2
      ) as FeatureCollectionPBuffer.QueryResult;
    }
  ...
  export namespace FeatureCollectionPBuffer {
    ...
    export class SpatialReference extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.wkid != 0) writer.writeUint32(1, this.wkid);
        if (this.lastestWkid != 0) writer.writeUint32(2, this.lastestWkid);
        if (this.vcsWkid != 0) writer.writeUint32(3, this.vcsWkid);
        if (this.latestVcsWkid != 0) writer.writeUint32(4, this.latestVcsWkid);
    ...
    export class Field extends pb_1.Message {
      ...
      get fieldType() {
        ...
        ) as FeatureCollectionPBuffer.FieldType;
      }
      ...
      get sqlType() {
        return pb_1.Message.getFieldWithDefault(
          this,
          4,
          FeatureCollectionPBuffer.SQLType.sqlTypeBigInt
        ) as FeatureCollectionPBuffer.SQLType;
      }
    ...
    export class Value extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_float_value) writer.writeFloat(2, this.float_value);
        if (this.has_double_value) writer.writeDouble(3, this.double_value);
        if (this.has_sint_value) writer.writeSint32(4, this.sint_value);
        if (this.has_uint_value) writer.writeUint32(5, this.uint_value);
        if (this.has_int64_value) writer.writeInt64(6, this.int64_value);
        if (this.has_uint64_value) writer.writeUint64(7, this.uint64_value);
        if (this.has_sint64_value) writer.writeSint64(8, this.sint64_value);
        if (this.has_bool_value) writer.writeBool(9, this.bool_value);
        if (!w) return writer.getResultBuffer();
      }
    ...
    export class Geometry extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.lengths.length) writer.writePackedUint32(2, this.lengths);
        if (this.coords.length) writer.writePackedSint64(3, this.coords);
        if (!w) return writer.getResultBuffer();
      }
    ...
    export class esriShapeBuffer extends pb_1.Message {
      ...
      static fromObject(data: { bytes?: Uint8Array }): esriShapeBuffer {
    ...
    export class Feature extends pb_1.Message {
      ...
      get attributes() {
        return pb_1.Message.getRepeatedWrapperField(
          ...
          1
        ) as FeatureCollectionPBuffer.Value[];
      }
            ...
            case 1:
              reader.readMessage(message.attributes, () =>
                pb_1.Message.addToRepeatedWrapperField(
                  message,
                  1,
                  FeatureCollectionPBuffer.Value.deserialize(reader),
                  FeatureCollectionPBuffer.Value
                )
              );
              break;
    ...
    export class ServerGens extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.minServerGen != 0) writer.writeUint64(1, this.minServerGen);
        if (this.serverGen != 0) writer.writeUint64(2, this.serverGen);
        if (!w) return writer.getResultBuffer();
      }
    ...
    export class Scale extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.xScale != 0) writer.writeDouble(1, this.xScale);
        if (this.yScale != 0) writer.writeDouble(2, this.yScale);
        if (this.mScale != 0) writer.writeDouble(3, this.mScale);
        if (this.zScale != 0) writer.writeDouble(4, this.zScale);
        if (!w) return writer.getResultBuffer();
      }
    ...
    export class Translate extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.xTranslate != 0) writer.writeDouble(1, this.xTranslate);
        if (this.yTranslate != 0) writer.writeDouble(2, this.yTranslate);
        if (this.mTranslate != 0) writer.writeDouble(3, this.mTranslate);
        if (this.zTranslate != 0) writer.writeDouble(4, this.zTranslate);
        if (!w) return writer.getResultBuffer();
      }
    ...
    export class Transform extends pb_1.Message {
      ...
      get translate() {
        return pb_1.Message.getWrapperField(
          ...
          3
        ) as FeatureCollectionPBuffer.Translate;
      }
    ...
    export class FeatureResult extends pb_1.Message {
      ...
      get uniqueIdField() {
        return pb_1.Message.getWrapperField(
          ...
          2
        ) as FeatureCollectionPBuffer.UniqueIdField;
      }
      ...
      get serverGens() {
        return pb_1.Message.getWrapperField(
          ...
          6
        ) as FeatureCollectionPBuffer.ServerGens;
      }
      ...
      get geometryType() {
        ...
        ) as FeatureCollectionPBuffer.GeometryType;
      }
      ...
      get spatialReference() {
        return pb_1.Message.getWrapperField(
          ...
          8
        ) as FeatureCollectionPBuffer.SpatialReference;
      }
      ...
      get transform() {
        return pb_1.Message.getWrapperField(
          ...
          12
        ) as FeatureCollectionPBuffer.Transform;
      }
      ...
      get fields() {
        return pb_1.Message.getRepeatedWrapperField(
          ...
          13
        ) as FeatureCollectionPBuffer.Field[];
      }
      ...
      get features() {
        return pb_1.Message.getRepeatedWrapperField(
          ...
          15
        ) as FeatureCollectionPBuffer.Feature[];
      }
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            ...
            case 13:
              reader.readMessage(message.fields, () =>
                pb_1.Message.addToRepeatedWrapperField(
                  message,
                  13,
                  FeatureCollectionPBuffer.Field.deserialize(reader),
                  FeatureCollectionPBuffer.Field
                )
              );
              break;
            case 14:
              ...
              break;
            case 15:
              reader.readMessage(message.features, () =>
                pb_1.Message.addToRepeatedWrapperField(
                  message,
                  15,
                  FeatureCollectionPBuffer.Feature.deserialize(reader),
                  FeatureCollectionPBuffer.Feature
                )
              );
              break;
    ...
    export class CountResult extends pb_1.Message {
      ...
      static fromObject(data: { count?: number }): CountResult {
