...
export class PhillyLandmarksDataset {
              ...
              attributes: [
                ...
                },
                {
                  value: {
                    valueFormat: 0,
                    value:
                      "Installing high friction surfaces on top of existing roadway to decrease the number of crashes along high crash roadway curves",
                    displayValue:
                      "Installing high friction surfaces on top of existing roadway to decrease the number of crashes along high crash roadway curves",
                  },
                  property: {
  ...
  public static phillyTransportationGetFeatureInfoQueryJson = {
    objectIdFieldName: "OBJECTID",
    uniqueIdField: { name: "OBJECTID", isSystemMaintained: true },
    globalIdFieldName: "GlobalID",
    serverGens: { minServerGen: 617056, serverGen: 705029 },
    geometryType: "esriGeometryPoint",
    spatialReference: { wkid: 102100, latestWkid: 3857 },
    transform: { originPosition: "upperLeft", scale: [2.3886571335751796, 2.3886571335751796], translate: [-8365268.374365235, 4860172.005808106] },
    fields: [
      { name: "OBJECTID", type: "esriFieldTypeOID", alias: "OBJECTID", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      {
        name: "GISDATAPROJECT_LOCATION_DETAIL_",
        type: "esriFieldTypeInteger",
        alias: "GISDATAPROJECT_LOCATION_DETAIL_PTFID",
        sqlType: "sqlTypeInteger",
        domain: null,
        defaultValue: null,
      },
      { name: "PROJECT_ID", type: "esriFieldTypeInteger", alias: "PROJECT_ID", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      {
        name: "PROJECT_TITLE",
      ...
      },
      {
        name: "PROJECT_IMPROVEMENT_DESC",
        type: "esriFieldTypeString",
        alias: "PROJECT_IMPROVEMENT_DESC",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      ...
      },
      {
        name: "PLANNING_PARTNER_SHORT_NAME",
        type: "esriFieldTypeString",
        alias: "PLANNING_PARTNER_SHORT_NAME",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      ...
      },
      {
        name: "PRIMARY_LOCAL_ROAD_NUMBER",
        type: "esriFieldTypeSmallInteger",
        alias: "PRIMARY_LOCAL_ROAD_NUMBER",
        sqlType: "sqlTypeSmallInt",
        domain: null,
        defaultValue: null,
      },
      ...
      },
      {
        name: "PROJECT_STATUS_CODE_DESC",
        type: "esriFieldTypeString",
        alias: "PROJECT_STATUS_CODE_DESC",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      },
      { name: "CODE_ID", type: "esriFieldTypeSmallInteger", alias: "CODE_ID", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      {
        name: "POTENTIAL_COMMITTED_DATE_FLAG",
        type: "esriFieldTypeString",
      ...
      },
      {
        name: "POTENTIAL_COMMITTED_YEAR",
        type: "esriFieldTypeString",
        alias: "POTENTIAL_COMMITTED_YEAR",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      },
      {
        name: "POTENTIAL_COMMITTED_DATE",
        type: "esriFieldTypeString",
        alias: "POTENTIAL_COMMITTED_DATE",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      },
      {
        name: "EST_CONSTR_PHASE_COST_AMOUNT",
        type: "esriFieldTypeSingle",
        alias: "EST_CONSTR_PHASE_COST_AMOUNT",
        sqlType: "sqlTypeReal",
        domain: null,
        defaultValue: null,
      },
      ...
      { name: "NTP_DATE", type: "esriFieldTypeInteger", alias: "NTP_DATE", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      {
        name: "COMPLETION_FLAG",
        type: "esriFieldTypeString",
      ...
      },
      {
        name: "PROJECT_MANAGER_CONTACT_NAME",
        type: "esriFieldTypeString",
        alias: "PROJECT_MANAGER_CONTACT_NAME",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      ...
      },
      {
        name: "CAPTIAL_BUDGET_REQUIRED_FLAG",
        type: "esriFieldTypeString",
        alias: "CAPTIAL_BUDGET_REQUIRED_FLAG",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      ...
      },
      {
        name: "RESPONSIBLE_DISTRICT_NAME",
        type: "esriFieldTypeString",
        alias: "RESPONSIBLE_DISTRICT_NAME",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      ...
      { name: "DOI_ID", type: "esriFieldTypeString", alias: "DOI_ID", sqlType: "sqlTypeNVarchar", length: 4000, domain: null, defaultValue: null },
      {
        name: "PRIMARY_PROJECT_ID",
        type: "esriFieldTypeInteger",
        alias: "PRIMARY_PROJECT_ID",
        sqlType: "sqlTypeInteger",
        domain: null,
        defaultValue: null,
      },
      ...
      },
      {
        name: "HAS_PLAN_RESEARCH_ADMIN_PHASE",
        type: "esriFieldTypeString",
        alias: "HAS_PLAN_RESEARCH_ADMIN_PHASE",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      ...
      },
      {
        name: "HAS_UTILITY_PHASE",
        type: "esriFieldTypeString",
        alias: "HAS_UTILITY_PHASE",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      },
      { name: "CTY_CODE", type: "esriFieldTypeSmallInteger", alias: "CTY_CODE", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      { name: "ST_RT_NO", type: "esriFieldTypeSmallInteger", alias: "ST_RT_NO", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      { name: "JURIS", type: "esriFieldTypeSmallInteger", alias: "JURIS", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      { name: "DISTRICT_NO", type: "esriFieldTypeSmallInteger", alias: "DISTRICT_NO", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      { name: "SEG_BGN", type: "esriFieldTypeSmallInteger", alias: "SEG_BGN", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      { name: "OFFSET_BGN", type: "esriFieldTypeSmallInteger", alias: "OFFSET_BGN", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      { name: "SEG_END", type: "esriFieldTypeSmallInteger", alias: "SEG_END", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      { name: "OFFSET_END", type: "esriFieldTypeSmallInteger", alias: "OFFSET_END", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      { name: "SEG_PT_BGN", type: "esriFieldTypeInteger", alias: "SEG_PT_BGN", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      { name: "SEG_PT_END", type: "esriFieldTypeInteger", alias: "SEG_PT_END", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      { name: "SEG_LNGTH_FEET", type: "esriFieldTypeInteger", alias: "SEG_LNGTH_FEET", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      { name: "NLF_ID", type: "esriFieldTypeInteger", alias: "NLF_ID", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      { name: "SIDE_IND", type: "esriFieldTypeSmallInteger", alias: "SIDE_IND", sqlType: "sqlTypeSmallInt", domain: null, defaultValue: null },
      { name: "NLF_CNTL_BGN", type: "esriFieldTypeInteger", alias: "NLF_CNTL_BGN", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      { name: "NLF_CNTL_END", type: "esriFieldTypeInteger", alias: "NLF_CNTL_END", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      { name: "CUM_OFFSET_BGN", type: "esriFieldTypeInteger", alias: "CUM_OFFSET_BGN", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      { name: "CUM_OFFSET_END", type: "esriFieldTypeInteger", alias: "CUM_OFFSET_END", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      {
        name: "COUNTY_MUNICIPALITY_CODES",
        type: "esriFieldTypeString",
        alias: "COUNTY_MUNICIPALITY_CODES",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      ...
      },
      {
        name: "BRIDGE_WORK_FLAG",
        type: "esriFieldTypeString",
        alias: "BRIDGE_WORK_FLAG",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      },
      { name: "RECORD_UPDATE", type: "esriFieldTypeInteger", alias: "RECORD_UPDATE", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      {
        name: "CREATED_DATE",
        type: "esriFieldTypeDate",
        alias: "CREATED_DATE",
      ...
      { name: "GEOM_LENGTH_FT", type: "esriFieldTypeInteger", alias: "GEOM_LENGTH_FT", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      {
        name: "GEOMETRY_TYPE",
        type: "esriFieldTypeString",
        alias: "GEOMETRY_TYPE",
      ...
      },
      {
        name: "BRIDGE_WORK_LOCATION_FLAG",
        type: "esriFieldTypeString",
        alias: "BRIDGE_WORK_LOCATION_FLAG",
        sqlType: "sqlTypeNVarchar",
        length: 4000,
        domain: null,
        defaultValue: null,
      ...
      },
      {
        name: "GIS_GEOMETRY_UPDATE_DATE",
        type: "esriFieldTypeDate",
        alias: "GIS_GEOMETRY_UPDATE_DATE",
        sqlType: "sqlTypeTimestamp2",
        length: 8,
        domain: null,
        defaultValue: null,
      ...
      { name: "GPID", type: "esriFieldTypeInteger", alias: "GPID", sqlType: "sqlTypeInteger", domain: null, defaultValue: null },
      { name: "GlobalID", type: "esriFieldTypeGlobalID", alias: "GlobalID", sqlType: "sqlTypeOther", length: 38, domain: null },
    ],
    features: [{
      attributes: {
        OBJECTID: 1320,
        GISDATAPROJECT_LOCATION_DETAIL_: 974725878,
        PROJECT_ID: 102572,
        PROJECT_TITLE: "High Friction Surfaces(F)",
        PROJECT_STATUS: "CAND",
        PROJECT_CLASS: "SAFE",
        PROJECT_CLASS_NAME: "Safety Improvement",
        PROJECT_IMPROVEMENT_DESC:
          "Installing high friction surfaces on top of existing roadway to decrease the number of crashes along high crash roadway curves",
        PROJECT_SHORT_NARRATIVE: "High Friction Surfaces  Various high-crash roadway curves in D6-0  Treatmnt to reduce crashes on rdwy curves",
        IMPROVEMENT_TYPE: "Surface Treatment",
        IMPROVEMENT_CODE: 37,
        IMPROVEMENT_SHORT_DESC: "Surface Treatment",
        TYP_FRST_APR_DT: 1399939200000,
        MAJOR_PROJECT_FLAG: "N",
        TRANSPORT_MODE: "H",
        PLANNING_PARTNER_SHORT_NAME: "DVRPC",
        RESPONSIBLE_DISTRICT_NO: 6,
        PRIMARY_ST_RT_NO: 3033,
        DISTRICT_SECTION_ID: "HFS",
        PRIMARY_LOCAL_ROAD_NUMBER: 0,
        ...
        POTENTIAL_COMMITTED_DATE: "6/12/2014 12:00:00 AM",
        EST_CONSTR_PHASE_COST_AMOUNT: 2445000,
        TYP_FLAG: "N",
        TIP_FLAG: "N",
        STIP_FLAG: "N",
        DECADE_OF_INVESTMENT_FLAG: "N",
        TIP_PROPOSED_FLAG: "N",
        TYP_PROPOSED_FLAG: "N",
        OBLIGATION_PLAN_FLAG: "Y",
        LET_FLAG: "A",
        LET_DATE: "20140703",
        LET_DATE_DISPLAY: "7/3/2014 12:00:00 AM",
        OPEN_FLAG: null,
        OPEN_DATE: null,
        NTP_FLAG: "A",
        NTP_DATE: 20140818,
        COMPLETION_FLAG: "A",
        COMPLETION_DATE: "20151007",
        FISCALLY_READY: null,
        FISCAL_DATE: null,
        PHYSICALLY_READY: null,
        PHYSICAL_DATE: null,
        PROJECT_MANAGER_CONTACT_NAME: "George Dunheimer ADE CONSTR",
        PROJECT_MANAGER_PHONE: "6102056680",
        PROJECT_MANAGER_EMAIL: "gdunheimer@pa.gov",
        UNDER_CONSTRUCTION: "N",
        COMPLETED: "Y",
        FUTURE_DEVELOPMENT: "N",
        IN_DEVELOPMENT: "N",
        PROJECT_STAGE: "COMPLETED",
        PROJECT_CREATION_DATE: 1397779200000,
        ...
        PROJECT_SPONSOR_NAME: "PennDOT",
        SD_BRIDGE_WORK_FLAG: "N",
        OPEN_TO_TRAFFIC_DATE: null,
        ORIGINAL_CONTRACT_AMOUNT: null,
        CURRENT_CONTRACT_AMOUNT: null,
        ESTIMATED_LET_DATE: "7/3/2014 12:00:00 AM",
        DOI_DATE: null,
        DOI_ID: null,
        PRIMARY_PROJECT_ID: 102572,
        PRIMARY_CONTRACT_AMOUNT: null,
        PRIMARY_PROJECT_FLAG: "Y",
        HAS_CONSTRUCTION_PHASE: "T",
        HAS_FINAL_DESIGN_PHASE: "F",
        HAS_PRELIMINARY_ENGINEER_PHASE: "F",
        HAS_PLAN_RESEARCH_ADMIN_PHASE: "F",
        HAS_RIGHT_OF_WAY_PHASE: "F",
        HAS_STUDY_PHASE: "F",
        HAS_UTILITY_PHASE: "F",
        CTY_CODE: 67,
        ST_RT_NO: 8009,
        ...
        CUM_OFFSET_BGN: 6590,
        CUM_OFFSET_END: 9480,
        COUNTY_MUNICIPALITY_CODES: "67301",
        MUNICIPALITY_CODES: "301",
        MUNICIPALITY_NAMES: "PHILADELPHIA ",
        HOUSE_DISTRICTS: "175",
        SENATE_DISTRICTS: "1",
        CONGRESS_DISTRICTS: "2/3/2022 12:00:00 AM",
        HOUSE_LEGISLATOR_NAMES: "Marylouise Isaacson, (D)",
        SENATE_LEGISLATOR_NAMES: "Nikil Saval, (D)",
        CONGRESS_LEGISLATOR_NAMES: "Brendan F. Boyle (D), Dwight Evans (D)",
        COUNTY_NAME: "PHILADELPHIA",
        STREET_NAME: null,
        BRIDGE_WORK_FLAG: "N",
        RECORD_UPDATE: 20210529,
        CREATED_DATE: 1557728835000,
        LAST_EDITED_DATE: 1622273589000,
        GEOM_LENGTH_FT: 4960,
        GEOMETRY_TYPE: "POINT",
        BRIDGE_WORK_LOCATION_FLAG: "N",
        PUBLIC_NARRATIVE: "High Friction Surfaces\r\nVarious high-crash roadway curves in D6-0\r\nTreatmnt to reduce crashes on rdwy curves",
        GIS_UPDATE_DATE: 1603171861000,
        GIS_GEOMETRY_UPDATE_DATE: 1636117557000,
        SE_ANNO_CAD_DATA: null,
        GPID: 974725878,
        GlobalID: "88c9a006-4af4-47eb-bea6-553a61306cee",
      },
    }],
  };
  ...
  public static phillySimplePolyQueryJson = {
    ...
    serverGens: { minServerGen: 617069, serverGen: 701173 },
    geometryType: "esriGeometryPolygon",
    spatialReference: { wkid: 102100, latestWkid: 3857 },
    transform: { originPosition: "upperLeft", scale: [1.1943285667766759, 1.1943285667766759], translate: [-8366491.366817627, 4858337.5171295125] },
    fields: [],
    features: [{ attributes: {}, geometry: { rings: [[[274, 472], [-3, 18], [-16, -3], [3, -17], [0, -1], [16, 3]]] } }],
  };
  ...
  public static phillySimplePolyQueryPbf = {
    ...
    queryResult: {
      featureResult: {
        ...
        serverGens: { minServerGen: 617069, serverGen: 701173 },
        geometryType: 3,
        spatialReference: { wkid: 102100, lastestWkid: 3857, vcsWkid: 0, latestVcsWkid: 0, wkt: "" },
        exceededTransferLimit: false,
        hasZ: false,
        hasM: false,
        transform: {
          quantizeOriginPostion: 0,
          scale: { xScale: 1.1943285667766759, yScale: 1.1943285667766759, mScale: 0, zScale: 0 },
          translate: { xTranslate: -8366491.366817627, yTranslate: 4858337.5171295125, mTranslate: 0, zTranslate: 0 },
        },
        fields: [],
        values: [],
        features: [{ attributes: [], geometry: { lengths: [6], coords: [274, 472, -3, 18, -16, -3, 3, -17, 0, -1, 16, 3] } }],
      },
    },
  };
  ...
  public static phillyDoubleRingPolyQueryJson = {
    ...
    geometryType: "esriGeometryPolygon",
    spatialReference: { wkid: 102100, latestWkid: 3857 },
    transform: { originPosition: "upperLeft", scale: [0.5971642833956139, 0.5971642833956139], translate: [-8365879.870591431, 4857726.020903323] },
    fields: [],
    features: [{
      attributes: {},
      geometry: {
        rings: [[
          ...
          [-12, -2],
          [0, 2],
        ], [[417, 109], [3, -16], [-21, -3], [-2, 15], [16, 3], [4, 1]]],
      },
    }],
  };
  ...
  public static phillyDoubleRingPolyQueryPbf = {
    ...
    queryResult: {
      featureResult: {
        ...
        transform: {
          quantizeOriginPostion: 0,
          scale: { xScale: 0.5971642833956139, yScale: 0.5971642833956139, mScale: 0, zScale: 0 },
          translate: { xTranslate: -8365879.870591431, yTranslate: 4857726.020903323, mTranslate: 0, zTranslate: 0 },
        },
        fields: [],
        values: [],
        features: [{
  ...
  public static phillySimplePathQueryPbf = {
    ...
    queryResult: {
      featureResult: {
        ...
        globalIdFieldName: "GlobalID",
        geohashFieldName: "",
        geometryProperties: { shapeAreaFieldName: "", shapeLengthFieldName: "Shape__Length_2", units: "esriMeters" },
        serverGens: { minServerGen: 617022, serverGen: 701134 },
        geometryType: 2,
        spatialReference: { wkid: 102100, lastestWkid: 3857, vcsWkid: 0, latestVcsWkid: 0, wkt: "" },
        exceededTransferLimit: false,
        hasZ: false,
        ...
        transform: {
          quantizeOriginPostion: 0,
          scale: { xScale: 19.10925706863054, yScale: 19.10925706863054, mScale: 0, zScale: 0 },
          translate: { xTranslate: -8365268.374365235, yTranslate: 4872401.930332029, mTranslate: 0, zTranslate: 0 },
        },
        fields: [],
        values: [],
        features: [{
  ...
  public static phillySimplePathQueryJson = {
    ...
    uniqueIdField: { name: "OBJECTID", isSystemMaintained: true },
    globalIdFieldName: "GlobalID",
    geometryProperties: { shapeLengthFieldName: "Shape__Length_2", units: "esriMeters" },
    serverGens: { minServerGen: 617022, serverGen: 701134 },
    geometryType: "esriGeometryPolyline",
    spatialReference: { wkid: 102100, latestWkid: 3857 },
    transform: { originPosition: "upperLeft", scale: [19.10925706863054, 19.10925706863054], translate: [-8365268.374365235, 4872401.930332029] },
    fields: [],
    features: [{
      attributes: {},
      geometry: {
  ...
  public static phillySimplePointQueryPbf = {
    ...
    queryResult: {
      featureResult: {
        ...
        globalIdFieldName: "GlobalID",
        geohashFieldName: "",
        serverGens: { minServerGen: 617056, serverGen: 701159 },
        geometryType: 0,
        spatialReference: { wkid: 102100, lastestWkid: 3857, vcsWkid: 0, latestVcsWkid: 0, wkt: "" },
        exceededTransferLimit: false,
        hasZ: false,
        ...
        transform: {
          quantizeOriginPostion: 0,
          scale: { xScale: 4.777314267153997, yScale: 4.777314267153997, mScale: 0, zScale: 0 },
          translate: { xTranslate: -8365268.374365235, yTranslate: 4860172.005808106, mTranslate: 0, zTranslate: 0 },
        },
        fields: [],
        values: [],
  ...
  public static phillySimplePointQueryJson = {
    ...
    geometryType: "esriGeometryPoint",
    spatialReference: { wkid: 102100, latestWkid: 3857 },
    transform: { originPosition: "upperLeft", scale: [4.777314267153997, 4.777314267153997], translate: [-8365268.374365235, 4860172.005808106] },
    fields: [],
    features: [{ attributes: {}, geometry: { x: 88, y: 488 } }],
  };
  ...
  public static phillySimpleLineDrawingInfo = {
    drawingInfo: {
      renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [165, 83, 183, 255], width: 1 } },
      transparency: 0,
      labelingInfo: null,
    },
  };
  ...
  public static polygonDrawingInfo = {
    drawingInfo: {
      renderer: {
        type: "simple",
        symbol: {
  ...
  public static pointDrawingInfo = {
    drawingInfo: {
      renderer: {
        type: "simple",
        symbol: {
