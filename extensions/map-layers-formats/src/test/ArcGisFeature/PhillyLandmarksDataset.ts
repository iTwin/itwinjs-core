...
export class PhillyLandmarksDataset {
  ...
  public static phillyTansportationGetFeatureInfoResultRef = [{layerName:"dummyFeatureLayer",info:[{subLayerName:"SampleLayer",displayFieldName:"SampleLayer",records:[{value:{valueFormat:0,value:1320,displayValue:"1320"},property:{name:"OBJECTID",displayLabel:"OBJECTID",typename:"integer"}},{value:{valueFormat:0,value:974725878,displayValue:"974725878"},property:{name:"GISDATAPROJECT_LOCATION_DETAIL_",displayLabel:"GISDATAPROJECT_LOCATION_DETAIL_",typename:"integer"}},{value:{valueFormat:0,value:102572,displayValue:"102572"},property:{name:"PROJECT_ID",displayLabel:"PROJECT_ID",typename:"integer"}},{value:{valueFormat:0,value:"High Friction Surfaces(F)",displayValue:"High Friction Surfaces(F)"},property:{name:"PROJECT_TITLE",displayLabel:"PROJECT_TITLE",typename:"string"}},{value:{valueFormat:0,value:"CAND",displayValue:"CAND"},property:{name:"PROJECT_STATUS",displayLabel:"PROJECT_STATUS",typename:"string"}},{value:{valueFormat:0,value:"SAFE",displayValue:"SAFE"},property:{name:"PROJECT_CLASS",displayLabel:"PROJECT_CLASS",typename:"string"}},{value:{valueFormat:0,value:"Safety Improvement",displayValue:"Safety Improvement"},property:{name:"PROJECT_CLASS_NAME",displayLabel:"PROJECT_CLASS_NAME",typename:"string"}},{value:{valueFormat:0,value:"Installing high friction surfaces on top of existing roadway to decrease the number of crashes along high crash roadway curves",displayValue:"Installing high friction surfaces on top of existing roadway to decrease the number of crashes along high crash roadway curves"},property:{name:"PROJECT_IMPROVEMENT_DESC",displayLabel:"PROJECT_IMPROVEMENT_DESC",typename:"string"}},{value:{valueFormat:0,value:"High Friction Surfaces  Various high-crash roadway curves in D6-0  Treatmnt to reduce crashes on rdwy curves",displayValue:"High Friction Surfaces  Various high-crash roadway curves in D6-0  Treatmnt to reduce crashes on rdwy curves"},property:{name:"PROJECT_SHORT_NARRATIVE",displayLabel:"PROJECT_SHORT_NARRATIVE",typename:"string"}},{value:{valueFormat:0,value:"Surface Treatment",displayValue:"Surface Treatment"},property:{name:"IMPROVEMENT_TYPE",displayLabel:"IMPROVEMENT_TYPE",typename:"string"}},{value:{valueFormat:0,value:37,displayValue:"37"},property:{name:"IMPROVEMENT_CODE",displayLabel:"IMPROVEMENT_CODE",typename:"integer"}},{value:{valueFormat:0,value:"Surface Treatment",displayValue:"Surface Treatment"},property:{name:"IMPROVEMENT_SHORT_DESC",displayLabel:"IMPROVEMENT_SHORT_DESC",typename:"string"}},{value:{valueFormat:0,value:"2014-05-13T00:00:00.000Z",displayValue:"Mon May 12 2014 20:00:00 GMT-0400 (Eastern Daylight Time)"},property:{name:"TYP_FRST_APR_DT",displayLabel:"TYP_FRST_APR_DT",typename:"dateTime"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"MAJOR_PROJECT_FLAG",displayLabel:"MAJOR_PROJECT_FLAG",typename:"string"}},{value:{valueFormat:0,value:"H",displayValue:"H"},property:{name:"TRANSPORT_MODE",displayLabel:"TRANSPORT_MODE",typename:"string"}},{value:{valueFormat:0,value:"DVRPC",displayValue:"DVRPC"},property:{name:"PLANNING_PARTNER_SHORT_NAME",displayLabel:"PLANNING_PARTNER_SHORT_NAME",typename:"string"}},{value:{valueFormat:0,value:6,displayValue:"6"},property:{name:"RESPONSIBLE_DISTRICT_NO",displayLabel:"RESPONSIBLE_DISTRICT_NO",typename:"integer"}},{value:{valueFormat:0,value:3033,displayValue:"3033"},property:{name:"PRIMARY_ST_RT_NO",displayLabel:"PRIMARY_ST_RT_NO",typename:"integer"}},{value:{valueFormat:0,value:"HFS",displayValue:"HFS"},property:{name:"DISTRICT_SECTION_ID",displayLabel:"DISTRICT_SECTION_ID",typename:"string"}},{value:{valueFormat:0,value:0,displayValue:"0"},property:{name:"PRIMARY_LOCAL_ROAD_NUMBER",displayLabel:"PRIMARY_LOCAL_ROAD_NUMBER",typename:"integer"}},{value:{valueFormat:0,value:6.77,displayValue:"6.77"},property:{name:"PROJECT_TOTAL_LENGTH",displayLabel:"PROJECT_TOTAL_LENGTH",typename:"float"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"LOCAL_PROJECT_FLAG",displayLabel:"LOCAL_PROJECT_FLAG",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"LET_RESPONSIBLE_AGENCY",displayLabel:"LET_RESPONSIBLE_AGENCY",typename:"string"}},{value:{valueFormat:0,value:"Various high-crash roadway curves in District 6-0",displayValue:"Various high-crash roadway curves in District 6-0"},property:{name:"GEOGRAPHIC_DESCRIPTION",displayLabel:"GEOGRAPHIC_DESCRIPTION",typename:"string"}},{value:{valueFormat:0,value:"CAND",displayValue:"CAND"},property:{name:"PROJECT_STATE_CODE",displayLabel:"PROJECT_STATE_CODE",typename:"string"}},{value:{valueFormat:0,value:"Candidate",displayValue:"Candidate"},property:{name:"PROJECT_STATUS_CODE_DESC",displayLabel:"PROJECT_STATUS_CODE_DESC",typename:"string"}},{value:{valueFormat:0,value:43,displayValue:"43"},property:{name:"CODE_ID",displayLabel:"CODE_ID",typename:"integer"}},{value:{valueFormat:0,displayValue:""},property:{name:"POTENTIAL_COMMITTED_DATE_FLAG",displayLabel:"POTENTIAL_COMMITTED_DATE_FLAG",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"POTENTIAL_COMMITTED_YEAR",displayLabel:"POTENTIAL_COMMITTED_YEAR",typename:"string"}},{value:{valueFormat:0,value:"6/12/2014 12:00:00 AM",displayValue:"6/12/2014 12:00:00 AM"},property:{name:"POTENTIAL_COMMITTED_DATE",displayLabel:"POTENTIAL_COMMITTED_DATE",typename:"string"}},{value:{valueFormat:0,value:2445000,displayValue:"2445000"},property:{name:"EST_CONSTR_PHASE_COST_AMOUNT",displayLabel:"EST_CONSTR_PHASE_COST_AMOUNT",typename:"float"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"TYP_FLAG",displayLabel:"TYP_FLAG",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"TIP_FLAG",displayLabel:"TIP_FLAG",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"STIP_FLAG",displayLabel:"STIP_FLAG",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"DECADE_OF_INVESTMENT_FLAG",displayLabel:"DECADE_OF_INVESTMENT_FLAG",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"TIP_PROPOSED_FLAG",displayLabel:"TIP_PROPOSED_FLAG",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"TYP_PROPOSED_FLAG",displayLabel:"TYP_PROPOSED_FLAG",typename:"string"}},{value:{valueFormat:0,value:"Y",displayValue:"Y"},property:{name:"OBLIGATION_PLAN_FLAG",displayLabel:"OBLIGATION_PLAN_FLAG",typename:"string"}},{value:{valueFormat:0,value:"A",displayValue:"A"},property:{name:"LET_FLAG",displayLabel:"LET_FLAG",typename:"string"}},{value:{valueFormat:0,value:"20140703",displayValue:"20140703"},property:{name:"LET_DATE",displayLabel:"LET_DATE",typename:"string"}},{value:{valueFormat:0,value:"7/3/2014 12:00:00 AM",displayValue:"7/3/2014 12:00:00 AM"},property:{name:"LET_DATE_DISPLAY",displayLabel:"LET_DATE_DISPLAY",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"OPEN_FLAG",displayLabel:"OPEN_FLAG",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"OPEN_DATE",displayLabel:"OPEN_DATE",typename:"string"}},{value:{valueFormat:0,value:"A",displayValue:"A"},property:{name:"NTP_FLAG",displayLabel:"NTP_FLAG",typename:"string"}},{value:{valueFormat:0,value:20140818,displayValue:"20140818"},property:{name:"NTP_DATE",displayLabel:"NTP_DATE",typename:"integer"}},{value:{valueFormat:0,value:"A",displayValue:"A"},property:{name:"COMPLETION_FLAG",displayLabel:"COMPLETION_FLAG",typename:"string"}},{value:{valueFormat:0,value:"20151007",displayValue:"20151007"},property:{name:"COMPLETION_DATE",displayLabel:"COMPLETION_DATE",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"FISCALLY_READY",displayLabel:"FISCALLY_READY",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"FISCAL_DATE",displayLabel:"FISCAL_DATE",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"PHYSICALLY_READY",displayLabel:"PHYSICALLY_READY",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"PHYSICAL_DATE",displayLabel:"PHYSICAL_DATE",typename:"string"}},{value:{valueFormat:0,value:"George Dunheimer ADE CONSTR",displayValue:"George Dunheimer ADE CONSTR"},property:{name:"PROJECT_MANAGER_CONTACT_NAME",displayLabel:"PROJECT_MANAGER_CONTACT_NAME",typename:"string"}},{value:{valueFormat:0,value:"6102056680",displayValue:"6102056680"},property:{name:"PROJECT_MANAGER_PHONE",displayLabel:"PROJECT_MANAGER_PHONE",typename:"string"}},{value:{valueFormat:0,value:"gdunheimer@pa.gov",displayValue:"gdunheimer@pa.gov"},property:{name:"PROJECT_MANAGER_EMAIL",displayLabel:"PROJECT_MANAGER_EMAIL",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"UNDER_CONSTRUCTION",displayLabel:"UNDER_CONSTRUCTION",typename:"string"}},{value:{valueFormat:0,value:"Y",displayValue:"Y"},property:{name:"COMPLETED",displayLabel:"COMPLETED",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"FUTURE_DEVELOPMENT",displayLabel:"FUTURE_DEVELOPMENT",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"IN_DEVELOPMENT",displayLabel:"IN_DEVELOPMENT",typename:"string"}},{value:{valueFormat:0,value:"COMPLETED",displayValue:"COMPLETED"},property:{name:"PROJECT_STAGE",displayLabel:"PROJECT_STAGE",typename:"string"}},{value:{valueFormat:0,value:"2014-04-18T00:00:00.000Z",displayValue:"Thu Apr 17 2014 20:00:00 GMT-0400 (Eastern Daylight Time)"},property:{name:"PROJECT_CREATION_DATE",displayLabel:"PROJECT_CREATION_DATE",typename:"dateTime"}},{value:{valueFormat:0,displayValue:""},property:{name:"CAPITAL_BUDGET_YEAR",displayLabel:"CAPITAL_BUDGET_YEAR",typename:"string"}},{value:{valueFormat:0,value:"Y",displayValue:"Y"},property:{name:"CAPTIAL_BUDGET_REQUIRED_FLAG",displayLabel:"CAPTIAL_BUDGET_REQUIRED_FLAG",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"CAPITAL_BUDGET_APPROVED_FLAG",displayLabel:"CAPITAL_BUDGET_APPROVED_FLAG",typename:"string"}},{value:{valueFormat:0,value:"Delaware Valley Regional Planning Commission MPO                           ",displayValue:"Delaware Valley Regional Planning Commission MPO                           "},property:{name:"PLANNING_PARTNER_NAME",displayLabel:"PLANNING_PARTNER_NAME",typename:"string"}},{value:{valueFormat:0,value:"District 6-0                  ",displayValue:"District 6-0                  "},property:{name:"RESPONSIBLE_DISTRICT_NAME",displayLabel:"RESPONSIBLE_DISTRICT_NAME",typename:"string"}},{value:{valueFormat:0,value:15,displayValue:"15"},property:{name:"RESPONSIBLE_COUNTY_CODE",displayLabel:"RESPONSIBLE_COUNTY_CODE",typename:"integer"}},{value:{valueFormat:0,value:"Chester       ",displayValue:"Chester       "},property:{name:"RESPONSIBLE_COUNTY_NAME",displayLabel:"RESPONSIBLE_COUNTY_NAME",typename:"string"}},{value:{valueFormat:0,value:"PennDOT",displayValue:"PennDOT"},property:{name:"PROJECT_SPONSOR_NAME",displayLabel:"PROJECT_SPONSOR_NAME",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"SD_BRIDGE_WORK_FLAG",displayLabel:"SD_BRIDGE_WORK_FLAG",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"OPEN_TO_TRAFFIC_DATE",displayLabel:"OPEN_TO_TRAFFIC_DATE",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"ORIGINAL_CONTRACT_AMOUNT",displayLabel:"ORIGINAL_CONTRACT_AMOUNT",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"CURRENT_CONTRACT_AMOUNT",displayLabel:"CURRENT_CONTRACT_AMOUNT",typename:"string"}},{value:{valueFormat:0,value:"7/3/2014 12:00:00 AM",displayValue:"7/3/2014 12:00:00 AM"},property:{name:"ESTIMATED_LET_DATE",displayLabel:"ESTIMATED_LET_DATE",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"DOI_DATE",displayLabel:"DOI_DATE",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"DOI_ID",displayLabel:"DOI_ID",typename:"string"}},{value:{valueFormat:0,value:102572,displayValue:"102572"},property:{name:"PRIMARY_PROJECT_ID",displayLabel:"PRIMARY_PROJECT_ID",typename:"integer"}},{value:{valueFormat:0,displayValue:""},property:{name:"PRIMARY_CONTRACT_AMOUNT",displayLabel:"PRIMARY_CONTRACT_AMOUNT",typename:"string"}},{value:{valueFormat:0,value:"Y",displayValue:"Y"},property:{name:"PRIMARY_PROJECT_FLAG",displayLabel:"PRIMARY_PROJECT_FLAG",typename:"string"}},{value:{valueFormat:0,value:"T",displayValue:"T"},property:{name:"HAS_CONSTRUCTION_PHASE",displayLabel:"HAS_CONSTRUCTION_PHASE",typename:"string"}},{value:{valueFormat:0,value:"F",displayValue:"F"},property:{name:"HAS_FINAL_DESIGN_PHASE",displayLabel:"HAS_FINAL_DESIGN_PHASE",typename:"string"}},{value:{valueFormat:0,value:"F",displayValue:"F"},property:{name:"HAS_PRELIMINARY_ENGINEER_PHASE",displayLabel:"HAS_PRELIMINARY_ENGINEER_PHASE",typename:"string"}},{value:{valueFormat:0,value:"F",displayValue:"F"},property:{name:"HAS_PLAN_RESEARCH_ADMIN_PHASE",displayLabel:"HAS_PLAN_RESEARCH_ADMIN_PHASE",typename:"string"}},{value:{valueFormat:0,value:"F",displayValue:"F"},property:{name:"HAS_RIGHT_OF_WAY_PHASE",displayLabel:"HAS_RIGHT_OF_WAY_PHASE",typename:"string"}},{value:{valueFormat:0,value:"F",displayValue:"F"},property:{name:"HAS_STUDY_PHASE",displayLabel:"HAS_STUDY_PHASE",typename:"string"}},{value:{valueFormat:0,value:"F",displayValue:"F"},property:{name:"HAS_UTILITY_PHASE",displayLabel:"HAS_UTILITY_PHASE",typename:"string"}},{value:{valueFormat:0,value:67,displayValue:"67"},property:{name:"CTY_CODE",displayLabel:"CTY_CODE",typename:"integer"}},{value:{valueFormat:0,value:8009,displayValue:"8009"},property:{name:"ST_RT_NO",displayLabel:"ST_RT_NO",typename:"integer"}},{value:{valueFormat:0,value:1,displayValue:"1"},property:{name:"JURIS",displayLabel:"JURIS",typename:"integer"}},{value:{valueFormat:0,value:6,displayValue:"6"},property:{name:"DISTRICT_NO",displayLabel:"DISTRICT_NO",typename:"integer"}},{value:{valueFormat:0,value:250,displayValue:"250"},property:{name:"SEG_BGN",displayLabel:"SEG_BGN",typename:"integer"}},{value:{valueFormat:0,value:0,displayValue:"0"},property:{name:"OFFSET_BGN",displayLabel:"OFFSET_BGN",typename:"integer"}},{value:{valueFormat:0,value:250,displayValue:"250"},property:{name:"SEG_END",displayLabel:"SEG_END",typename:"integer"}},{value:{valueFormat:0,value:2890,displayValue:"2890"},property:{name:"OFFSET_END",displayLabel:"OFFSET_END",typename:"integer"}},{value:{valueFormat:0,value:2500000,displayValue:"2500000"},property:{name:"SEG_PT_BGN",displayLabel:"SEG_PT_BGN",typename:"integer"}},{value:{valueFormat:0,value:2502890,displayValue:"2502890"},property:{name:"SEG_PT_END",displayLabel:"SEG_PT_END",typename:"integer"}},{value:{valueFormat:0,value:2890,displayValue:"2890"},property:{name:"SEG_LNGTH_FEET",displayLabel:"SEG_LNGTH_FEET",typename:"integer"}},{value:{valueFormat:0,value:39099,displayValue:"39099"},property:{name:"NLF_ID",displayLabel:"NLF_ID",typename:"integer"}},{value:{valueFormat:0,value:1,displayValue:"1"},property:{name:"SIDE_IND",displayLabel:"SIDE_IND",typename:"integer"}},{value:{valueFormat:0,value:0,displayValue:"0"},property:{name:"NLF_CNTL_BGN",displayLabel:"NLF_CNTL_BGN",typename:"integer"}},{value:{valueFormat:0,value:2890,displayValue:"2890"},property:{name:"NLF_CNTL_END",displayLabel:"NLF_CNTL_END",typename:"integer"}},{value:{valueFormat:0,value:6590,displayValue:"6590"},property:{name:"CUM_OFFSET_BGN",displayLabel:"CUM_OFFSET_BGN",typename:"integer"}},{value:{valueFormat:0,value:9480,displayValue:"9480"},property:{name:"CUM_OFFSET_END",displayLabel:"CUM_OFFSET_END",typename:"integer"}},{value:{valueFormat:0,value:"67301",displayValue:"67301"},property:{name:"COUNTY_MUNICIPALITY_CODES",displayLabel:"COUNTY_MUNICIPALITY_CODES",typename:"string"}},{value:{valueFormat:0,value:"301",displayValue:"301"},property:{name:"MUNICIPALITY_CODES",displayLabel:"MUNICIPALITY_CODES",typename:"string"}},{value:{valueFormat:0,value:"PHILADELPHIA ",displayValue:"PHILADELPHIA "},property:{name:"MUNICIPALITY_NAMES",displayLabel:"MUNICIPALITY_NAMES",typename:"string"}},{value:{valueFormat:0,value:"175",displayValue:"175"},property:{name:"HOUSE_DISTRICTS",displayLabel:"HOUSE_DISTRICTS",typename:"string"}},{value:{valueFormat:0,value:"1",displayValue:"1"},property:{name:"SENATE_DISTRICTS",displayLabel:"SENATE_DISTRICTS",typename:"string"}},{value:{valueFormat:0,value:"2/3/2022 12:00:00 AM",displayValue:"2/3/2022 12:00:00 AM"},property:{name:"CONGRESS_DISTRICTS",displayLabel:"CONGRESS_DISTRICTS",typename:"string"}},{value:{valueFormat:0,value:"Marylouise Isaacson, (D)",displayValue:"Marylouise Isaacson, (D)"},property:{name:"HOUSE_LEGISLATOR_NAMES",displayLabel:"HOUSE_LEGISLATOR_NAMES",typename:"string"}},{value:{valueFormat:0,value:"Nikil Saval, (D)",displayValue:"Nikil Saval, (D)"},property:{name:"SENATE_LEGISLATOR_NAMES",displayLabel:"SENATE_LEGISLATOR_NAMES",typename:"string"}},{value:{valueFormat:0,value:"Brendan F. Boyle (D), Dwight Evans (D)",displayValue:"Brendan F. Boyle (D), Dwight Evans (D)"},property:{name:"CONGRESS_LEGISLATOR_NAMES",displayLabel:"CONGRESS_LEGISLATOR_NAMES",typename:"string"}},{value:{valueFormat:0,value:"PHILADELPHIA",displayValue:"PHILADELPHIA"},property:{name:"COUNTY_NAME",displayLabel:"COUNTY_NAME",typename:"string"}},{value:{valueFormat:0,displayValue:""},property:{name:"STREET_NAME",displayLabel:"STREET_NAME",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"BRIDGE_WORK_FLAG",displayLabel:"BRIDGE_WORK_FLAG",typename:"string"}},{value:{valueFormat:0,value:20210529,displayValue:"20210529"},property:{name:"RECORD_UPDATE",displayLabel:"RECORD_UPDATE",typename:"integer"}},{value:{valueFormat:0,value:"2019-05-13T06:27:15.000Z",displayValue:"Mon May 13 2019 02:27:15 GMT-0400 (Eastern Daylight Time)"},property:{name:"CREATED_DATE",displayLabel:"CREATED_DATE",typename:"dateTime"}},{value:{valueFormat:0,value:"2021-05-29T07:33:09.000Z",displayValue:"Sat May 29 2021 03:33:09 GMT-0400 (Eastern Daylight Time)"},property:{name:"LAST_EDITED_DATE",displayLabel:"LAST_EDITED_DATE",typename:"dateTime"}},{value:{valueFormat:0,value:4960,displayValue:"4960"},property:{name:"GEOM_LENGTH_FT",displayLabel:"GEOM_LENGTH_FT",typename:"integer"}},{value:{valueFormat:0,value:"POINT",displayValue:"POINT"},property:{name:"GEOMETRY_TYPE",displayLabel:"GEOMETRY_TYPE",typename:"string"}},{value:{valueFormat:0,value:"N",displayValue:"N"},property:{name:"BRIDGE_WORK_LOCATION_FLAG",displayLabel:"BRIDGE_WORK_LOCATION_FLAG",typename:"string"}},{value:{valueFormat:0,value:"High Friction Surfaces\r\nVarious high-crash roadway curves in D6-0\r\nTreatmnt to reduce crashes on rdwy curves",displayValue:"High Friction Surfaces\r\nVarious high-crash roadway curves in D6-0\r\nTreatmnt to reduce crashes on rdwy curves"},property:{name:"PUBLIC_NARRATIVE",displayLabel:"PUBLIC_NARRATIVE",typename:"string"}},{value:{valueFormat:0,value:"2020-10-20T05:31:01.000Z",displayValue:"Tue Oct 20 2020 01:31:01 GMT-0400 (Eastern Daylight Time)"},property:{name:"GIS_UPDATE_DATE",displayLabel:"GIS_UPDATE_DATE",typename:"dateTime"}},{value:{valueFormat:0,value:"2021-11-05T13:05:57.000Z",displayValue:"Fri Nov 05 2021 09:05:57 GMT-0400 (Eastern Daylight Time)"},property:{name:"GIS_GEOMETRY_UPDATE_DATE",displayLabel:"GIS_GEOMETRY_UPDATE_DATE",typename:"dateTime"}},{value:{valueFormat:0,displayValue:""},property:{name:"SE_ANNO_CAD_DATA",displayLabel:"SE_ANNO_CAD_DATA",typename:"string"}},{value:{valueFormat:0,value:974725878,displayValue:"974725878"},property:{name:"GPID",displayLabel:"GPID",typename:"integer"}},{value:{valueFormat:0,value:"88c9a006-4af4-47eb-bea6-553a61306cee",displayValue:"88c9a006-4af4-47eb-bea6-553a61306cee"},property:{name:"GlobalID",displayLabel:"GlobalID",typename:"string"}}]}]}];
