...
export class NewYorkDataset {
  ...
  public static streetsLayerCapabilities: any = {
    ...
    copyrightText: "",
    defaultVisibility: true,
    serverGens: { minServerGen: 498989, serverGen: 689763 },
    ...
    advancedQueryCapabilities: {
      ...
      supportedOperationsWithCacheHint: ["query", "queryTopFilter", "queryAnalytics", "queryAttachments", "queryRelated"],
    ...
    maxScale: 0,
    extent: {
      xmin: -8266144.7918439023,
      ymin: 4938569.7715200111,
      xmax: -8204248.7873679493,
      ymax: 4999630.6406602357,
      spatialReference: { wkid: 102100, latestWkid: 3857 },
    },
    drawingInfo: {
      renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [153, 0, 5, 255], width: 1 }, label: "", description: "" },
      transparency: 0,
      labelingInfo: null,
    },
    allowGeometryUpdates: true,
    ...
    indexes: [
      { name: "PK__NEWYORK3__F4B70D858AB09618", fields: "OBJECTID", isAscending: true, isUnique: true, description: "" },
      ...
      { name: "GlobalID_Index", fields: "GlobalID", isAscending: false, isUnique: true, description: "" },
    ],
