# Project Geolocation and Extents Extension

Copyright © Bentley Systems, Incorporated. All rights reserved.

An iModel.js Extension that provides tools to resize the project extents and establish geolocation.
...
4. Copy all the output files in the lib/build directory tree to imjs_extensions/projectLocation directory in the web resources of the host application.
...
7. Start the extension using the ExtensionTool - ExtensionTool.run("localhost:3000/projectLocation");
