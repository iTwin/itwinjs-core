...
describe("FrustumUniforms", () => {
  it("should create, store, and retrieve FrustumUniforms", () => {
    ...
    assert.isTrue(5.0 === fu.getNearPlane(), "should be able to retrieve Near after setting frustum");
    assert.isTrue(6.0 === fu.getFarPlane(), "should be able to retrieve Far after setting frustum");
    assert.isTrue(FrustumUniformType.Perspective === fu.GetType(), "should be able to retrieve Type after setting frustum");
