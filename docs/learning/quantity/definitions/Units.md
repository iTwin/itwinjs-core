...
- **Persistence Unit** - The unit used to store a quantify a value in memory or to persist the value in an editable [iModel](../../iModels.md). iModels define the persistence unit through [KindOfQuantity]($docs/bis/ec/kindofquantity/) objects.
