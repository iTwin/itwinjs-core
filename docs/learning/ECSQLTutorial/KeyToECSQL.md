...
> **Try it yourself** > _Goal:_ Find out how many [Elements](../../bis/domains/BisCore.ecschema.md#element) there are in the iModel.
>
> _ECSQL_
>
> ```sql
...
Look [here](../ECSqlReference/index.md) for an overview of supported features in ECSQL.
