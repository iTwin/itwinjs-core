...
A *View* renders geometry from one or more [Models](../../bis/fundamentals/foundation/model-fundamentals) of an iModel in a web browser. iTwin.js applications can embed and interact with Views anywhere on a web page via an `HTMLDivElement`.
