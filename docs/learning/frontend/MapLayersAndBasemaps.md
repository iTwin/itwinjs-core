...
For supplying credentials to services that require them - including custom authentication headers via an access client - see [Map-layer authentication](./MapLayerAuthentication.md).
