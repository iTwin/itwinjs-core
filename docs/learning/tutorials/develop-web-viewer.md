...
- Add a valid contextId (i.e. Project Id) and iModelId for your user to the REACT_APP_TEST_CONTEXT_ID and REACT_APP_TEST_IMODEL_ID variables in the .env file within the application's root directory.
