...
ECSchemas / domains available in the iModel. See more details in the [Defining ECSchema Requirements for Presentation Rules](../presentation/Advanced/SchemaRequirements) page.
