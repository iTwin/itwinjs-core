...
The deprecated field `handleInstancesPolymorphically?` of [ContentInstancesOfSpecificClassesSpecification](../presentation/content/ContentInstancesOfSpecificClasses.md) has been removed. To specify handling polymorphically, specify the value in `classes.arePolymorphic` or `excludedClasses.arePolymorphic`.
