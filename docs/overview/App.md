...
![>](../right_chevron.png)[write an interactive app](../learning/WriteAnInteractiveApp.md).
...
![>](../right_chevron.png)[write an interactive desktop app](../learning/WriteAnInteractiveDesktopApp.md).
...
![>](../right_chevron.png)[write an interactive mobile app](../learning/WriteAnInteractiveMobileApp.md).
