- [Parsing and Formatting](#parsing-and-formatting)
  - [FormatterSpec and ParserSpec](#formatterspec-and-parserspec)
    - [FormatterSpec](#formatterspec)
    - [ParserSpec](#parserspec)
  - [Parser Behavior](#parser-behavior)
    - [Parsing Process](#parsing-process)
    - [Example: Parsing Values](#example-parsing-values)
  - [Mathematical Operations](#mathematical-operations)
    - [Enabling Mathematical Operations](#enabling-mathematical-operations)
    - [Example: Parsing Mathematical Expressions](#example-parsing-mathematical-expressions)
    - [Limitations](#limitations)
      - [Whitespace Handling](#whitespace-handling)
      - [Composite Unit Handling](#composite-unit-handling)
  - [Usage in iTwin Tools and Components](#usage-in-itwin-tools-and-components)
    - [QuantityFormatter Integration](#quantityformatter-integration)
    - [Measure Tools Examples](#measure-tools-examples)
      - [Example 1: MeasureDistanceTool - Formatting](#example-1-measuredistancetool---formatting)
      - [Example 2: MeasureLocationTool - Parsing](#example-2-measurelocationtool---parsing)
    - [General Pattern for Tools and Components](#general-pattern-for-tools-and-components)
    - [Migrating from QuantityType to KindOfQuantity](#migrating-from-quantitytype-to-kindofquantity)
      - [Why Migrate?](#why-migrate)
      - [QuantityType Replacement Table](#quantitytype-replacement-table)
      - [Handling Missing Schemas](#handling-missing-schemas)
