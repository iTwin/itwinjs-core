...
- **[BasicUnitsProvider]($quantity)** - Resolves conversions from the bundled BIS Units schema (492 units). Default provider.
...
4. **Use the default BasicUnitsProvider** - It covers 492 units; only switch to SchemaUnitProvider when you need custom domain-specific units
