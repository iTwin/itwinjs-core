...
_formatName_`(`_precision_`)` `[`_unitName_`|`_unitLabel_`]` `[`_unitName_`|`_unitLabel_`]` `[`_unitName_`|`_unitLabel_`]` `[`_unitName_`|`_unitLabel_`]`
...
_Unit Override_ = `[`_unitName_`|`_unitLabel_`]`
