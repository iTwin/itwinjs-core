...
A struct class may inherit from another non-sealed struct class. Struct properties use exactly their declared struct type; they do not accept instances of derived struct types. BIS schema policy prohibits struct inheritance.
