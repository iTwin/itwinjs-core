...
| **CodeValue Property**<a name="code-value-property"></a> | A nullable string property of Element that holds a human-readable identifier of the entity that the Element represents. See [Codes](./codes.md). |
