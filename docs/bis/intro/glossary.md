...
| **ElementOwnsChildElements**<a name="element-owns-child-elements"></a> | Relates an Element to *child* Elements which represent *parts* of the [Entity](#entity) modeled by the parent Element. Element subclasses can either allow the use child Elements to model its parts, or allow use of the ModelModelsElement relationship with another Model to express a detailed model of the parts, but not both. |
