...
import { SvgSprite, WebFontIcon, WebFontIconProps } from "@itwin/ui-core-react";
...
export class ImageRenderer {
  ...
  /** Render image as ui-core-react icon */
   ...
   * Defaults to ui-core-react icon if iconName does not contain className.
   */
