...
describe("Breadcrumb withDragDrop HOC", () => {
  ...
  describe("Drag callbacks", () => {
    it("should have no drag callback when no dragProps are provided", () => {
      const root = ReactTestUtils.renderIntoDocument(<DragDropBreadcrumb dataProvider={[]} />) as any;
    ...
    it("should pass constant objectType through", () => {
      const root = ReactTestUtils.renderIntoDocument(<DragDropBreadcrumb dataProvider={[]} dragProps={{ objectType: "test" }} />) as any;
