 ...
 * @alpha
 */
export const NavigationArea = React.memo<NavigationAreaProps>(function NavigationArea(props) { // eslint-disable-line @typescript-eslint/naming-convention, @typescript-eslint/no-shadow
