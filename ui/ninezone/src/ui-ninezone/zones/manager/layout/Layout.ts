...
export class Layout {
  ...
  public readonly horizontalAnchor: HorizontalAnchor;
  ...
  public constructor(props: LayoutProps) {
    ...
    this.horizontalAnchor = props.horizontalAnchor;
...
export class GrowLeftStrategy extends GrowStrategy {
  ...
  public getMaxGrowBy(layout: Layout) {
    ...
    return layout.horizontalAnchor === HorizontalAnchor.Right ? layout.bounds.left - initialBounds.left : Number.MAX_SAFE_INTEGER;
  }
...
export class GrowRightStrategy extends GrowStrategy {
  ...
  public getMaxGrowBy(layout: Layout) {
    ...
    const initialBounds = layout.getInitialBounds();
    return layout.horizontalAnchor === HorizontalAnchor.Left ? initialBounds.right - layout.bounds.right : Number.MAX_SAFE_INTEGER;
  }
