...
import { Tooltip, SizeProps } from "../../../ui-ninezone";
import { offsetAndContainInContainer } from "../../../ui-ninezone/popup/tooltip/Tooltip";
...
describe("<Tooltip />", () => {
  ...
  it("should offset and contain in container", () => {
    const sut = offsetAndContainInContainer({ x: 0, y: 0 })({
      bottom: 22,
      left: 90,
      right: 110,
      top: 12,
