...
import { Rectangle, RectangleProps, Layout, Root, HorizontalAnchor } from "../../../../ui-ninezone";
...
class LayoutMock extends Layout {
  ...
  public constructor(bounds: RectangleProps = new Rectangle(), root = new Root(new Rectangle(), true)) {
    super({
      bounds,
