...
export class FrameworkAccuDraw extends AccuDraw implements UserSettingsProvider {
  ...
  private outputCompassModeMessage(): void {
    if (FrameworkAccuDraw.displayNotifications) {
      ...
      const modeMessage = UiFramework.localizationClient.getLocalizedStringWithNamespace(UiFramework.localizationNamespace, "accuDraw.compassModeSet", { modeString });
  ...
  private outputRotationMessage(): void {
    if (FrameworkAccuDraw.displayNotifications) {
      ...
      const rotationMessage = UiFramework.localizationClient.getLocalizedStringWithNamespace(UiFramework.localizationNamespace, "accuDraw.rotationSet", { rotationString });
