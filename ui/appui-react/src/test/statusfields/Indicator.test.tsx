...
describe("Indicator", () => {
  it("Should render label on left", () => {
    const wrapper = render(
      <Indicator iconSpec={"test-icon"} label="test-label" isLabelVisible={true} labelSide={StatusBarLabelSide.Left} isInFooterMode={true} />);
  ...
  it("Should render label on right", () => {
    const wrapper = render(
      <Indicator iconSpec={"test-icon"} label="test-label" isLabelVisible={true} labelSide={StatusBarLabelSide.Right} isInFooterMode={true} />);
    expect(wrapper).not.to.be.undefined;
