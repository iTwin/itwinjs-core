...
import { createDraggedTabState } from "@itwin/appui-layout-react/lib/cjs/appui-layout-react/state/InternalStateHelpers";
import {
  ...
  describe("ModalFrontstageComposer", () => {
    ...
    describe("dynamic widgets", () => {
      ...
      it("should stop rendering unloaded extension widgets", async () => {
        ...
        frontstageDef?.nineZoneState?.widgets.rightEnd.tabs.should.eql(["TestUi2ProviderRM1"], "rightMiddle widget tabs");
        ...
        should().not.exist(frontstageDef?.nineZoneState?.widgets.rightEnd, "rightMiddle widget");
