 ...
 * @beta
 * @deprecated in 3.x. Use [BackstageItemType]($appui-abstract) instead
 */
 ...
 * @beta
 * @deprecated in 3.x. Use [BackstageActionItem]($appui-abstract) instead
 */
...
/** Describes the data needed to insert an action button into the backstage menu.
 * @beta
 * @deprecated in 3.x. Use [BackstageStageLauncher]($appui-abstract) instead
 */
...
export class BackstageItemUtilities {
   ...
   * @beta
   * @deprecated in 3.x. Use [BackstageItemUtilities.createStageLauncher]($appui-abstract) instead
   */
   ...
   * @beta
   * @deprecated in 3.x. Use [BackstageItemUtilities.createActionItem]($appui-abstract) instead
   */
