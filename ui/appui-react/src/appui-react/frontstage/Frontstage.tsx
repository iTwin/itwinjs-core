...
export interface FrontstageProps extends CommonProps {
  ...
  */
   ...
   * @deprecated in 3.x. use statusBar property */
 ...
 * @deprecated in 3.x. Use [[FrontstageConfig]] instead.
 * @public
 */
