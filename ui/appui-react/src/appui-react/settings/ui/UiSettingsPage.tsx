...
/**
 * @deprecated in 3.x. Framework version is deprecated, only UI2.0 is supported.
 * @beta
 */
...
/**
 * @deprecated in 3.x. Framework version is deprecated, only UI2.0 is supported. Use `getUiSettingsManagerEntry(itemPriority)` instead.
 * @beta
 */
