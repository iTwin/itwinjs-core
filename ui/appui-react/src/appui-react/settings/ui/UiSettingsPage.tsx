 ...
 * @beta
 */
export function UiSettingsPage(): React.JSX.Element;

/**
 * @deprecated in 3.6. Framework version is deprecated, only UI2.0 is supported.
 * @beta
 */
export function UiSettingsPage({ allowSettingUiFrameworkVersion }: { allowSettingUiFrameworkVersion: boolean }): React.JSX.Element; // eslint-disable-line @typescript-eslint/unified-signatures
