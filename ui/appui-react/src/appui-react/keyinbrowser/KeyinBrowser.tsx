...
/** Data for each key-in.
 @deprecated in 3.0. Key-in browser replaced by [KeyinPalettePopup]($appui-react) */
 ...
 * @beta @deprecated in 3.0. Key-in browser replaced by [KeyinPalettePopup]($appui-react).
 */
