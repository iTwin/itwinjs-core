...
import type { StatusBarFieldId, StatusBarWidgetControl, StatusBarWidgetControlArgs } from "./StatusBarWidgetControl";
import type { StatusMessage } from "../messages/StatusMessageManager";
