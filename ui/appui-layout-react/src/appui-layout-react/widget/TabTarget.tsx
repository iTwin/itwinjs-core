 ...
 * @internal v1 target
 */
export const WidgetTabTarget = React.memo<WidgetTabTargetProps>(
  withTargetVersion("1", function WidgetTabTarget(props) { // eslint-disable-line @typescript-eslint/naming-convention, no-shadow
