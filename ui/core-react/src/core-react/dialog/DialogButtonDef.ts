...
/** Enum for button types. Determines button label, and default button style.
  * @public
  * @deprecated in 3.x. Use [DialogButtonType]($appui-abstract) instead
  */
...
/** Enum for button style.
  * @public
  * @deprecated in 3.x. Use [DialogButtonStyle]($appui-abstract) instead
  */
...
/** Interface for a dialog button in a button cluster
  * @public
  * @deprecated in 3.x. Use [DialogButtonDef]($appui-abstract) instead
  */
