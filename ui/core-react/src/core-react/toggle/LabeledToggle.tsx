 ...
 * @public
 * @deprecated in 3.x. Use ToggleSwitchProps from itwinui-react instead
 */
 ...
 * @public
 * @deprecated in 3.x. Use ToggleSwitch from itwinui-react with `labelPosition="right"` instead
 */
