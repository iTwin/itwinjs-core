...
describe("ToolbarItemsManager", () => {
  ...
  const nestedConditionalIcon = new ConditionalStringValue(
    () => (isVisible ? "nested-icon-developer" : "nested-icon-home"),
    [syncId]
  );
  ...
  const child1ActionSpec = ToolbarItemUtilities.createActionButton(
    "child1-test-action-tool",
    100,
    "icon-developer",
    "child1",
    (): void => {},
  ...
  const nestedGroupItem = ToolbarItemUtilities.createGroupButton(
    "tool-formatting-setting-nested",
    110,
    "icon-placeholder",
    "set formatting units",
    [nestedChild1ActionSpec, nestedChild2ActionSpec],
    { badgeType: BadgeType.New }
  );
  const groupItem = ToolbarItemUtilities.createGroupButton(
    "tool-formatting-setting",
    110,
    "icon-placeholder",
    "set formatting units",
    [child1ActionSpec, child2ActionSpec, nestedGroupItem],
