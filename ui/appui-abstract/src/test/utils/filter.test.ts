...
describe("Filters", () => {
  ...
  it("fuzzySeparateFilter", function () {
    ...
    filterOk(fuzzySeparateFilter, "gp", "Git: Pull", [
      { start: 0, end: 1 },
      { start: 5, end: 6 },
    ]);
    filterOk(fuzzySeparateFilter, "g p", "Git: Pull", [
      { start: 0, end: 1 },
      { start: 4, end: 6 },
    ]);
    filterOk(fuzzySeparateFilter, "gipu", "Git: Pull", [
      { start: 0, end: 2 },
      { start: 5, end: 7 },
    ]);
    filterOk(fuzzySeparateFilter, "gp", "Category: Git: Pull", [
      { start: 10, end: 11 },
      { start: 15, end: 16 },
    ]);
    filterOk(fuzzySeparateFilter, "g p", "Category: Git: Pull", [
      { start: 10, end: 11 },
      { start: 14, end: 16 },
    ]);
    filterOk(fuzzySeparateFilter, "gipu", "Category: Git: Pull", [
      { start: 10, end: 12 },
      { start: 15, end: 17 },
    ]);
  });
  ...
  it("patternPos isn't working correctly #79815", function () {
    assertMatches(":p".substring(1), "prop", "^prop", fuzzyScore, {
      patternPos: 0,
    });
