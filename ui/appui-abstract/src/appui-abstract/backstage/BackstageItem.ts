 ...
 * @deprecated Use [CommonBackstageItem]($appui-react) instead.
 * @public
 */
export interface CommonBackstageItem extends ProvidedItem { // eslint-disable-line deprecation/deprecation
  ...
  /** Subtitle. */
  readonly subtitle?: string | ConditionalStringValue; // eslint-disable-line deprecation/deprecation
  /** Tooltip. */
  ...
  readonly isActive?: boolean | ConditionalBooleanValue; // eslint-disable-line deprecation/deprecation
}

/** Describes the data needed to insert an action button into the backstage menu.
 * @deprecated Use [BackstageActionItem]($appui-react) instead.
 * @public
 */
...
/** Describes the data needed to insert a button into the backstage menu.
 * @deprecated Use [BackstageItem]($appui-react) instead.
 * @public
 */
 ...
 * @deprecated Use [isBackstageActionItem]($appui-react) instead.
 * @public
 */
 ...
 * @deprecated Use [isBackstageStageLauncher]($appui-react) instead.
 * @public
 */
 ...
 * @deprecated Use [BackstageItemUtilities]($appui-react) instead.
 * @public
 */
