...
export class StandardContentLayouts {
  ...
  public static readonly threeViewsTwoOnLeft: ContentLayoutProps = {
    ...
    verticalSplit: {
      ...
      percentage: 0.50,
      left: {
        horizontalSplit: { id: "uia:twoViewsOnLeftHorizontal", percentage: 0.50, top: 0, bottom: 1, lock: false, minSizeTop: 50, minSizeBottom: 50 },
      },
      right: 2,
    },
  };
  ...
  public static readonly threeViewsTwoOnRight: ContentLayoutProps = {
    ...
    verticalSplit: {
      ...
      left: 0,
      right: {
        horizontalSplit: { id: "uia:twoViewsOnRightHorizontal", percentage: 0.50, top: 1, bottom: 2, lock: false, minSizeTop: 50, minSizeBottom: 50 },
      },
    },
  };
  ...
  public static readonly threeViewsTwoOnBottom: ContentLayoutProps = {
    ...
    horizontalSplit: {
      ...
      top: 0,
      bottom: {
        verticalSplit: { id: "uia:twoViewsOnBottomVertical", percentage: 0.50, left: 1, right: 2, lock: false, minSizeLeft: 50, minSizeRight: 50 },
      },
    },
  };
  ...
  public static readonly threeViewsTwoOnTop: ContentLayoutProps = {
    ...
    horizontalSplit: {
      ...
      lock: false,
      top: {
        verticalSplit: { id: "uia:twoViewsOnTopVertical", percentage: 0.50, left: 0, right: 1, lock: false, minSizeLeft: 50, minSizeRight: 50 },
      },
      bottom: 2,
    },
  };
