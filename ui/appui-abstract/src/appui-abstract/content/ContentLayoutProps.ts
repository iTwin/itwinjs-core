 ...
 * @public
 * @deprecated in 4.10.x - will not be removed until 2026-06-13. Use `LayoutSplitPropsBase` from `@itwin/appui-react`.
 */
 ...
 * @public
 * @deprecated in 4.10.x - will not be removed until 2026-06-13. Use `LayoutFragmentProps` from `@itwin/appui-react`.
 */
 ...
 * @public
 * @deprecated in 4.10.x - will not be removed until 2026-06-13. Use `LayoutVerticalSplitProps` from `@itwin/appui-react`.
 */
 ...
 * When a number, it represents an index into a [[ContentGroup]].
 * @public
 * @deprecated in 4.10.x - will not be removed until 2026-06-13. Use `LayoutHorizontalSplitProps` from `@itwin/appui-react`.
 */
 ...
 * @public
 * @deprecated in 4.10.x - will not be removed until 2026-06-13. Use `ContentLayoutProps` from `@itwin/appui-react`.
 */
