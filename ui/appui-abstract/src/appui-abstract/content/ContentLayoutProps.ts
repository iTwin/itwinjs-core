 ...
 * @public
 * @deprecated in 4.10.x - might be removed in next major version. Use `LayoutSplitPropsBase` from `@itwin/appui-react`.
 */
 ...
 * @public
 * @deprecated in 4.10.x - might be removed in next major version. Use `LayoutFragmentProps` from `@itwin/appui-react`.
 */
 ...
 * @public
 * @deprecated in 4.10.x - might be removed in next major version. Use `LayoutVerticalSplitProps` from `@itwin/appui-react`.
 */
 ...
 * When a number, it represents an index into a [[ContentGroup]].
 * @public
 * @deprecated in 4.10.x - might be removed in next major version. Use `LayoutHorizontalSplitProps` from `@itwin/appui-react`.
 */
 ...
 * @public
 * @deprecated in 4.10.x - might be removed in next major version. Use `ContentLayoutProps` from `@itwin/appui-react`.
 */
