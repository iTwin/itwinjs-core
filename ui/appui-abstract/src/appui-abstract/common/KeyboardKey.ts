 ...
 * @public @deprecated in 4.3 - will not be removed until 2026-06-13. Please use the `ts-key-enum` npm package or string literals.
 */
 ...
 * @public @deprecated in 4.3 - will not be removed until 2026-06-13. Please use a custom implementation moving forward.
 */
