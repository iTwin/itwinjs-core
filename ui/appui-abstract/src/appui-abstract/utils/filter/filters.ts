 ...
 * @public @deprecated in 4.3.x - will not be removed until 2026-06-13. A rarely used interface. If needed, please add a custom implementation.
 */
 ...
 * @internal @deprecated in 4.3 - will not be removed until 2026-06-13. Use `matchesWords` from @itwin/core-react instead. Though internal, this requires deprecation due to known public usage in @itwin/core-react.
 */
