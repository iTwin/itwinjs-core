...
/** @beta
 * calculate solar angles (in radians) based at a given date/time and location (longitude and latitude in degrees).
 */
export function calculateSolarAngles(date: Date, longitude: number, latitude: number): { azimuth: number, elevation: number } {
