...
- improve test data to help with debugging; clarify test error messages
...
- Accomodate ULAS requirements for empty projectId
...
- add frontend feature logging telemetry client
