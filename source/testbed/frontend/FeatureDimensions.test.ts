...
import { LUTParams, getFeatureName, FeatureDimension, FeatureDimensions, FeatureDimensionsIterator } from "@bentley/imodeljs-frontend/lib/render/FeatureDimensions";
