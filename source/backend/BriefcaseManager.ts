...
export class BriefcaseManager {
  ...
  private static getCachedBriefcaseInfos(cacheDir: string): any {
    const nativeDb: AddonDgnDb = new (NativePlatformRegistry.getNativePlatform()).AddonDgnDb();
  ...
  private static openBriefcase(briefcase: BriefcaseEntry) {
    if (!briefcase.nativeDb)
      briefcase.nativeDb = new (NativePlatformRegistry.getNativePlatform()).AddonDgnDb();
