...
import { EditCommandIpc, EditorAppIpc, EditorAppEnum } from "@bentley/imodeljs-editor-common";
...
class EditorAppImpl extends IpcHandler implements EditorAppIpc {
  public async getVersion() { return EditorAppEnum.Version; }
  public get channelName() { return EditorAppEnum.Channel; }
