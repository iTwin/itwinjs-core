...
export function makeCommandMethodProxy<K extends EditCommandIpc>(): PickAsyncMethods<K> {
...
export const solidModelingIpc = makeCommandMethodProxy<SolidModelingCommandIpc>();
export const basicManipulationIpc = makeCommandMethodProxy<BasicManipulationCommandIpc>();
