...
export abstract class SolidPrimitiveTool extends CreateElementWithDynamicsTool {
  ...
  protected getGeometryProps(
    ...
    if (!builder.appendGeometryQuery(this.current)) return;
...
export class CreateSphereTool extends SolidPrimitiveTool {
    ...
    if (!this._cappedProperty)
      this._cappedProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "sphereCapped",
          EditTools.translate("CreateSphere.Label.Capped")
        ),
        true
      );
  ...
  public get capped(): boolean {
    return this.cappedProperty.value;
  }
  public set capped(value: boolean) {
    this.cappedProperty.value = value;
  }
  ...
  protected override async updateElementData(
    ...
    this.current = Sphere.createFromAxesAndScales(
      this.accepted[0],
      this.baseRotation,
      radius,
      radius,
    ...
    if (isDynamics || undefined === this.current) return;
...
export class CreateCylinderTool extends SolidPrimitiveTool {
  ...
  public get useLength(): boolean {
    return this.useLengthProperty.value;
  }
  public set useLength(value: boolean) {
    this.useLengthProperty.value = value;
  }
  ...
  public get cappedProperty() {
    if (!this._cappedProperty)
      this._cappedProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "cylinderCapped",
          EditTools.translate("CreateCylinder.Label.Capped")
        ),
        true
      );
    return this._cappedProperty;
  ...
  public get orthogonalProperty() {
    if (!this._orthogonalProperty)
      this._orthogonalProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "cylinderOrthogonal",
          EditTools.translate("CreateCylinder.Label.Orthogonal")
        ),
        true
      );
  ...
  public get orthogonal(): boolean {
    return this.orthogonalProperty.value;
  }
  public set orthogonal(value: boolean) {
    this.orthogonalProperty.value = value;
  }
  ...
  protected override async updateElementData(
    ...
    switch (this.createPhase) {
      ...
      case CreateCylinderPhase.AcceptRadius: {
        ...
        if (
          undefined === vector0.scaleToLength(radius, vector0) ||
          undefined === vector90.scaleToLength(radius, vector90)
        ) {
          this.current = undefined;
          this.clearGraphics();
          return;
      ...
      case CreateCylinderPhase.AcceptLength: {
        ...
        if (isDynamics || undefined === this.current) break;
...
export class CreateConeTool extends SolidPrimitiveTool {
  ...
  public get useBaseRadius(): boolean {
    return this.useBaseRadiusProperty.value;
  }
  public set useBaseRadius(value: boolean) {
    this.useBaseRadiusProperty.value = value;
  }
  ...
  public get baseRadius(): number {
    return this.baseRadiusProperty.value;
  }
  public set baseRadius(value: number) {
    this.baseRadiusProperty.value = value;
  }
  ...
  public get useTopRadius(): boolean {
    return this.useTopRadiusProperty.value;
  }
  public set useTopRadius(value: boolean) {
    this.useTopRadiusProperty.value = value;
  }
  ...
  public get topRadius(): number {
    return this.topRadiusProperty.value;
  }
  public set topRadius(value: number) {
    this.topRadiusProperty.value = value;
  }
  ...
  public get useLengthProperty() {
    if (!this._useLengthProperty)
      this._useLengthProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildLockPropertyDescription("useConeLength"),
        false
      );
    return this._useLengthProperty;
  }
  ...
  public get orthogonalProperty() {
    if (!this._orthogonalProperty)
      this._orthogonalProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "coneOrthogonal",
          EditTools.translate("CreateCone.Label.Orthogonal")
        ),
        true
      );
    return this._orthogonalProperty;
      ...
      case CreateConePhase.AcceptLength: {
        ...
        if (this.orthogonal)
          this.current = Cone.createAxisPoints(
            ...
            pt1.plus(zAxis),
            this.baseRadius,
            this.useTopRadius ? this.topRadius : 0.0,
            this.capped
          );
        else
          this.current = Cone.createBaseAndTarget(
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    this.initializeToolSettingPropertyValues([
      this.baseRadiusProperty,
      this.useBaseRadiusProperty,
      this.topRadiusProperty,
      this.useTopRadiusProperty,
      this.lengthProperty,
      this.useLengthProperty,
      this.orthogonalProperty,
      this.cappedProperty,
    ...
    const useBaseRadiusLock = this.useBaseRadiusProperty.toDialogItem({
      rowPriority: 1,
      columnIndex: 0,
    });
    toolSettings.push(
...
export class CreateBoxTool extends SolidPrimitiveTool {
  ...
  public get useLengthProperty() {
    if (!this._useLengthProperty)
      this._useLengthProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildLockPropertyDescription("useBoxLength"),
        false
      );
    return this._useLengthProperty;
  }
  ...
  public get useWidthProperty() {
    if (!this._useWidthProperty)
      this._useWidthProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildLockPropertyDescription("useBoxWidth"),
        false
      );
    return this._useWidthProperty;
  }

  public get useWidth(): boolean {
    return this.useWidthProperty.value;
  }
  public set useWidth(value: boolean) {
    this.useWidthProperty.value = value;
  }
  ...
  public get useHeightProperty() {
    if (!this._useHeightProperty)
      this._useHeightProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildLockPropertyDescription("useBoxHeight"),
        false
      );
    return this._useHeightProperty;
  }

  public get useHeight(): boolean {
    return this.useHeightProperty.value;
  }
  public set useHeight(value: boolean) {
    this.useHeightProperty.value = value;
  }
  ...
  public get orthogonalProperty() {
    if (!this._orthogonalProperty)
      this._orthogonalProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "boxOrthogonal",
          EditTools.translate("CreateBox.Label.Orthogonal")
        ),
        true
      );
    return this._orthogonalProperty;
  ...
  protected override async updateElementData(
    ...
    switch (this.accepted.length) {
      ...
      default: {
        if (undefined === this.baseRotation) return; // Should always have base rotation after width is defined...
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    this.initializeToolSettingPropertyValues([
      ...
      this.useLengthProperty,
      this.widthProperty,
      this.useWidthProperty,
      this.heightProperty,
      this.useHeightProperty,
      this.orthogonalProperty,
      this.cappedProperty,
    ]);
...
export class CreateTorusTool extends SolidPrimitiveTool {
  ...
  public get usePrimaryRadius(): boolean {
    return this.usePrimaryRadiusProperty.value;
  }
  public set usePrimaryRadius(value: boolean) {
    this.usePrimaryRadiusProperty.value = value;
  }
  ...
  public get primaryRadius(): number {
    return this.primaryRadiusProperty.value;
  }
  public set primaryRadius(value: number) {
    this.primaryRadiusProperty.value = value;
  }
  ...
  public get useSecondaryRadius(): boolean {
    return this.useSecondaryRadiusProperty.value;
  }
  public set useSecondaryRadius(value: boolean) {
    this.useSecondaryRadiusProperty.value = value;
  }
  ...
  public get secondaryRadius(): number {
    return this.secondaryRadiusProperty.value;
  }
  public set secondaryRadius(value: number) {
    this.secondaryRadiusProperty.value = value;
  }

  private _useAngleProperty: DialogProperty<boolean> | undefined;
  public get useAngleProperty() {
    if (!this._useAngleProperty)
      this._useAngleProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildLockPropertyDescription("useTorusAngle"),
        false
      );
  ...
  public get useAngle(): boolean {
    return this.useAngleProperty.value;
  }
  public set useAngle(value: boolean) {
    this.useAngleProperty.value = value;
  }
  ...
  public get cappedProperty() {
    if (!this._cappedProperty)
      this._cappedProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "torusCapped",
          EditTools.translate("CreateTorus.Label.Capped")
        ),
        true
      );
    return this._cappedProperty;
  ...
  protected override async updateElementData(
    ...
    switch (this.createPhase) {
      ...
      case CreateTorusPhase.AcceptCenter: {
        ...
        if (
          undefined === vector0.scaleToLength(primaryRadius, vector0) ||
          undefined === vector90.scaleToLength(primaryRadius, vector90)
        ) {
          this.current = undefined;
          this.clearGraphics();
          return;
        ...
        if (allowComplete) {
          ...
          this.current = TorusPipe.createDgnTorusPipe(
            ...
            Angle.createRadians(this.angle),
            this.capped
          );
          ...
          if (!isDynamics) this.createPhase = CreateTorusPhase.AcceptResult;
          break;
        }
        ...
        this.createPhase = this.useSecondaryRadius
          ? CreateTorusPhase.AcceptAngle
          : CreateTorusPhase.AcceptSecondaryRadius;
        break;
      }

      case CreateTorusPhase.AcceptSecondaryRadius: {
        const vector0 = Vector3d.createStartEnd(this.accepted[0], ev.point);
        const secondaryRadius = this.useSecondaryRadius
          ? this.secondaryRadius
          : Math.min(this.primaryRadius, vector0.magnitude());
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    this.initializeToolSettingPropertyValues([
      this.primaryRadiusProperty,
      this.usePrimaryRadiusProperty,
      this.secondaryRadiusProperty,
      this.useSecondaryRadiusProperty,
      this.angleProperty,
      this.useAngleProperty,
      this.cappedProperty,
    ]);
    ...
    const usePrimaryRadiusLock = this.usePrimaryRadiusProperty.toDialogItem({
      rowPriority: 1,
      columnIndex: 0,
    });
    toolSettings.push(
    ...
    const useAngleLock = this.useAngleProperty.toDialogItem({
      rowPriority: 3,
      columnIndex: 0,
    });
    toolSettings.push(
...
export class ExtrudeCurveTool extends ModifyCurveTool {
  ...
  protected override allowView(vp: Viewport) {
    return vp.view.is3d();
  }
  ...
  public get cappedProperty() {
    if (!this._cappedProperty)
      this._cappedProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "extrudeCapped",
          EditTools.translate("ExtrudeCurve.Label.Capped")
        ),
        true
      );
    return this._cappedProperty;
  ...
  public get orthogonalProperty() {
    if (!this._orthogonalProperty)
      this._orthogonalProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "extrudeOrthogonal",
          EditTools.translate("ExtrudeCurve.Label.Orthogonal")
        ),
        true
      );
    return this._orthogonalProperty;
  ...
  public get keepProfileProperty() {
    if (!this._keepProfileProperty)
      this._keepProfileProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "extrudeKeepProfile",
          EditTools.translate("ExtrudeCurve.Label.KeepProfile")
        ),
        false
      );
  ...
  public get keepProfile(): boolean {
    return this.keepProfileProperty.value;
  }
  public set keepProfile(value: boolean) {
  ...
  protected override modifyCurve(
    ...
    const spacePoint = this.orthogonal
      ? AccuDrawHintBuilder.projectPointToLineInView(
          ev.point,
          this.anchorPoint,
  ...
  public get cappedProperty() {
    if (!this._cappedProperty)
      this._cappedProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "revolveCapped",
          EditTools.translate("RevolveCurve.Label.Capped")
        ),
        true
      );
    return this._cappedProperty;
  ...
  public get keepProfileProperty() {
    if (!this._keepProfileProperty)
      this._keepProfileProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "revolveKeepProfile",
          EditTools.translate("RevolveCurve.Label.KeepProfile")
        ),
        false
      );
    return this._keepProfileProperty;
