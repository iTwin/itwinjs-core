...
import {
  ElementGeometryCacheTool,
  isSameSubEntity,
  LocateSubEntityTool,
  SubEntityData,
} from "./ElementGeometryTool";
...
export abstract class BooleanOperationTool extends ElementGeometryCacheTool {
  ...
  protected override get allowSelectionSet(): boolean {
    return BooleanMode.Subtract !== this.mode;
  }
  ...
  protected override get requiredElementCount(): number {
    return 2;
  }
  ...
  protected override get geometryCacheFilter():
    ...
    return {
      parts: true,
      curves: false,
      surfaces: BooleanMode.Subtract === this.mode && !this.agenda.isEmpty,
      solids: true,
      other: false,
    };
  }
  ...
  protected override async onAgendaModified(): Promise<void> {
    ...
    if (
      BooleanMode.Subtract === this.mode &&
      (this.agenda.isEmpty || 1 === this.agenda.length)
    )
      this.onGeometryCacheFilterChanged();
  }

  protected async applyAgendaOperation(): Promise<
    ElementGeometryResultProps | undefined
  > {
    if (this.agenda.length < this.requiredElementCount) return undefined;
...
export class UniteSolidElementsTool extends BooleanOperationTool {
  ...
  protected override get mode(): BooleanMode {
    return BooleanMode.Unite;
  }
...
export class ThickenSheetElementsTool extends ElementGeometryCacheTool {
  ...
  public get frontDistanceProperty() {
    if (!this._frontDistanceProperty)
      this._frontDistanceProperty = new DialogProperty<number>(
        new LengthDescription(
          "thickenFront",
          EditTools.translate("ThickenSheets.Label.FrontDistance")
        ),
        0.1,
        undefined
      );
  ...
  public get frontDistance(): number {
    return this.frontDistanceProperty.value;
  }
  public set frontDistance(value: number) {
    this.frontDistanceProperty.value = value;
  }
  ...
  public get backDistanceProperty() {
    if (!this._backDistanceProperty)
      this._backDistanceProperty = new DialogProperty<number>(
        new LengthDescription(
          "thickenBack",
          EditTools.translate("ThickenSheets.Label.BackDistance")
        ),
        0.0,
        undefined
      );
  ...
  public get backDistance(): number {
    return this.backDistanceProperty.value;
  }
  public set backDistance(value: number) {
    this.backDistanceProperty.value = value;
  }
  ...
  > {
    ...
    try {
      this._startedCmd = await this.startCommand();
      const target = this.agenda.elements[0];
      const params: ThickenSheetProps = {
        front: this.frontDistance,
        back: this.backDistance,
      };
      const opts: ElementGeometryResultOptions = { writeChanges: true };
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    this.initializeToolSettingPropertyValues([
      this.frontDistanceProperty,
      this.backDistanceProperty,
    ]);

    const toolSettings = new Array<DialogItem>();
    toolSettings.push(
      this.frontDistanceProperty.toDialogItem({
        rowPriority: 1,
        columnIndex: 0,
      })
    );
    toolSettings.push(
      this.backDistanceProperty.toDialogItem({ rowPriority: 2, columnIndex: 0 })
    );
    return toolSettings;
  }
...
export class CutSolidElementsTool extends ElementGeometryCacheTool {
    ...
    if (!this._bothDirectionsProperty)
      this._bothDirectionsProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "cutBothDirections",
          EditTools.translate("CutSolids.Label.BothDirections")
        ),
        false
      );
  ...
  public get bothDirections(): boolean {
    return this.bothDirectionsProperty.value;
  }
  public set bothDirections(value: boolean) {
    this.bothDirectionsProperty.value = value;
  }
  ...
  public get outsideProperty() {
    if (!this._outsideProperty)
      this._outsideProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "cutOutside",
          EditTools.translate("CutSolids.Label.Outside")
        ),
        false
      );
  ...
  public get outside(): boolean {
    return this.outsideProperty.value;
  }
  public set outside(value: boolean) {
    this.outsideProperty.value = value;
  }

  private _useDepthProperty: DialogProperty<boolean> | undefined;
  public get useDepthProperty() {
    if (!this._useDepthProperty)
      this._useDepthProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildLockPropertyDescription("useCutDepth"),
        false
      );
    return this._useDepthProperty;
  }

  public get useDepth(): boolean {
    return this.useDepthProperty.value;
  }
  public set useDepth(value: boolean) {
    this.useDepthProperty.value = value;
  }

  private _depthProperty: DialogProperty<number> | undefined;
  public get depthProperty() {
    if (!this._depthProperty)
      this._depthProperty = new DialogProperty<number>(
        new LengthDescription(
          "cutDepth",
          EditTools.translate("CutSolids.Label.Depth")
        ),
        0.1,
        undefined,
        !this.useDepth
  ...
  public get depth(): number {
    return this.depthProperty.value;
  }
  public set depth(value: number) {
    this.depthProperty.value = value;
  }
  ...
  protected override get geometryCacheFilter():
    ...
    return {
      minGeom: 1,
      maxGeom: profilePhase ? 1 : undefined,
      parts: true,
      curves: profilePhase,
      surfaces: profilePhase,
      solids: !profilePhase,
      other: false,
    };
  }
  ...
  protected override async createElementGeometryCache(
    ...
    if (!(await super.createElementGeometryCache(id))) return false;

    if (!this.isProfilePhase) return true;
  ...
  > {
    ...
    const direction = this.bothDirections
      ? CutDirectionMode.Both
      : CutDirectionMode.Auto;
    ...
    try {
      ...
      const params: CutProps = {
        profile,
        direction,
        depth,
        distance: this.depth,
        outside: this.outside ? true : undefined,
        closeOpen: ProfileClosure.Auto,
        targetPoint: this.targetPoint,
        toolPoint: this.toolPoint,
      };
      const opts: ElementGeometryResultOptions = { writeChanges: true };
  ...
  protected override async buildLocateAgenda(hit: HitDetail): Promise<boolean> {
    if (this.isProfilePhase) this.toolPoint = hit.hitPoint;
    else this.targetPoint = hit.hitPoint;
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    this.initializeToolSettingPropertyValues([
      this.bothDirectionsProperty,
      this.outsideProperty,
      this.useDepthProperty,
      this.depthProperty,
    ]);

    const toolSettings = new Array<DialogItem>();
    toolSettings.push(
      this.bothDirectionsProperty.toDialogItem({
        rowPriority: 1,
        columnIndex: 0,
      })
    );
    toolSettings.push(
      this.outsideProperty.toDialogItem({ rowPriority: 2, columnIndex: 0 })
    );

    // ensure controls are enabled/disabled based on current lock property state
    this.depthProperty.isDisabled = !this.useDepth;
    const useDepthLock = this.useDepthProperty.toDialogItem({
      rowPriority: 3,
      columnIndex: 0,
    });
    toolSettings.push(
      this.depthProperty.toDialogItem(
...
export class EmbossSolidElementsTool extends ElementGeometryCacheTool {
  ...
  > {
    ...
    try {
      ...
      const target = this.agenda.elements[0];
      const profile = this.agenda.elements[1];
      const params: EmbossProps = {
        profile,
        direction: EmbossDirectionMode.Auto,
        targetPoint: this.targetPoint,
      };
      const opts: ElementGeometryResultOptions = { writeChanges: true };
  ...
  protected override async buildLocateAgenda(hit: HitDetail): Promise<boolean> {
    if (!this.isProfilePhase) this.targetPoint = hit.hitPoint;
...
export class LoftProfilesTool extends ElementGeometryCacheTool {
  ...
  > {
    ...
    try {
      ...
      const params: LoftProps = {
        tools,
        orderCurves: this.isSelectionSetModify ? true : undefined,
        orientCurves: true,
      };
      const opts: ElementGeometryResultOptions = { writeChanges: true };
...
export class OffsetFacesTool extends LocateSubEntityTool {
  ...
  public get addSmoothProperty() {
    if (!this._addSmoothProperty)
      this._addSmoothProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "offsetSmooth",
          EditTools.translate("OffsetFaces.Label.AddSmooth")
        ),
        false
      );
  ...
  public get addSmooth(): boolean {
    return this.addSmoothProperty.value;
  }
  public set addSmooth(value: boolean) {
    this.addSmoothProperty.value = value;
  }
  ...
  public get useDistance(): boolean {
    return this.useDistanceProperty.value;
  }
  public set useDistance(value: boolean) {
    this.useDistanceProperty.value = value;
  }
  ...
  public get distanceProperty() {
    if (!this._distanceProperty)
      this._distanceProperty = new DialogProperty<number>(
        new LengthDescription(
          "offsetDistance",
          EditTools.translate("OffsetFaces.Label.Distance")
        ),
        0.1,
        undefined,
        !this.useDistance
  ...
  public set distance(value: number) {
    this.distanceProperty.value = value;
  }
  ...
  protected override async createSubEntityData(
    id: Id64String,
  ...
  protected override drawAcceptedSubEntities(context: DecorateContext): void {
    ...
    const faceData = this.getAcceptedSubEntityData()
      ?.toolData as FaceLocationData;
    if (undefined === faceData) return;
  ...
  protected override async applyAgendaOperation(
    ...
    if (
      ...
      this.agenda.isEmpty ||
      !this.haveAcceptedSubEntities
    )
      return undefined;

    const faceData = this.getAcceptedSubEntityData()
      ?.toolData as FaceLocationData;
    if (undefined === faceData) return undefined;

    const projPt = AccuDrawHintBuilder.projectPointToLineInView(
      ev.point,
      faceData.point,
      faceData.normal,
      ev.viewport
    ...
    if (undefined === projPt) return undefined;

    const offsetDir = Vector3d.createStartEnd(faceData.point, projPt);

    if (
      this.useDistance &&
      undefined === offsetDir.scaleToLength(this.distance, offsetDir)
    )
      return undefined;

    let offset = offsetDir.magnitude();

    if (offset < Geometry.smallMetricDistance) return undefined;

    if (offsetDir.dotProduct(faceData.normal) < 0.0) offset = -offset;
    ...
    try {
      ...
      if (this.addSmooth) {
        ...
        for (const face of faces) {
          ...
          if (undefined !== smoothFaces) allSmoothFaces.push(...smoothFaces);
        }

        for (const smooth of allSmoothFaces) {
          if (
            undefined ===
            faces.find((selected) => isSameSubEntity(selected, smooth))
          )
  ...
  protected override setupAccuDraw(): void {
    if (!this.haveAcceptedSubEntities) return;
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    ...
    const useDistanceLock = this.useDistanceProperty.toDialogItem({
      rowPriority: 1,
      columnIndex: 0,
    });
    toolSettings.push(
    ...
    toolSettings.push(
      this.addSmoothProperty.toDialogItem({ rowPriority: 2, columnIndex: 0 })
    );
...
export class HollowFacesTool extends LocateSubEntityTool {
  ...
  public get shellThicknessProperty() {
    if (!this._shellThicknessProperty)
      this._shellThicknessProperty = new DialogProperty<number>(
        new LengthDescription(
          "hollowShellThickness",
          EditTools.translate("HollowFaces.Label.ShellThickness")
        ),
        0.1,
        undefined
      );
  ...
  public get shellThickness(): number {
    return this.shellThicknessProperty.value;
  }
  public set shellThickness(value: number) {
    this.shellThicknessProperty.value = value;
  }
  ...
  public get faceThicknessProperty() {
    if (!this._faceThicknessProperty)
      this._faceThicknessProperty = new DialogProperty<number>(
        new LengthDescription(
          "hollowFaceThickness",
          EditTools.translate("HollowFaces.Label.FaceThickness")
        ),
        0.0,
        undefined
      );
  ...
  public get faceThickness(): number {
    return this.faceThicknessProperty.value;
  }
  public set faceThickness(value: number) {
    this.faceThicknessProperty.value = value;
  }
  ...
  protected override async applyAgendaOperation(
    ...
    try {
      this._startedCmd = await this.startCommand();
      const params: HollowFacesProps = {
        faces: this.getAcceptedSubEntities(),
        distances: this.faceThickness,
        defaultDistance: this.shellThickness,
      };
      const opts: ElementGeometryResultOptions = {
        wantGraphic: isAccept ? undefined : true,
        chordTolerance: computeChordToleranceFromPoint(ev.viewport, ev.point),
      ...
      return await solidModelingIpc.hollowFaces(
        this.agenda.elements[0],
        params,
        opts
      );
    } catch (err) {
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    this.initializeToolSettingPropertyValues([
      this.shellThicknessProperty,
      this.faceThicknessProperty,
    ]);

    const toolSettings = new Array<DialogItem>();
    toolSettings.push(
      this.shellThicknessProperty.toDialogItem({
        rowPriority: 1,
        columnIndex: 0,
      })
    );
    toolSettings.push(
      this.faceThicknessProperty.toDialogItem({
        rowPriority: 2,
        columnIndex: 0,
      })
    );
...
export class DeleteSubEntitiesTool extends LocateSubEntityTool {
  ...
  protected override wantSubEntityType(type: SubEntityType): boolean {
    switch (type) {
      ...
      case SubEntityType.Edge:
        ...
        return (
          0 === this._acceptedSubEntities.length ||
          this._acceptedSubEntities[0].props.type === type
        );
      default:
        return false;
    }
  ...
  protected override getMaximumSubEntityHits(type: SubEntityType): number {
    if (!this.wantSubEntityType(type)) return 0;
  ...
  protected override async doPickSubEntities(
    id: Id64String,
    ev: BeButtonEvent
  ): Promise<SubEntityLocationProps[] | undefined> {
    const hits = await super.doPickSubEntities(id, ev);

    if (undefined === hits) return hits;

    // Don't allow reset to select a back edge...
    if (SubEntityType.Face === hits[0].subEntity.type)
      return hits.filter((hit) => {
        return SubEntityType.Face === hit.subEntity.type;
      });

    try {
      const accept = await solidModelingIpc.isRedundantEdge(
        id,
        hits[0].subEntity
      );

      if (accept) return hits;
  ...
  protected override async applyAgendaOperation(
    ...
    try {
      this._startedCmd = await this.startCommand();
      const params: DeleteSubEntityProps = {
        subEntities: this.getAcceptedSubEntities(),
      };
      const opts: ElementGeometryResultOptions = {
        wantGraphic: isAccept ? undefined : true,
        chordTolerance: computeChordToleranceFromPoint(ev.viewport, ev.point),
      ...
      return await solidModelingIpc.deleteSubEntities(
        this.agenda.elements[0],
        params,
        opts
      );
...
export class ImprintSolidElementsTool extends LocateSubEntityTool {
  ...
  private static methodMessage(str: string) {
    return EditTools.translate(`ImprintSolids.Method.${str}`);
  }
  private static getMethodChoices = (): EnumerationChoice[] => {
    return [
      {
        label: ImprintSolidElementsTool.methodMessage("Element"),
        value: ImprintSolidMethod.Element,
      },
      {
        label: ImprintSolidElementsTool.methodMessage("Edges"),
        value: ImprintSolidMethod.Edges,
      },
      {
        label: ImprintSolidElementsTool.methodMessage("Points"),
        value: ImprintSolidMethod.Points,
      },
    ];
  };
    ...
    if (!this._methodProperty)
      this._methodProperty = new DialogProperty<number>(
        PropertyDescriptionHelper.buildEnumPicklistEditorDescription(
          "imprintMethod",
          EditTools.translate("ImprintSolids.Label.Method"),
          ImprintSolidElementsTool.getMethodChoices()
        ),
        ImprintSolidMethod.Element as number
      );
    return this._methodProperty;
  }

  public get method(): ImprintSolidMethod {
    return this.methodProperty.value as ImprintSolidMethod;
  }
  public set method(method: ImprintSolidMethod) {
  ...
  public get distanceProperty() {
    if (!this._distanceProperty)
      this._distanceProperty = new DialogProperty<number>(
        new LengthDescription(
          "imprintDistance",
          EditTools.translate("ImprintSolids.Label.Distance")
        ),
        0.1,
        undefined
      );
  ...
  public get extendProperty() {
    if (!this._extendProperty)
      this._extendProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "imprintExtend",
          EditTools.translate("ImprintSolids.Label.Extend")
        ),
        false
      );
  ...
  public get extend(): boolean {
    return this.extendProperty.value;
  }
  public set extend(value: boolean) {
    this.extendProperty.value = value;
  }

  protected override get requiredSubEntityCount(): number {
    return ImprintSolidMethod.Element === this.method ? 0 : 1;
  }
  protected override get requiredElementCount(): number {
    return ImprintSolidMethod.Element === this.method ? 2 : 1;
  }
  protected override get allowSubEntityControlSelect(): boolean {
    return ImprintSolidMethod.Edges === this.method;
  }
  protected override get inhibitSubEntityDisplay(): boolean {
    return ImprintSolidMethod.Points === this.method
      ? false
      : super.inhibitSubEntityDisplay;
  }
  ...
  protected override get wantAccuSnap(): boolean {
    return ImprintSolidMethod.Points === this.method && this.isDynamicsStarted;
  }
  ...
  protected override async onAgendaModified(): Promise<void> {
    ...
    if (
      ImprintSolidMethod.Element === this.method &&
      (this.agenda.isEmpty || 1 === this.agenda.length)
    )
      this.onGeometryCacheFilterChanged();
  }
  ...
  protected override async applyAgendaOperation(
    ...
    try {
      ...
      if (ImprintSolidMethod.Points === this.method) {
        if (!this.haveAcceptedSubEntities) return undefined;

        const geom = ElementGeometry.fromGeometryQuery(
        ...
        params = {
          imprint: geom,
          face: this.getAcceptedSubEntityData(0)?.props,
          extend: this.extend ? true : undefined,
        };
        ...
        if (undefined === edge) return undefined;

        const edgeFaces = await solidModelingIpc.getConnectedSubEntities(
          id,
          edge,
          SubEntityType.Face
        );
        if (undefined === edgeFaces || 0 === edgeFaces.length) return undefined;

        // TODO: Check planar face...get preferred face from cursor location in dynamics, etc.
        const edgeLoop = await solidModelingIpc.getConnectedSubEntities(
          id,
          edge,
          SubEntityType.Edge,
          { loopFace: edgeFaces[0] }
        );
        if (undefined === edgeLoop || 0 === edgeLoop.length) return undefined;
        ...
        params = {
          imprint: this.agenda.elements[1],
          extend: this.extend ? true : undefined,
        };
      }
  ...
  protected override async gatherInput(
    ...
    switch (this.method) {
      case ImprintSolidMethod.Points: {
        if (!this.haveAcceptedSubEntities) break;

        this.points.push(ev.point.clone());
        if (!ev.isControlKey) break;
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    ...
    switch (this.method) {
      case ImprintSolidMethod.Element:
        toolSettings.push(
          this.extendProperty.toDialogItem({ rowPriority: 2, columnIndex: 0 })
        );
        break;
      case ImprintSolidMethod.Edges:
        toolSettings.push(
          this.distanceProperty.toDialogItem({ rowPriority: 2, columnIndex: 0 })
        );
        break;
      case ImprintSolidMethod.Points:
        toolSettings.push(
...
export abstract class BlendEdgesTool extends LocateSubEntityTool {
  ...
  public get addSmoothProperty() {
    if (!this._addSmoothProperty)
      this._addSmoothProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "blendSmooth",
          EditTools.translate("RoundEdges.Label.AddSmooth")
        ),
        false
      );
    return this._addSmoothProperty;
  ...
  protected override wantSubEntityType(type: SubEntityType): boolean {
    return SubEntityType.Edge === type;
  }
  ...
  protected async getTangentEdges(
    id: Id64String,
    edge: SubEntityProps
  ): Promise<SubEntityProps[] | undefined> {
    try {
  ...
  protected async addTangentEdges(
    id: Id64String,
    edge?: SubEntityProps,
    ...
    if (undefined === edge) {
      this._acceptedSubEntities.forEach(async (accepted) => {
        if (undefined === accepted.toolData)
          await this.addTangentEdges(
            id,
            accepted.props,
            accepted.chordTolerance
          );
      });
      return;
    }
    ...
    if (undefined === tangentEdges) return;
  ...
  protected async removeTangentEdges(
    _id: Id64String,
    edge?: SubEntityProps
  ): Promise<void> {
    if (undefined === edge) {
      this._acceptedSubEntities = this._acceptedSubEntities.filter(
        (entry) => undefined === entry.toolData
      );
      return;
    }

    const edgeData = this._acceptedSubEntities.find((entry) =>
      isSameSubEntity(entry.props, edge)
    );
    if (undefined === edgeData) return undefined;

    const isTangentEdge = (other: SubEntityData): boolean => {
      const primaryOther =
        undefined !== other.toolData ? other.toolData : other.props;
      return isSameSubEntity(primaryEdge, primaryOther);
    };

    const primaryEdge =
      undefined !== edgeData.toolData ? edgeData.toolData : edgeData.props;
    this._acceptedSubEntities = this._acceptedSubEntities.filter(
      (entry) => !isTangentEdge(entry)
    );
  }
  ...
  protected async syncTangentEdges(): Promise<void> {
    ...
    if (this.addSmooth) await this.addTangentEdges(id);
    else await this.removeTangentEdges(id);
  ...
  protected override async removeSubEntity(
    ...
    if (!this.addSmooth) return super.removeSubEntity(id, props);

    const edge =
      undefined !== props
        ? props.subEntity
        : this.getAcceptedSubEntityData()?.props;
    if (undefined === edge) return;
  ...
  protected override getAcceptedSubEntities(): SubEntityProps[] {
    ...
    this._acceptedSubEntities.forEach((entry) => {
      if (undefined === entry.toolData) edges.push(entry.props);
    });
...
export class RoundEdgesTool extends BlendEdgesTool {
  ...
  public get radiusProperty() {
    if (!this._radiusProperty)
      this._radiusProperty = new DialogProperty<number>(
        new LengthDescription(
          "roundRadius",
          EditTools.translate("RoundEdges.Label.Radius")
        ),
        0.1,
        undefined
      );
  ...
  protected override async applyAgendaOperation(
    ...
    try {
      this._startedCmd = await this.startCommand();
      const params: BlendEdgesProps = {
        edges: this.getAcceptedSubEntities(),
        radii: this.radius,
        propagateSmooth: this.addSmooth,
      };
      const opts: ElementGeometryResultOptions = {
        wantGraphic: isAccept ? undefined : true,
        chordTolerance: computeChordToleranceFromPoint(ev.viewport, ev.point),
      ...
      return await solidModelingIpc.blendEdges(
        this.agenda.elements[0],
        params,
        opts
      );
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    ...
    const toolSettings = new Array<DialogItem>();
    toolSettings.push(
      this.radiusProperty.toDialogItem({ rowPriority: 1, columnIndex: 0 })
    );
    toolSettings.push(
      this.addSmoothProperty.toDialogItem({ rowPriority: 2, columnIndex: 0 })
    );
...
export class ChamferEdgesTool extends BlendEdgesTool {
  ...
  private static methodMessage(str: string) {
    return EditTools.translate(`ChamferEdges.Method.${str}`);
  }
  private static getMethodChoices = (): EnumerationChoice[] => {
    return [
      {
        label: ChamferEdgesTool.methodMessage("Length"),
        value: ChamferMode.Length,
      },
      {
        label: ChamferEdgesTool.methodMessage("Distances"),
        value: ChamferMode.Distances,
      },
      {
        label: ChamferEdgesTool.methodMessage("DistanceAngle"),
        value: ChamferMode.DistanceAngle,
      },
      {
        label: ChamferEdgesTool.methodMessage("AngleDistance"),
        value: ChamferMode.AngleDistance,
      },
    ];
  };
  ...
  public get methodProperty() {
    if (!this._methodProperty)
      this._methodProperty = new DialogProperty<number>(
        PropertyDescriptionHelper.buildEnumPicklistEditorDescription(
          "chamferMethod",
          EditTools.translate("ChamferEdges.Label.Method"),
          ChamferEdgesTool.getMethodChoices()
        ),
        ChamferMode.Length as number
      );
    return this._methodProperty;
  }

  public get method(): ChamferMode {
    return this.methodProperty.value as ChamferMode;
  }
  public set method(method: ChamferMode) {
    this.methodProperty.value = method;
  }
  ...
  public get lengthProperty() {
    if (!this._lengthProperty)
      this._lengthProperty = new DialogProperty<number>(
        new LengthDescription(
          "chamferLength",
          EditTools.translate("ChamferEdges.Label.Length")
        ),
        0.1,
        undefined
      );
  ...
  public get length(): number {
    return this.lengthProperty.value;
  }
  public set length(value: number) {
    this.lengthProperty.value = value;
  }
  ...
  public get distanceLeftProperty() {
    if (!this._distanceLeftProperty)
      this._distanceLeftProperty = new DialogProperty<number>(
        new LengthDescription(
          "chamferLeftDist",
          EditTools.translate("ChamferEdges.Label.LeftDistance")
        ),
        0.1,
        undefined
      );
  ...
  public get distanceLeft(): number {
    return this.distanceLeftProperty.value;
  }
  public set distanceLeft(value: number) {
    this.distanceLeftProperty.value = value;
  }
  ...
  public get distanceRightProperty() {
    if (!this._distanceRightProperty)
      this._distanceRightProperty = new DialogProperty<number>(
        new LengthDescription(
          "chamferRightDist",
          EditTools.translate("ChamferEdges.Label.RightDistance")
        ),
        0.1,
        undefined
      );
  ...
  public get distanceRight(): number {
    return this.distanceRightProperty.value;
  }
  public set distanceRight(value: number) {
    this.distanceRightProperty.value = value;
  }
    ...
    if (!this._angleProperty)
      this._angleProperty = new DialogProperty<number>(
        new AngleDescription(
          "chamferAngle",
          EditTools.translate("ChamferEdges.Label.Angle")
        ),
        Angle.piOver4Radians,
        undefined,
        false
      );
  ...
  protected override async applyAgendaOperation(
    ...
    try {
      ...
      const params: ChamferEdgesProps = {
        edges: this.getAcceptedSubEntities(),
        mode: this.method,
        values1,
        values2,
      ...
      return await solidModelingIpc.chamferEdges(
        this.agenda.elements[0],
        params,
        opts
      );
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    this.initializeToolSettingPropertyValues([
      ...
      this.addSmoothProperty,
      this.lengthProperty,
      this.distanceLeftProperty,
      this.distanceRightProperty,
      this.angleProperty,
    ]);
    ...
    toolSettings.push(
      this.addSmoothProperty.toDialogItem({
        rowPriority: ChamferMode.Length === this.method ? 3 : 4,
        columnIndex: 0,
      })
    );
    ...
    switch (this.method) {
      case ChamferMode.Length:
        toolSettings.push(
          this.lengthProperty.toDialogItem({ rowPriority: 2, columnIndex: 0 })
        );
        break;
      case ChamferMode.Distances:
        toolSettings.push(
          this.distanceLeftProperty.toDialogItem({
            rowPriority: 2,
            columnIndex: 0,
          })
        );
        toolSettings.push(
          this.distanceRightProperty.toDialogItem({
            rowPriority: 3,
            columnIndex: 0,
          })
        );
      ...
      case ChamferMode.DistanceAngle:
        ...
        toolSettings.push(
          this.angleProperty.toDialogItem({ rowPriority: 3, columnIndex: 0 })
        );
        break;
      case ChamferMode.AngleDistance:
        toolSettings.push(
...
export abstract class LocateFaceOrProfileTool extends LocateSubEntityTool {
  protected override get wantGeometrySummary(): boolean {
    return true;
  }
  ...
  protected override async doPickSubEntities(
    ...
    const accept =
      BRepEntityType.Wire ===
      this.getBRepEntityTypeForSubEntity(id, hits[0].subEntity)
        ? SubEntityType.Edge
        : SubEntityType.Face;
  ...
  protected override async createSubEntityData(
    ...
    const point =
      id === snap?.sourceId && snap.isHot
        ? snap.snapPoint
        : Point3d.fromJSON(hit.point);
    const matrix =
      id === snap?.sourceId
        ? AccuDraw.getSnapRotation(snap, undefined)
        : undefined;
    ...
    if (undefined !== invMatrix)
      ...
      data.toolData = new ProfileLocationData(
        point,
        undefined !== hit.normal
          ? Vector3d.fromJSON(hit.normal)
          : Vector3d.unitZ()
      );
  ...
  protected override drawSubEntity(
    ...
    if (
      undefined !== id &&
      BRepEntityType.Solid !==
        this.getBRepEntityTypeForSubEntity(id, subEntity.props)
    )
  ...
  protected override drawAcceptedSubEntities(context: DecorateContext): void {
    ...
    const profileData = this.getAcceptedSubEntityData()
      ?.toolData as ProfileLocationData;
    if (undefined === profileData) return;
...
export class SweepFacesTool extends LocateFaceOrProfileTool {
  ...
  protected override get wantSubEntitySnap(): boolean {
    return true;
  }
  ...
  public get addSmoothProperty() {
    if (!this._addSmoothProperty)
      this._addSmoothProperty = new DialogProperty<boolean>(
        PropertyDescriptionHelper.buildToggleDescription(
          "sweepSmooth",
          EditTools.translate("SweepFaces.Label.AddSmooth")
        ),
        false
      );
    return this._addSmoothProperty;
  ...
  public get distanceProperty() {
    if (!this._distanceProperty)
      this._distanceProperty = new DialogProperty<number>(
        new LengthDescription(
          "sweepDistance",
          EditTools.translate("SweepFaces.Label.Distance")
        ),
        0.1,
        undefined,
        !this.useDistance
  ...
  protected async getSmoothFaces(
    ...
    try {
      ...
      return await solidModelingIpc.getConnectedSubEntities(
        ...
        face,
        SubEntityType.Face,
        { smoothFaces: true, adjacentFaces: true }
      );
    } catch (err) {
      return undefined;
    }
  ...
  protected override async applyAgendaOperation(
    ...
    const profileData = this.getAcceptedSubEntityData()
      ?.toolData as ProfileLocationData;
    if (undefined === profileData) return undefined;

    const path = Vector3d.createStartEnd(profileData.point, ev.point);

    if (
      this.useDistance &&
      undefined === path.scaleToLength(this.distance, path)
    )
      return undefined;

    if (path.magnitude() < Geometry.smallMetricDistance) return undefined;
    ...
    try {
      ...
      if (
        SubEntityType.Edge === subEntities[0].type ||
        BRepEntityType.Solid !==
          this.getBRepEntityTypeForSubEntity(id, subEntities[0])
      ) {
      ...
      if (this.addSmooth) {
        ...
        for (const smooth of allSmoothFaces) {
          if (
            undefined ===
            subEntities.find((selected) => isSameSubEntity(selected, smooth))
          )
  ...
  protected override setupAccuDraw(): void {
    ...
    hints.setXAxis2(
      profileData.orientation instanceof Matrix3d
        ? profileData.orientation.getColumn(2)
...
export class SpinFacesTool extends LocateFaceOrProfileTool {
  ...
  public get angleProperty() {
    if (!this._angleProperty)
      this._angleProperty = new DialogProperty<number>(
        new AngleDescription(
          "spinAngle",
          EditTools.translate("SpinFaces.Label.Angle")
        ),
  ...
  protected override async applyAgendaOperation(
    ...
    if (
      ...
      this.agenda.isEmpty ||
      !this.haveAcceptedSubEntities ||
      this.points.length < (isAccept ? 2 : 1)
    )
      return undefined;
  ...
  protected override async gatherInput(
    ...
    if (!this.wantAdditionalSubEntities) this.points.push(ev.point.clone());
  ...
  protected override setupAccuDraw(): void {
    if (!this.haveAcceptedSubEntities || 0 !== this.points.length) return;
    ...
    else hints.setNormal(profileData.orientation);
  ...
  public override supplyToolSettingsProperties(): DialogItem[] | undefined {
    ...
    const toolSettings = new Array<DialogItem>();
    toolSettings.push(
      this.angleProperty.toDialogItem({ rowPriority: 1, columnIndex: 0 })
    );
    return toolSettings;
  }
