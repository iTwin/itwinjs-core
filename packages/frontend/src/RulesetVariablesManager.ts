...
import { VariableValueTypes, VariableValueJSON } from "@bentley/ecpresentation-common/lib/IRulesetVariablesManager";
import { RulesetVariableRpcRequestOptions } from "@bentley/ecpresentation-common/lib/ECPresentationRpcInterface";
...
export default class RulesetVariablesManager implements IRulesetVariablesManager {
  ...
  private async getValue(variableId: string, variableType: VariableValueTypes): Promise<VariableValueJSON> {
    return await ECPresentationRpcInterface.getClient().getRulesetVariableValue(this.createRequestOptions(variableId), variableType);
  }
  ...
  public async setString(variableId: string, value: string): Promise<void> {
    await ECPresentationRpcInterface.getClient().setRulesetVariableValue(this.createRequestOptions(variableId), VariableValueTypes.String, value);
  }
  ...
  public async setBool(variableId: string, value: boolean): Promise<void> {
    await ECPresentationRpcInterface.getClient().setRulesetVariableValue(this.createRequestOptions(variableId), VariableValueTypes.Bool, value);
  }
  ...
  public async setInt(variableId: string, value: number): Promise<void> {
    await ECPresentationRpcInterface.getClient().setRulesetVariableValue(this.createRequestOptions(variableId), VariableValueTypes.Int, value);
  }
  ...
  public async setInts(variableId: string, value: number[]): Promise<void> {
    await ECPresentationRpcInterface.getClient().setRulesetVariableValue(this.createRequestOptions(variableId), VariableValueTypes.IntArray, value);
  }
  ...
  public async setId64(variableId: string, value: Id64): Promise<void> {
    await ECPresentationRpcInterface.getClient().setRulesetVariableValue(this.createRequestOptions(variableId), VariableValueTypes.Id64, value.value);
  }
  ...
  public async setId64s(variableId: string, value: Id64[]): Promise<void> {
    await ECPresentationRpcInterface.getClient().setRulesetVariableValue(this.createRequestOptions(variableId),
