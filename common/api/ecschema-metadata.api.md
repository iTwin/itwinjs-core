...
export class Unit extends SchemaItem {
    ...
    protected _denominator?: number;
    // (undocumented)
    fromJSON(unitProps: IUnitProps): Promise<void>;
    // (undocumented)
    fromJSONSync(unitProps: IUnitProps): void;
    // (undocumented)
    get hasDenominator(): boolean;
    // (undocumented)
    get hasNumerator(): boolean;
    ...
    toJSON(standalone?: boolean, includeSchemaVersion?: boolean): IUnitProps;
    // @internal (undocumented)
    toXml(schemaXml: Document): Promise<Element>;
    // (undocumented)
    get unitSystem(): LazyLoadedUnitSystem | undefined;
...
export class XmlParser extends AbstractParser<Element> {
    ...
    // (undocumented)
    parseUnit(xmlElement: Element): IUnitProps;
    // (undocumented)
