...
export class CustomAttributeClass extends ECClass {
  ...
  // @internal
  static assertIsCustomAttributeClass(
    item?: SchemaItem
  ): asserts item is CustomAttributeClass;
  ...
  static isCustomAttributeClass(
    item?: SchemaItem
  ): item is CustomAttributeClass;
  // (undocumented)
  readonly schemaItemType: SchemaItemType;
  // @internal (undocumented)
  static get schemaItemType(): SchemaItemType;
...
// @internal
export type DelayedPromiseWithProps<TProps, TPayload> = TProps &
...
export interface DelayedPromiseWithPropsConstructor {
  ...
  ): TProps & DelayedPromise<TPayload>;
}
  ...
  implements CustomAttributeContainerProps
{
  ...
  cleanCache(): void;
  // @internal
  protected createPrimitiveArrayProperty(
    name: string,
  ...
  // @internal (undocumented)
  protected createStructArrayProperty(
    name: string,
  ...
  protected static mergeProperties(
    target: Property[],
    existingValues: Map<string, number>,
    propertiesToMerge: Iterable<Property>,
...
export class EntityClass extends ECClass implements HasMixins {
  ...
  // @internal (undocumented)
  protected createNavigationProperty(
    name: string,
...
export class Format extends SchemaItem {
  ...
  // @internal
  protected addUnit(
    unit: LazyLoadedUnit | LazyLoadedInvertedUnit,
    label?: string
  ): void;
  // @internal
  ...
  get units():
    | ReadonlyArray<
        [LazyLoadedUnit | LazyLoadedInvertedUnit, string | undefined]
      >
    | undefined;
  // (undocumented)
...
// @beta
export function isSupportedSchemaItemType(
...
export class KindOfQuantity extends SchemaItem {
  // @internal (undocumented)
  protected addPresentationFormat(
    format: LazyLoadedFormat | OverrideFormat,
    isDefault?: boolean
  ): void;
  // @internal
  static assertIsKindOfQuantity(
    item?: SchemaItem
  ): asserts item is KindOfQuantity;
  // @internal
  protected createFormatOverride(
    parent: Format,
    precision?: number,
    unitLabelOverrides?: Array<
      [LazyLoadedUnit | LazyLoadedInvertedUnit, string | undefined]
    >
  ): OverrideFormat;
  get defaultPresentationFormat():
    | LazyLoadedFormat
    | OverrideFormat
    | undefined;
  // (undocumented)
  ...
  static get schemaItemType(): SchemaItemType;
  // @internal
  protected setPersistenceUnit(
    value: LazyLoadedUnit | LazyLoadedInvertedUnit | undefined
  ): void;
  // @internal
...
// @public @preview (undocumented)
export type LazyLoadedSchemaItem<T extends SchemaItem> = SchemaItemKey &
  Promise<T>;
...
export class OverrideFormat {
  ...
  static createOverrideFormatFullName(
    parent: Format,
    precision?: DecimalPrecision | FractionalPrecision,
    unitAndLabels?: Array<
      [LazyLoadedUnit | LazyLoadedInvertedUnit, string | undefined]
...
export class PropertyCategory extends SchemaItem {
  ...
  constructor(schema: Schema, name: string);
  // @internal
  static assertIsPropertyCategory(
    item?: SchemaItem
  ): asserts item is PropertyCategory;
  // (undocumented)
...
// @internal (undocumented)
export function propertyTypeToString(
  type: PropertyType
):
  | "PrimitiveProperty"
  | "StructProperty"
...
export class RelationshipClass extends ECClass {
  ...
  constructor(schema: Schema, name: string, modifier?: ECClassModifier);
  // @internal
  static assertIsRelationshipClass(
    item?: SchemaItem
  ): asserts item is RelationshipClass;
  // @internal (undocumented)
  protected createNavigationProperty(
    name: string,
    relationship: string | RelationshipClass,
...
export class RelationshipConstraint implements CustomAttributeContainerProps {
  ...
  // @internal (undocumented)
  protected addCustomAttribute(customAttribute: CustomAttribute): void;
  static classCompatibleWithConstraint(
  ...
  get constraintClasses():
    | ReadonlyArray<LazyLoadedRelationshipConstraintClass>
    | undefined;
  // (undocumented)
  get customAttributes(): CustomAttributeSet | undefined;
  // (undocumented)
  ...
  protected removeClass(
    constraint: LazyLoadedRelationshipConstraintClass
  ): void;
  // (undocumented)
  get roleLabel(): string | undefined;
  get schema(): Schema;
  // @internal (undocumented)
  protected setAbstractConstraint(
...
export class Schema implements CustomAttributeContainerProps {
  ...
  // @internal
  protected createCustomAttributeClass(
    name: string,
    modifier?: ECClassModifier
  ...
  // @internal (undocumented)
  protected createItem<T extends SchemaItem>(
  ...
  // @internal
  protected createRelationshipClass(
    name: string,
    modifier?: ECClassModifier
  ...
  // (undocumented)
  getItem<T extends typeof SchemaItem>(
    name: string,
    itemConstructor: T
  ): Promise<InstanceType<T> | undefined>;
  getItems(): Iterable<SchemaItem>;
  // (undocumented)
  getItems<T extends typeof SchemaItem>(
    itemConstructor: T
  ): Iterable<InstanceType<T>>;
  getItemSync(name: string): SchemaItem | undefined;
  // (undocumented)
  getItemSync<T extends typeof SchemaItem>(
    name: string,
    itemConstructor: T
  ...
  ): Promise<SchemaItem | undefined>;
  // (undocumented)
  lookupItem<T extends typeof SchemaItem>(
    key: Readonly<SchemaItemKey> | string,
    itemConstructor: T
  ): Promise<InstanceType<T> | undefined>;
  lookupItemSync(key: Readonly<SchemaItemKey> | string): SchemaItem | undefined;
  // (undocumented)
  lookupItemSync<T extends typeof SchemaItem>(
    key: Readonly<SchemaItemKey> | string,
    itemConstructor: T
  ): InstanceType<T> | undefined;
  // (undocumented)
...
export class SchemaContext {
  ...
  getSchemaItem<T extends typeof SchemaItem>(
    schemaNameOrKey: SchemaItemKey | string,
    itemNameOrCtor?: T
  ): Promise<InstanceType<T> | undefined>;
  // (undocumented)
  getSchemaItem<T extends typeof SchemaItem>(
  ...
  getSchemaItems(): Iterable<SchemaItem>;
  getSchemaItemSync<T extends typeof SchemaItem>(
    schemaNameOrKey: SchemaItemKey | string,
    itemNameOrCtor?: T
  ): InstanceType<T> | undefined;
  // (undocumented)
...
export class SchemaGraphUtil {
  static buildDependencyOrderedSchemaList(
    insertSchema: Schema,
    schemas?: Schema[]
  ): Schema[];
}
...
export class SchemaReadHelper<T = unknown> {
  constructor(
    parserType: AbstractParserConstructor<T>,
    context?: SchemaContext,
...
export class XmlParser extends AbstractParser<Element> {
  ...
  // (undocumented)
  getClassCustomAttributeProviders(
    xmlElement: Element
  ...
  // (undocumented)
  getPropertyCustomAttributeProviders(
    xmlElement: Element
  ): Iterable<CAProviderTuple>;
  // (undocumented)
  getReferences(): Iterable<SchemaReferenceProps>;
  // (undocumented)
  getRelationshipConstraintCustomAttributeProviders(
    xmlElement: Element
  ): [Iterable<CAProviderTuple>, Iterable<CAProviderTuple>];
  // (undocumented)
