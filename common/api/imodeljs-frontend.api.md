## API Review File for "@bentley/imodeljs-frontend"
...
export class IModelConnection extends IModel {
    ...
    static registerClass(className: string, classType: typeof EntityState): void;
...
// 
// src/tools/MeasureTool.ts:82:1 - (ae-forgotten-export) The symbol "MeasureMarker" needs to be exported by the entry point imodeljs-frontend.d.ts
