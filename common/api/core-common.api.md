...
export abstract class BentleyCloudRpcProtocol extends WebAppRpcProtocol {
  ...
  supplyPathForOperation(
    operation: RpcOperation,
    request: RpcRequest | undefined
  ): string;
  supplyPathParametersForOperation(
...
export class Cartographic implements CartographicProps {
  ...
  static geocentricLatitudeFromGeodeticLatitude(
  ...
  static parametricLatitudeFromGeodeticLatitude(
    geodeticLatitude: number
  ): number;
  static scalePointToGeodeticSurface(
    point: Point3d,
    result?: Point3d
  ): Point3d | undefined;
...
export namespace ChannelNotAllowedError {
  export function isChannelNotAllowedError(
    error: unknown
  ): error is ChannelNotAllowedError;
  export function throwChannelNotAllowedError(
    message?: string,
...
export namespace ChannelRootExistsError {
  export function isChannelRootExistsError(
    error: unknown
  ): error is ChannelsNestError;
  export function throwChannelRootExistsError(
    message?: string,
    metadata?: LoggingMetaData
  ): never;
}
...
export namespace ChannelsNestError {
  export function isChannelsNestError(
    error: unknown
  ): error is ChannelsNestError;
  export function throwChannelsNestError(
    message?: string,
    metadata?: LoggingMetaData
  ): never;
}
...
export class ColorDef {
  ...
  static computeTbgrFromComponents(
    red: number,
    green: number,
    blue: number,
    transparency?: number
...
export class ContextRealityModel {
  constructor(
    ...
    options?: {
      createClassifiers: (
        container: SpatialClassifiersContainer
      ) => SpatialClassifiers;
    }
  );
  ...
  readonly onAppearanceOverridesChanged: BeEvent<
    (
  ...
  >;
  // @beta
  readonly onDisplaySettingsChanged: BeEvent<
    (
  ...
  >;
  // @beta
  readonly onInvisibleChanged: BeEvent<
    (invisible: boolean, model: ContextRealityModel) => void
  >;
  readonly onPlanarClipMaskChanged: BeEvent<
    (
...
export namespace ContextRealityModelProps {
  export function clone(
    input: ContextRealityModelProps
...
export class ContextRealityModels {
  ...
  // @beta
  readonly onInvisibleChanged: BeEvent<
    (model: ContextRealityModel, invisible: boolean) => void
  >;
  readonly onPlanarClipMaskChanged: BeEvent<
    (
      model: ContextRealityModel,
...
export class DisplayStyleSettings {
  ...
  // @beta
  getRealityModelDisplaySettings(
    modelId: Id64String
  ...
  readonly onOverridesApplied: BeEvent<
    (overrides: Readonly<DisplayStyleSettingsProps>) => void
  >;
  readonly onPlanarClipMaskChanged: BeEvent<
    (
  ...
  >;
  readonly onPlanProjectionSettingsChanged: BeEvent<
    (
      modelId: Id64String,
  ...
  >;
  // @beta
  readonly onRealityModelDisplaySettingsChanged: BeEvent<
    (
      modelId: Id64String,
      newSettings: RealityModelDisplaySettings | undefined
    ) => void
  >;
  readonly onRenderTimelineChanged: BeEvent<
    (newRenderTimeline: Id64String | undefined) => void
  >;
  readonly onScheduleScriptPropsChanged: BeEvent<
    (newProps: Readonly<RenderSchedule.ScriptProps> | undefined) => void
  >;
  readonly onSolarShadowsChanged: BeEvent<
    (newSettings: SolarShadowSettings) => void
  >;
  readonly onSubCategoryOverridesChanged: BeEvent<
    (
...
export class EcefLocation implements EcefLocationProps {
  ...
  static createFromCartographicOrigin(
    origin: Cartographic,
    point?: Point3d,
    angle?: Angle
  ): EcefLocation;
...
export class ECSqlReader implements AsyncIterableIterator<QueryRowProxy> {
  ...
  // @internal
  constructor(
    _executor: DbRequestExecutor<DbQueryRequest, DbQueryResponse>,
    query: string,
    param?: QueryBinder,
...
export namespace ElementGeometry {
  ...
  export class Builder {
    ...
    static placementAnglesFromPoints(
      pts: Point3d[],
      defaultUp?: Vector3d,
  ...
  export function toTextStringGlyphData(
    entry: ElementGeometryDataEntry
  ): TextStringGlyphData | undefined;
...
export namespace GenericInstanceFilter {
  export function isFilterRuleGroup(
    obj: GenericInstanceFilterRule | GenericInstanceFilterRuleGroup
  ): obj is GenericInstanceFilterRuleGroup;
}
...
// @beta
export type GenericInstanceFilterRuleValue =
  | GenericInstanceFilterRuleNumericValue
  | GenericInstanceFilterRuleNonNumericValue;
...
export namespace GenericInstanceFilterRuleValue {
  ...
  export function isInstanceKey(
    value: GenericInstanceFilterRuleValue.Values
  ): value is GenericInstanceFilterRuleValue.InstanceKey;
  export function isPoint2d(
    value: GenericInstanceFilterRuleValue.Values
  ): value is GenericInstanceFilterRuleValue.Point2d;
  export function isPoint3d(
    value: GenericInstanceFilterRuleValue.Values
  ): value is GenericInstanceFilterRuleValue.Point3d;
  // (undocumented)
...
export class GeometryParams {
  ...
  setCategoryId(
    categoryId: Id64String,
    clearAppearanceOverrides?: boolean
  ): void;
  setSubCategoryId(
    subCategoryId: Id64String,
    clearAppearanceOverrides?: boolean
...
export class ImageMapLayerSettings extends MapLayerSettings {
  ...
  // @internal (undocumented)
  protected static mapTypeName(
    type: BackgroundMapType
  ): "Aerial Imagery" | "Aerial Imagery with labels" | "Streets";
  // (undocumented)
  password?: string;
  // @beta
...
export abstract class IModel implements IModelProps {
  ...
  readonly onChangesetChanged: BeEvent<
    (previousChangeset: ChangesetIdWithIndex) => void
  >;
  readonly onEcefLocationChanged: BeEvent<
    (previousLocation: EcefLocation | undefined) => void
  >;
  readonly onGeographicCoordinateSystemChanged: BeEvent<
  ...
  readonly onProjectExtentsChanged: BeEvent<
    (previousExtents: AxisAlignedBox3d) => void
  >;
  readonly onRootSubjectChanged: BeEvent<
...
export namespace InUseLocksError {
  ...
  export function throwInUseLocksError(
    inUseLocks: InUseLock[],
    message?: string,
    metadata?: LoggingMetaData
  ): never;
...
// @public
export function isBinaryImageSource(
  source: ImageSource
): source is BinaryImageSource;
...
// @public
export function isValidImageSourceFormat(
  format: number
): format is ImageSourceFormat;
...
export namespace RenderSchedule {
  ...
  export class Timeline {
    ...
    readonly color?: TimelineEntryList<
      ColorEntry,
      ColorEntryProps,
      RgbColor | undefined
    >;
    ...
    readonly cuttingPlane?: TimelineEntryList<
      CuttingPlaneEntry,
...
export abstract class RpcConfiguration {
  ...
  // @internal
  static assign<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>,
    supplier: RpcConfigurationSupplier
  ): void;
  static assignWithRouting<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>,
    routing: RpcRoutingToken,
  ...
  static obtain<T extends RpcConfiguration>(
    configurationConstructor: new () => T
  ): T;
  // @internal (undocumented)
  onRpcClientInitialized(
    definition: RpcInterfaceDefinition,
    client: RpcInterface
  ): void;
  // @internal (undocumented)
  onRpcClientTerminated(
    definition: RpcInterfaceDefinition,
    client: RpcInterface
  ): void;
  // @internal (undocumented)
  onRpcImplInitialized(
    definition: RpcInterfaceDefinition,
    impl: RpcInterface
  ): void;
  // @internal (undocumented)
...
export class RpcManager {
  ...
  static getClientForInterface<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>,
    routing?: RpcRoutingToken
  ): T;
  static initializeInterface<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>
  ): void;
  static registerImpl<
  ...
  static terminateInterface<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>
  ): void;
  static unregisterImpl<TDefinition extends RpcInterface>(
    definition: RpcInterfaceDefinition<TDefinition>
  ): void;
}
...
export namespace RpcOperation {
  ...
  ): <T extends RpcInterface>(definition: RpcInterfaceDefinition<T>) => void;
  ...
  export function setRoutingProps(
    handler: RpcRequestTokenSupplier_T
  ): <T extends RpcInterface>(
    target: T,
    propertyKey: string,
    descriptor: PropertyDescriptor
...
export class RpcRegistry {
  ...
  // (undocumented)
  getClientForInterface<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>,
    routing?: RpcRoutingToken
  ): T;
  // (undocumented)
  getImplForInterface<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>
  ): T;
  // (undocumented)
  id: () => number;
  ...
  // (undocumented)
  initializeRpcInterface<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>
  ): void;
  // (undocumented)
  static get instance(): RpcRegistry;
  // (undocumented)
  isRpcInterfaceInitialized<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>
  ): boolean;
  // (undocumented)
  ...
  // (undocumented)
  terminateRpcInterface<T extends RpcInterface>(
    definition: RpcInterfaceDefinition<T>
  ): void;
  // (undocumented)
  unregisterImpl<TDefinition extends RpcInterface>(
    definition: RpcInterfaceDefinition<TDefinition>
  ): void;
}
...
export namespace RpcRequestFulfillment {
  // (undocumented)
  export function forUnknownError(
    request: SerializedRpcRequest,
    error: any
...
export namespace RpcRequestStatus {
  ...
  export function isTransientError(
    ...
    | RpcRequestStatus.BadGateway
    | RpcRequestStatus.ServiceUnavailable
    | RpcRequestStatus.GatewayTimeout
    | RpcRequestStatus.RequestTimeout
    | RpcRequestStatus.TooManyRequests;
}
...
export class ThematicDisplaySensorSettings {
  ...
  // (undocumented)
  static fromJSON(
    json?: ThematicDisplaySensorSettingsProps
...
export class ThematicGradientSettings {
  ...
  // (undocumented)
  static fromJSON(
    json?: ThematicGradientSettingsProps
...
export class ViewDetails {
  // @internal
  constructor(jsonProperties: { viewDetails?: ViewDetailsProps });
  ...
  readonly onClipVectorChanged: BeEvent<
...
export class ViewDetails3d extends ViewDetails {
  // @internal
  constructor(jsonProperties: { viewDetails?: ViewDetails3dProps });
  ...
  readonly onModelClipGroupsChanged: BeEvent<
...
export namespace ViewStoreRpc {
  ...
  export interface Reader {
    ...
    getViewGroups(args: { parent?: ViewGroupSpec }): Promise<
      {
        id: IdString;
        name: string;
      }[]
...
export abstract class WebAppRpcProtocol extends RpcProtocol {
  ...
  abstract supplyPathParametersForOperation(
    _operation: RpcOperation
  ): OpenAPIParameter[];
  // (undocumented)
  supportsStatusCategory: boolean;
