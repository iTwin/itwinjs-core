...
// @beta
export const ColorPickerButton: (props: ColorPickerProps) => React_2.JSX.Element | null;
...
// @public @deprecated
export function ColorPickerPanel({ activeColor, onColorChange, colorPresets, colorInputType }: ColorPickerPanelProps): React_2.JSX.Element;
...
// @public
export const ColorPickerPopup: (props: ColorPickerPopupProps) => React_2.JSX.Element | null;
...
// @beta
export const QuantityNumberInput: (props: QuantityNumberInputProps) => React_2.JSX.Element | null;
