...
export class CurveFactory {
    ...
    static createFilletsInLineString(points: LineString3d | IndexedXYZCollection | Point3d[], radius: number | number[], allowBackupAlongEdge?: boolean, filletAtTheSeam?: boolean): Path | undefined;
