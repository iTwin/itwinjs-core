...
export class Format {
    ...
    static getTraitString(trait: FormatTraits): "keepSingleZero" | "showUnitLabel" | "fractionDash" | "keepDecimalPoint" | "trailZeroes" | "zeroEmpty" | "applyRounding" | "prependUnitLabel" | "use1000Separator" | "exponentOnlyNegative";
