...
export enum BridgeLoggerCategory {
  Framework = "itwin-connector-framework.Framework",
}
...
export class Synchronizer {
  constructor(
    imodel: IModelDb,
    _supportsMultipleFilesPerChannel: boolean,
    _requestContext?: AuthorizedClientRequestContext | undefined
  );
  detectChanges(
    scope: Id64String,
    sourceKind: string,
