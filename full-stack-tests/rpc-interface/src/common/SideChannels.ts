...
export function exposeBackendCallbacks() {
  ...
  registerBackendCallback(getClientAccessTokenCallbackName, async (clientConfiguration: ServiceAuthorizationClientConfiguration) => {
...
export async function getClientAccessTokenFromBackend(clientConfiguration: ServiceAuthorizationClientConfiguration): Promise<AccessToken> {
