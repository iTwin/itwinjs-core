...
import { EditTools, IpcConnection } from "@itwin/editor-frontend";
...
class TestEditTool1 extends PrimitiveTool {
  ...
  public testIpc = new IpcConnection<TestCommandIpc>();
  ...
  public async go(cmd: string, str1: string, str2: string, obj1: TestCmdOjb1) {
    ...
    testOut = await this.testIpc.connection.testMethod1(str1, str2, obj1);
  }
}
