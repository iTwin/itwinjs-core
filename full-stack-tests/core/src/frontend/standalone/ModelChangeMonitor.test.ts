...
import { addAllowedChannels, coreFullStackTestIpc, initializeEditTools, insertLineElement, makeModelCode, transformElements } from "../Editing";
...
if (!ProcessDetector.isMobileAppFrontend) {
  describe("Model change monitoring", () => {
    ...
    beforeEach(async () => {
      ...
      await addAllowedChannels(imodel, ["shared"]);
    });
