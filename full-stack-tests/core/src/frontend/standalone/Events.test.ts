...
describe("EventSource", () => {
  if (RpcPushChannel.enabled) {
    ...
    it("removes listeners upon disposal", () => {
      let dummy = 0; // eslint-disable-line @typescript-eslint/no-unused-vars
      const listener = (input: number) => { dummy += input; }; // eslint-disable-line @typescript-eslint/no-unused-vars
    ...
    it("adds and removes listeners for individual events", () => {
      ...
      const l2 = (input: number) => { dummy -= input; }; // eslint-disable-line @typescript-eslint/no-unused-vars
