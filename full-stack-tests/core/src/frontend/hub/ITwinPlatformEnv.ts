...
import {
  BriefcaseQuery,
  ChangeSet, ChangeSetQuery, IModelBankClient, IModelBankFileSystemContextClient, IModelHubClient, IModelQuery, VersionQuery,
...
/** Wraps the iModelHubClient to fulfill the methods needed for [[FrontendHubAccess]] and assist in other portions of the tests */
export class IModelHubFrontend implements TestFrontendHubAccess {
