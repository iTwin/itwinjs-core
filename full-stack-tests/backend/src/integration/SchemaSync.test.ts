...
import { BriefcaseDb, BriefcaseManager, CloudSqlite, HubMock, IModelDb, IModelHost, PullMergeMethod, SchemaSync, SnapshotDb, SqliteStatement } from "@itwin/core-backend";
...
for (const pullMergeMethod of ["Merge", "Rebase"] as PullMergeMethod[]) {
  describe(`Schema synchronization (PullMergeMethod: ${pullMergeMethod})`, function (this: Suite) {
    this.timeout(0);
