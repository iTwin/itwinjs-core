...
describe("ChangesetReaderAPI", async () => {
    ...
    <ECSchema schemaName="TestDomain" alias="ts" version="01.00" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.1">
		...
		if (undefined === drawingCategoryId) drawingCategoryId = DrawingCategory.insert(rwIModel, IModel.dictionaryId, "MyDrawingCategory", new SubCategoryAppearance());
	...
	it("Track changeset health stats", async () => {
		...
		// Import schema
		await firstBriefcase.importSchemaStrings([
      ...
      <ECSchema schemaName="TestSchema" alias="ts" version="1.0.0" xmlns="http://www.bentley.com/schemas/Bentley.ECXML.3.2">
		...
		if (undefined === drawingCategoryId) drawingCategoryId = DrawingCategory.insert(firstBriefcase, IModel.dictionaryId, "MyDrawingCategory", new SubCategoryAppearance());
		...
		reporter.addEntry("ChangesetReaderAPI", "ChangesetHealthStats", "Execution time (ms)", secondBriefcaseChangeset2.totalElapsedMs, {
			changesetId: secondBriefcaseChangeset2.changesetId,
			statementsExecuted: secondBriefcaseChangeset2.perStatementStats.length,
		});
