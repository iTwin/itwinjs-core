...
describe("SchemaLoaderPerformance", () => {
  ...
  function copyBisSchemasToAssetsDir() {
    ...
    fs.copyFileSync(
      getSchemaPath("Standard", "Units.01.00.07.ecschema.xml"),
      path.join(assetDir, "Units.01.00.07.ecschema.xml")
    );
    fs.copyFileSync(
      getSchemaPath("Standard", "Formats.01.00.00.ecschema.xml"),
    ...
    fs.copyFileSync(
      getSchemaPathFromPackage("cif-bridge-schema", "CifBridge.ecschema.xml"),
      path.join(assetDir, "CifBridge.ecschema.xml")
    );
    fs.copyFileSync(
      getSchemaPathFromPackage("cif-common-schema", "CifCommon.ecschema.xml"),
    ...
    fs.copyFileSync(
      getSchemaPathFromPackage("cif-rail-schema", "CifRail.ecschema.xml"),
      path.join(assetDir, "CifRail.ecschema.xml")
    );
    fs.copyFileSync(
      getSchemaPathFromPackage("cif-roads-schema", "CifRoads.ecschema.xml"),
    ...
    fs.copyFileSync(
      getSchemaPathFromPackage("cif-units-schema", "CifUnits.ecschema.xml"),
      path.join(assetDir, "CifUnits.ecschema.xml")
    );
    ...
    fs.copyFileSync(
      getSchemaPathFromPackage("aec-units-schema", "AecUnits.ecschema.xml"),
  ...
  function timeBisSchemasLoading(schemaName: string) {
    ...
    reporter.addEntry(
      ...
      `Get schema from imodel: ${schemaName}`,
      "Execution time(ms)",
      elapsedTime,
      {}
    );
