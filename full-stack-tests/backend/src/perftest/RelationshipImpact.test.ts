...
import type { GeometricElementProps, GeometryStreamProps, RelationshipProps} from "@itwin/core-common";
import {
  BriefcaseIdValue, Code, ColorDef, IModel, RelatedElement, SubCategoryAppearance,
