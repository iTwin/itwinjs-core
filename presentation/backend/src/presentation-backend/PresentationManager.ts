...
export class PresentationManager {
  ...
  private async request<TParams extends { diagnostics?: BackendDiagnosticsOptions, requestId: string, imodel: IModelDb, locale?: string, unitSystem?: UnitSystemKey, cancelEvent?: BeEvent<() => void> }, TResult>(params: TParams, reviver?: (key: string, value: any) => any): Promise<TResult> {
