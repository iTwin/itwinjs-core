...
import {
  ...
  HierarchyCompareOptions, HierarchyRequestOptions, InstanceKey, isSingleElementPropertiesRequestOptions, Key, KeySet, LabelDefinition,
  ...
  Ruleset, RulesetVariable, SelectClassInfo, SelectionScope, SelectionScopeRequestOptions, SingleElementPropertiesRequestOptions,
...
export class PresentationManager {
   ...
   * @public
   */
  public async computeSelection(requestOptions: SelectionScopeRequestOptions<IModelDb> & BackendDiagnosticsAttribute & { ids: Id64String[], scopeId: string }): Promise<KeySet> {
