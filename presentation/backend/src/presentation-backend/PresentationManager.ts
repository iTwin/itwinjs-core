 ...
 *
 * @public
 * @deprecated in 4.3 - will not be removed until 2026-06-13. The type has been moved to `@itwin/presentation-common` package.
 */
...
export interface PresentationManagerProps {
   ...
   *
   * @deprecated in 4.2 - will not be removed until 2026-06-13. This attribute is not used anymore - the package is not using private assets anymore.
   */
   ...
   *
   * @beta
   * @deprecated in 4.4 - will not be removed until 2026-06-13. The manager now always tracks for iModel data changes without polling.
   */
