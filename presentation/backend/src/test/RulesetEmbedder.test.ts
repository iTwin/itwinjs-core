...
describe("RulesetEmbedder", () => {
  ...
  function setupMocksForGettingRulesetModel() {
    ...
    elementsMock
      .setup((x) =>
        x.tryGetElement(
          DefinitionPartition.createCode(imodelMock.object, presentationRulesSubjectMock.object.id, "PresentationRules")
        )
      )
  ...
  function setupMocksForQueryingExistingRulesets(
    ...
    imodelMock
      .setup((x) =>
        x.createQueryReader(moq.It.isAnyString(), QueryBinder.from({ rulesetId }), {
