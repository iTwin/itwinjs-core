...
import {
  ...
  createRandomDescriptor, createRandomRuleset, createRandomId, createRandomSelectionScope, createRandomContent, createRandomLabelDefinitionJSON,
...
describe("PresentationRpcImplStateful", () => {
  ...
  it("uses default PresentationManager implementation if not overridden", () => {
    ...
    const impl = new PresentationRpcImplStateful();
  ...
  describe("calls forwarding", () => {
    ...
    let impl: PresentationRpcImplStateful;
    ...
    beforeEach(() => {
      ...
      impl = new PresentationRpcImplStateful();
