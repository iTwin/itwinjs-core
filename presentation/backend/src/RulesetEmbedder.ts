...
/** @hidden */
export default class RulesetEmbedder {
    ...
    /**
     * InsertRuleset
     *  @param ruleset: Ruleset to insert to iModel
     *  @param duplicateHandlingStrategy: Strategy for handling duplicate rulesets
     *  @returns Id of inserted ruleset
     */
    public async insertRuleset(ruleset: Ruleset, duplicateHandlingStrategy?: DuplicateHandlingStrategy): Promise<Id64String> {
        if (duplicateHandlingStrategy === undefined)
            duplicateHandlingStrategy = DuplicateHandlingStrategy.Skip;
    ...
    private handleDuplicateRuleset(ruleset: Ruleset, duplicateHandlingStrategy: DuplicateHandlingStrategy, rulesetId: Id64String): Id64String {
    ...
    /**
     * GetRulesets
     * @returns a list containing all rulesets found in iModel
     */
