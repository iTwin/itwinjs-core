...
- Make PresentationPropertyDataProvider.getData non-memoized. Instead, call an internal function which takes care of memoization. This makes the method easy to override.
...
- Fix viewport unified selection stopping working after imodel change.
