...
export interface PresentationManagerProps {
   ...
   * is used by default.
   *
   * @deprecated in 4.0 - will not be removed until 2026-06-13. Use [IModelApp.quantityFormatter]($core-frontend) to set the active unit system.
   */
...
export class PresentationManager implements Disposable {
   ...
   *
   * @deprecated in 4.0 - will not be removed until 2026-06-13. `IModelApp.quantityFormatter` should be used to get/set the active unit system. At the moment
  ...
  /**
   * Retrieves nodes
   * @deprecated in 4.5 - will not be removed until 2026-06-13. Use [[getNodesIterator]] instead.
   */
   ...
   * @deprecated in 4.5 - will not be removed until 2026-06-13. Use [[getContentIterator]] instead.
   */
   ...
   * @deprecated in 4.5 - will not be removed until 2026-06-13. Use [[getDistinctValuesIterator]] instead.
   */
  ...
  /**
   * Retrieves display label definition of specific items.
   * @deprecated in 4.5 - will not be removed until 2026-06-13. Use [[getDisplayLabelDefinitionsIterator]] instead.
   */
