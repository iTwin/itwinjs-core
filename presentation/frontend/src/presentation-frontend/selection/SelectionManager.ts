...
export interface SelectionManagerProps {
  /** A manager for [selection scopes]($docs/presentation/Unified-Selection/Terminology#selection-scope) */
...
export class SelectionManager implements ISelectionProvider {
  ...
  /** Manager for [selection scopes]($docs/presentation/Unified-Selection/Terminology#selection-scope) */
   ...
   * @param level Selection level (see [Selection levels]($docs/presentation/Unified-Selection/Terminology#selection-level))
  ...
  /**
   * Add keys to selection after applying [selection scope]($docs/presentation/Unified-Selection/Terminology#selection-scope) on them.
   * @param source Name of the selection source
   * @param imodel iModel associated with the selection
  ...
  /**
   * Remove keys from current selection after applying [selection scope]($docs/presentation/Unified-Selection/Terminology#selection-scope) on them.
   * @param source Name of the selection source
   * @param imodel iModel associated with the selection
  ...
  /**
   * Replace current selection with keys after applying [selection scope]($docs/presentation/Unified-Selection/Terminology#selection-scope) on them.
   * @param source Name of the selection source
   * @param imodel iModel associated with the selection
