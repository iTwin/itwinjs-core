 ...
 *
 * @public
 * @deprecated in 5.0 - will not be removed until 2026-06-13. Use `HiliteSet` from [@itwin/unified-selection](https://github.com/iTwin/presentation/blob/master/packages/unified-selection/README.md#hilite-sets) package instead.
 */
 ...
 * @public
 * @deprecated in 5.0 - will not be removed until 2026-06-13. Use `HiliteSetProvider` from [@itwin/unified-selection](https://github.com/iTwin/presentation/blob/master/packages/unified-selection/README.md#hilite-sets) package instead.
 */
