 ...
 *
 * @public
 * @deprecated in 5.0 - might be removed in next major version. Use `HiliteSet` from [@itwin/unified-selection](https://github.com/iTwin/presentation/blob/master/packages/unified-selection/README.md#hilite-sets) package instead.
 */
