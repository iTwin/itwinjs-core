 ...
 * @public
 * @deprecated in 5.0 - might be removed in next major version. Use `StorageSelectionChangesListener` from [@itwin/unified-selection](https://github.com/iTwin/presentation/blob/master/packages/unified-selection/README.md) package instead.
 */
 ...
 * @public
 * @deprecated in 5.0 - might be removed in next major version. Use `StorageSelectionChangeEventArgs` from [@itwin/unified-selection](https://github.com/iTwin/presentation/blob/master/packages/unified-selection/README.md) package instead.
 */
