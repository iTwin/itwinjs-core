...
} from "../../presentation-frontend/selection/SelectionScopesManager";
...
describe("SelectionScopesManager", () => {
  ...
  const getManager = () => {
    if (!manager) manager = new SelectionScopesManager(managerProps);
    return manager;
  };
