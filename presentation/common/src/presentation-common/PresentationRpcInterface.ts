 ...
 * @public
 */
export type PresentationRpcRequestOptions<TManagerRequestOptions> = Omit<
  TManagerRequestOptions,
  "imodel" | "diagnostics"
> & {
 ...
 * @public
 */
export type HierarchyRpcRequestOptions = PresentationRpcRequestOptions<
  HierarchyRequestOptions<never, NodeKey, RulesetVariableJSON>
>;
 ...
 * @public
 */
export type DisplayLabelRpcRequestOptions = PresentationRpcRequestOptions<
  DisplayLabelRequestOptions<never, InstanceKey>
>;
 ...
 * @public
 */
export type DisplayLabelsRpcRequestOptions = PresentationRpcRequestOptions<
  DisplayLabelsRequestOptions<never, InstanceKey>
>;
...
export class PresentationRpcInterface extends RpcInterface {
  ...
  public async getNodesCount(
    ...
    _options: HierarchyRpcRequestOptions
  ): PresentationRpcResponse<number> {
