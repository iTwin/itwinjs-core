 ...
 * @public
 * @deprecated in 5.0 - will not be removed until 2026-06-13. Use `computeSelection` from [@itwin/unified-selection](https://github.com/iTwin/presentation/blob/master/packages/unified-selection/README.md#selection-scopes) package instead.
 */
...
export class PresentationRpcInterface extends RpcInterface {
  ...
  /** @deprecated in 4.10 - will not be removed until 2026-06-13. Use [PresentationManager]($presentation-frontend) instead of calling the RPC interface directly. */
