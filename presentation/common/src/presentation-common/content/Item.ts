...
export interface ItemJSON {
  ...
  /** @deprecated in 5.x - will not be removed until 2026-06-13. Use [[label]] instead. */
...
export class Item {
   ...
   * @deprecated in 5.0 - will not be removed until 2026-06-13. Use an overload with `ItemProps` instead.
   */
  public constructor(
    primaryKeys: InstanceKey[],
