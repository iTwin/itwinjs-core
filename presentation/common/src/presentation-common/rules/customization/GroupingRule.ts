...
export interface PropertyGroup extends GroupingSpecificationBase {
   ...
   *
   * @minLength 1
   * @deprecated in 5.x - will not be removed until 2026-06-13. Use [[ExtendedDataRule]] instead. See [extended data usage page]($docs/presentation/customization/ExtendedDataUsage.md) for more details.
   */
  imageId?: string;
