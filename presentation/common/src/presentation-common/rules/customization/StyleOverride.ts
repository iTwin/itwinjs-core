...
export interface StyleOverride extends RuleBase, ConditionContainer {
  ...
  /**
   * Foreground color that should be used for node. The value should be an [ECExpression]($docs/learning/presentation/Advanced/ECExpressions.md)
  ...
  /**
   * Background color that should be used for node. The value should be an [ECExpression]($docs/learning/presentation/Advanced/ECExpressions.md)
   * whose result would evaluate to one the following formats:
   * - color name (`Red`, `Blue`, etc.)
   * - `rgb(255, 255, 255)`
   * - `#0F0F0F`
  ...
  /**
   * Font style that should be used for node. The value should be an [ECExpression]($docs/learning/presentation/Advanced/ECExpressions.md)
