 ...
 *
 * There are [special ECExpression symbols]($docs/learning/presentation/Advanced/ECExpressions.md#ruleset-variables-user-settings)
...
export interface VariablesGroup {
   ...
   * May be [localized]($docs/learning/presentation/Advanced/Localization.md).
   */
  label: string;
