...
describe("CategoryDescription", () => {
  describe("toJSON", () => {
    ...
    it("returns valid JSON for category with parent", () => {
      const category = createTestCategoryDescription({
        parent: createTestCategoryDescription(),
      });
  ...
  describe("listFromJSON", () => {
    it("creates categories and sets up correct parent-child relationships", () => {
      const r1 = {
        ...createTestCategoryDescription({ name: "r1" }),
        parent: undefined,
      };
      const c11 = {
        ...createTestCategoryDescription({ name: "c11" }),
        parent: "r1",
      };
      const c12 = {
        ...createTestCategoryDescription({ name: "c12" }),
        parent: "r1",
      };
      const c121 = {
        ...createTestCategoryDescription({ name: "c121" }),
        parent: "c12",
      };
      const r2 = {
        ...createTestCategoryDescription({ name: "r2" }),
        parent: undefined,
      };
