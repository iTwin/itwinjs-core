...
import { GatewayConfiguration } from "@bentley/imodeljs-backend/lib/gateway/GatewayConfiguration";
import { GatewayProtocol, GatewayDirectProtocol } from "@bentley/imodeljs-backend/lib/gateway/GatewayProtocol";
