...
const errorLogger: LogFunction = (message: string, getMetaData?: GetMetaDataFunction): void => console.log("Error: " + message + (getMetaData ? " " + JSON.stringify(getMetaData()) : ""));
const warningLogger: LogFunction = (message: string, getMetaData?: GetMetaDataFunction): void => console.log("Warning: " + message + (getMetaData ? " " + JSON.stringify(getMetaData()) : ""));
const infoLogger: LogFunction = (message: string, getMetaData?: GetMetaDataFunction): void => console.log("Info: " + message + (getMetaData ? " " + JSON.stringify(getMetaData()) : ""));
...
export class MyAppFrontend {
  ...
  public static async openIModel(iModelName: string): Promise<void> {
    ...
    Logger.logInfo("Opened: " + this.iModel.name);
  }
