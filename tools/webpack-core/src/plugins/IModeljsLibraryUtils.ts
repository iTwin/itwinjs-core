...
/** List of dependencies that are not iModel.js specific are required to be shared between an Extension and an App to avoid runtime issues with multiple versions.
 */
