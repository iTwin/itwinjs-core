...
describe("CopyExternalsPlugin", () => {
  ...
  it("should copy direct external dependencies", async () => {
    ...
    expect(fs.readFileSync(path.join(__dirname, "dist/node_modules/foo/index.js"), "utf8")).to.equal(
      `console.log("This is foo");`
    );
    expect(fs.readFileSync(path.join(__dirname, "dist/node_modules/a/index.js"), "utf8")).to.equal(
      `console.log("This is a");`
    );
    expect(fs.readFileSync(path.join(__dirname, "dist/node_modules/b/index.js"), "utf8")).to.equal(
      `console.log("This is b");`
    );
    expect(fs.readFileSync(path.join(__dirname, "dist/node_modules/c/index.js"), "utf8")).to.equal(
  ...
  it("should copy hoisted indirect dependencies", async () => {
    ...
    expect(fs.readFileSync(path.join(__dirname, "dist/node_modules/bar/index.js"), "utf8")).to.equal(
  ...
  it("should copy nested indirect dependencies", async () => {
    ...
    expect(fs.existsSync(path.join(__dirname, "dist/node_modules/bar"))).to.be.true;
    expect(fs.readFileSync(path.join(__dirname, "dist/node_modules/bar/index.js"), "utf8")).to.equal(
      `console.log("This is bar inside foo");`
    );
  });
