...
- Update mini-css-extract-plugin to 0.11.3
...
- update react-dev-utils version to 11.0.4
...
- Fix svg?sprite processing for use in the UI of extensions.
...
- Bump css loader vers and update webpack config to match bentley cra
