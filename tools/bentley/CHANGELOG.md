# Change Log - @bentley/bentleyjs-tools
...
- Fix tslint.json to specify correct rules directory
...
- Add tslint-consistent-codestyle as a bundled dependency
...
- Support multiple file extensions for sample code extraction (separated by comma)
