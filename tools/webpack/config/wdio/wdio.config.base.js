...
exports.config = {
  ...
  //
  specs: [
    path.resolve(paths.appTestE2ELib, "**/*.test.js")
  ],
  // Patterns to exclude.
  exclude: [
  ...
  screenshotPath: path.resolve(paths.appTestE2EScreenshots, "errors"),
  //
  // Set a base URL in order to shorten url command calls. If your url parameter starts
  // with "/", then the base url gets prepended.
  baseUrl: paths.publicUrl,
  //
  ...
  before: function () {
    ...
    chai.Should();
    // Check to see if electron version is being run. If not, browse to baseUrl for web app testing.
    if (!browser.isVisible("#root"))
      browser.url("/");

    // Clear local storage before each test suite
