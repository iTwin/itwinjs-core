...
export abstract class RobotWorldReadRpcInterface extends RpcInterface { // eslint-disable-line @typescript-eslint/no-deprecated
...
export abstract class RobotWorldWriteRpcInterface extends RpcInterface { // eslint-disable-line @typescript-eslint/no-deprecated
