...
export class RobotWorldApp extends IModelApp {
  ...
  public async pickView(views: IModelConnection.ViewSpec[]): Promise<string> {
  ...
  public async loadOneView(): Promise<ViewState> {
