...
describe("RobotWorld", () => {
  it("should run robotworld", () => {
    ...
    const iModel: IModelDb = IModelTestUtils.openIModel("CompatibilityTestSeed.bim", {copyFilename: "should-run-robotworld.bim", deleteFirst: true, openMode: OpenMode.ReadWrite});
