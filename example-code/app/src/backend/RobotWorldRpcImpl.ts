...
export class RobotWorldReadRpcImpl extends RpcInterface implements RobotWorldReadRpcInterface { // eslint-disable-line @typescript-eslint/no-deprecated
...
export class RobotWorldWriteRpcImpl extends RpcInterface implements RobotWorldWriteRpcInterface { // eslint-disable-line @typescript-eslint/no-deprecated
