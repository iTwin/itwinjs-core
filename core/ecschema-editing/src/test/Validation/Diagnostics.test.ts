...
describe("Diagnostics tests", () => {
  ...
  it("createSchemaItemDiagnosticClass, invalid code, throws", () => {
    let code = "InvalidCode";
    expect(() => Diagnostics.createSchemaItemDiagnosticClass(code, "Test Message")).to.throw(
      Error,
      invalidCodeMsg(code)
    );
  ...
  it("createRelationshipConstraintDiagnosticClass, invalid code, throws", () => {
    let code = "InvalidCode";
    expect(() => Diagnostics.createRelationshipConstraintDiagnosticClass(code, "Test Message")).to.throw(
      Error,
      invalidCodeMsg(code)
    );
  ...
  it("createCustomAttributeContainerDiagnosticClass, invalid code, throws", () => {
    let code = "InvalidCode";
    expect(() => Diagnostics.createCustomAttributeContainerDiagnosticClass(code, "Test Message")).to.throw(
      Error,
      invalidCodeMsg(code)
    );
