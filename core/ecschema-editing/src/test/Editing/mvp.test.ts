...
describe("SchemaEditor tests", () => {
  ...
  describe("Class tests", () => {
    ...
    it("should create BisCore.Element subclass successfully", async () => {
      ...
      const result = await testEditor.entities.createElement(
        testSchemaKey,
        "testElement",
    ...
    it("Creating Element, try subclassing unsupported base class, throws", async () => {
      ...
      await expect(
        testEditor.entities.createElement(
          testSchemaKey,
          "testElement",
          ECClassModifier.None,
          elementKey,
        ...
        Error,
        "The class testElement could not be created because the specified base class BisCore.PhysicalModel is not an Element."
      );
    });
    ...
    it("Creating ElementMultiAspect, try subclassing unsupported base class, throws", async () => {
      ...
      await expect(
        testEditor.entities.createElementUniqueAspect(
          testSchemaKey,
          "testElement",
          ECClassModifier.None,
          uniqueAspectKey,
        ...
        Error,
        "The class testElement could not be created because the specified base class BisCore.PhysicalModel is not an ElementUniqueAspect."
      );
    });
    ...
    it("Creating ElementMultiAspect, try subclassing unsupported base class, throws", async () => {
      ...
      await expect(
        testEditor.entities.createElementMultiAspect(
          testSchemaKey,
          "testElement",
          ECClassModifier.None,
          multiAspectKey,
        ...
        Error,
        "The class testElement could not be created because the specified base class BisCore.PhysicalModel is not an ElementMultiAspect."
      );
    });
    ...
    describe("Property tests", () => {
      ...
      it("should successfully create a PrimitiveProperty of type double", async () => {
        const createResult = await testEditor.entities.createProperty(
