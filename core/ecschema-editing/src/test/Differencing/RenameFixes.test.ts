...
import { SchemaFixes } from "../../Differencing/SchemaFixes";

/* eslint-disable @typescript-eslint/naming-convention */

describe("Rename fixes tests", () => {
  ...
  describe("Rename schema item name tests", () => {
    it("should rename property category name", async () => {
      ...
      SchemaFixes.renameSchemaItem(differences, conflict.itemName!, "MergedCategory");
    ...
    it("should rename kind of quantity name", async () => {
      ...
      SchemaFixes.renameSchemaItem(differences, conflict.itemName!, "MergedKoq");
    ...
    it("should rename enumeration name", async () => {
      ...
      SchemaFixes.renameSchemaItem(differences, conflict.itemName!, "MergedEnum");
    ...
    it("should rename struct name", async () => {
      ...
      SchemaFixes.renameSchemaItem(differences, conflicts[0].itemName!, "MergedBaseStruct");
      SchemaFixes.renameSchemaItem(differences, conflicts[1].itemName!, "MergedStruct");
    ...
    it.skip("should rename custom attribute name", async () => {
      ...
      SchemaFixes.renameSchemaItem(differences, conflicts[0].itemName!, "MergedBaseCA");
      SchemaFixes.renameSchemaItem(differences, conflicts[1].itemName!, "MergedCA");
    ...
    it("should rename mixin name", async () => {
      ...
      SchemaFixes.renameSchemaItem(differences, conflicts[0].itemName!, "MergedBaseMixin");
      SchemaFixes.renameSchemaItem(differences, conflicts[1].itemName!, "MergedMixin");
    ...
    it("should rename entity name", async () => {
      ...
      SchemaFixes.renameSchemaItem(differences, conflicts[0].itemName!, "MergedBaseEntity");
      SchemaFixes.renameSchemaItem(differences, conflicts[1].itemName!, "MergedEntity");
    ...
    it.skip("should rename relationship name", async () => {
      ...
      SchemaFixes.renameSchemaItem(differences, conflicts[0].itemName!, "MergedBaseRelationship");
      SchemaFixes.renameSchemaItem(differences, conflicts[1].itemName!, "MergedRelationship");
    ...
    it("should rename property category name by fix", async () => {
      ...
      SchemaFixes.renameSchemaItem(differences, "TestItem", "MergedCategory");
  ...
  describe("Rename property name tests", () => {
    it("should rename property name when typename changed", async () => {
      ...
      SchemaFixes.renameProperty(differences, conflict.itemName!, conflict.path!, "MergedProperty");
    ...
    it.skip("should rename property and schema item name", async () => {
      const sourceSchema = await Schema.fromJson({
        ...sourceJson,
        items: {
          TestItem: {
            ...
            properties: [
              {
                name: "PrimitiveProp",
                description: "Primitive Integer Property",
                type: "PrimitiveProperty",
                typeName: "int",
              },
            ],
      ...
      const conflict = differences.conflicts!;
      expect(conflict[0].code).equals(ConflictCode.ConflictingItemName, "Unexpected conflict code");
      expect(conflict[1].code).equals(ConflictCode.ConflictingPropertyName, "Unexpected conflict code");
  
      SchemaFixes.renameSchemaItem(differences, conflict[0].itemName!, "MergedEntity");
      SchemaFixes.renameProperty(differences, conflict[1].itemName!, conflict[1].path!, "MergedProperty");
      ...
      const mergedEntity = await mergedSchema.getItem<EntityClass>("MergedEntity");
      const mergedProperty = await mergedEntity?.getProperty("MergedProperty");
      expect(mergedProperty?.toJSON()).to.eq({
        name: "MergedProperty",
        description: "Primitive Integer Property",
        type: "PrimitiveProperty",
        typeName: "int",
    ...
    it("should rename property name by fix", async () => {
      ...
      SchemaFixes.renameProperty(differences, "TestEntity", "StringProperty", "MergedProperty");
