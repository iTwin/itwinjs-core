...
export const TestDiagnostics = {
  ...
  FailingCustomAttributeClassDiagnostic: Diagnostics.createSchemaItemDiagnosticClass<
    CustomAttributeClass,
    [string, string]
  >(TestDiagnosticCodes.FailingCustomAttributeClassDiagnostic, "Failed with param {0} {1}"),
  FailingCustomAttributeContainerDiagnostic: Diagnostics.createCustomAttributeContainerDiagnosticClass<
    [string, string]
  >(TestDiagnosticCodes.FailingCustomAttributeContainerDiagnostic, "Failed with param {0} {1}"),
...
): AsyncIterable<Diagnostics.SchemaItemDiagnostic<SchemaItem, [string, string]>> {
...
): AsyncIterable<Diagnostics.SchemaItemDiagnostic<UnitSystem, [string, string]>> {
...
): AsyncIterable<Diagnostics.SchemaItemDiagnostic<Phenomenon, [string, string]>> {
...
export class TestRuleSet implements IRuleSet {
  ...
  public schemaRules = [sinon.spy(failingSchemaRule), sinon.spy(passingSchemaRule)];
  public schemaItemRules = [sinon.spy(failingSchemaItemRule), sinon.spy(passingSchemaItemRule)];
  public classRules = [sinon.spy(failingClassRule), sinon.spy(passingClassRule)];
  public propertyRules = [sinon.spy(failingPropertyRule), sinon.spy(passingPropertyRule)];
  public entityClassRules = [sinon.spy(failingEntityClassRule), sinon.spy(passingEntityClassRule)];
  public structClassRules = [sinon.spy(failingStructClassRule), sinon.spy(passingStructClassRule)];
  public mixinRules = [sinon.spy(failingMixinRule), sinon.spy(passingMixinRule)];
  public relationshipRules = [sinon.spy(failingRelationshipRule), sinon.spy(passingRelationshipRule)];
  ...
  public customAttributeInstanceRules = [sinon.spy(failingCustomAttributeRule), sinon.spy(passingCustomAttributeRule)];
  public enumerationRules = [sinon.spy(failingEnumerationRule), sinon.spy(passingEnumerationRule)];
  public kindOfQuantityRules = [sinon.spy(failingKindOfQuantityRule), sinon.spy(passingKindOfQuantityRule)];
  public propertyCategoryRules = [sinon.spy(failingPropertyCategoryRule), sinon.spy(passingPropertyCategoryRule)];
  public formatRules = [sinon.spy(failingFormatRule), sinon.spy(passingFormatRule)];
  public unitRules = [sinon.spy(failingUnitRule), sinon.spy(passingUnitRule)];
  public invertedUnitRules = [sinon.spy(failingInvertedUnitRule), sinon.spy(passingInvertedUnitRule)];
  public unitSystemRules = [sinon.spy(failingUnitSystemRule), sinon.spy(passingUnitSystemRule)];
  public phenomenonRules = [sinon.spy(failingPhenomenonRule), sinon.spy(passingPhenomenonRule)];
  public constantRules = [sinon.spy(failingConstantRule), sinon.spy(passingConstantRule)];
}
...
export class TestRuleSetB implements IRuleSet {
  ...
  public customAttributeRules = [sinon.spy(failingCustomAttributeRule), sinon.spy(passingCustomAttributeRule)];
  public enumerationRules = [sinon.spy(failingEnumerationRule), sinon.spy(passingEnumerationRule)];
  public kindOfQuantityRules = [sinon.spy(failingKindOfQuantityRule), sinon.spy(passingKindOfQuantityRule)];
  public propertyCategoryRules = [sinon.spy(failingPropertyCategoryRule), sinon.spy(passingPropertyCategoryRule)];
  public formatRules = [sinon.spy(failingFormatRule), sinon.spy(passingFormatRule)];
...
export class PassingRuleSet implements IRuleSet {
  ...
  public relationshipConstraintRules = [sinon.spy(passingRelationshipConstraintRule)];
  public customAttributeClassRules = [sinon.spy(passingCustomAttributeClassRule)];
  public customAttributeContainerRules = [sinon.spy(passingCustomAttributeContainerRule)];
