...
export class ProcessDetector {
   ...
   */
  public static get isBrowserProcess() {
   ...
   */
  public static get isNodeProcess() {
    return typeof process === "object" && undefined !== process.platform;
  }
  ...
  public static get isIPadBrowser() {
    return this.isBrowserProcess && window.navigator.platform === "iPad" ||
      (window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 0 &&
        !("MSStream" in window)); /* eslint-disable-line deprecation/deprecation */
  }
   ...
   */
  public static get isIOSBrowser() {
   ...
   */
  public static get isAndroidBrowser() {
   ...
   */
  public static get isMobileBrowser() {
  ...
  public static get isChromium() {
    return (this.isBrowserProcess && window.navigator.userAgent.indexOf("Chrome") > -1 && window.navigator.userAgent.indexOf("OP") === -1) ||
      this.isElectronAppFrontend;
  }
   ...
   */
  public static get isMobileAppFrontend() {
  ...
  public static get isIOSAppBackend() {
    return this.isNodeProcess && (process.platform as any) === "ios";
  }

  /** Is this process the backend of an Android mobile application? */
  public static get isAndroidAppBackend() {
    return this.isNodeProcess && (process.platform as any) === "android";
  }

  /**  Is this process a mobile app backend? */
  public static get isMobileAppBackend() {
    return this.isIOSAppBackend || this.isAndroidAppBackend;
  }

  /** Is this process the frontend of a native (Electron or Mobile) app? */
  public static get isNativeAppFrontend() {
