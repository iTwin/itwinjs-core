...
export class BentleyError extends Error {
  ...
  protected _initName(): string {
    switch (this.errorNumber) {
      ...
      case DbResult.BE_SQLITE_ERROR_SchemaNotFound: return "Schema is not found in the list of referenced schemas";
      case DbResult.BE_SQLITE_ERROR_SchemaReadFailed: return "Error reading schema";
      case DbResult.BE_SQLITE_ERROR_SchemaIsDynamic: return "Schema is dynamic";
      case DbResult.BE_SQLITE_ERROR_SchemaDomainNamesMismatched: return "Schema name does not match the domain name";
      case DbResult.BE_SQLITE_ERROR_DbIsReadonly: return "Cannot import schemas into the database because it is Readonly";
      case DbResult.BE_SQLITE_ERROR_FailedToParseXml: return "Error reading ECSchema from XML";
      case DbResult.BE_SQLITE_ERROR_InvalidECSchemaXml: return "Invalid ECSchema XML";
      case DbResult.BE_SQLITE_ERROR_ReferencedSchemaNotFound: return "Error locating referenced schema while deserializing XML";
      case DbResult.BE_SQLITE_ERROR_DuplicateSchema: return "Schema is already loaded in the cache";
      case DbResult.BE_SQLITE_ERROR_DuplicateTypeName: return "Duplicate class node is present in the schema";
      case DbResult.BE_SQLITE_ERROR_InvalidPrimitiveType: return "Invalid type name on enumeration";
      case DbResult.BE_SQLITE_ERROR_HasReferenceCycle: return "Schema has reference cycles";
      case DbResult.BE_SQLITE_ERROR_PruneItem: return "Pruning schema item";
