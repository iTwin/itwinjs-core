...
- Abandons resources on failed connector run
- point link for imodel-bridge to 2.x branch b/c it was removed in 3.x
...
- Abandons changes and releases locks after encountering an error
