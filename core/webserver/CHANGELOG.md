...
- Use cors package rather than set the headers manually. That fixed a CORS error.
...
- Redirect any signin-* to index.html, not just signin-callback
- Webserver untars Plugin and delivers their components.
...
- Fixed yargs so it can wrap to terminal width. Added proper type definitions.
