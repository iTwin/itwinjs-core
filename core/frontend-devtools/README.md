...
* `fdt attach model maplayer <globe|reality> [name]` - Attach a model map layer for each unique model of the currently selected elements to either the globe or attached reality models. If name is specified, use that.
