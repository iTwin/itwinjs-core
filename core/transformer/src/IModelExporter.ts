...
/** @beta */
export interface HandlerResult {} // eslint-disable-line @typescript-eslint/no-empty-interface
...
export abstract class IModelExportHandler {
   ...
   */
  public onExportCodeSpec(_codeSpec: CodeSpec, _isUpdate: boolean | undefined): HandlerResponse { }
   ...
   * @note This should be overridden to actually do the export.
   */
  public onExportFont(_font: FontProps, _isUpdate: boolean | undefined): HandlerResponse { }
   ...
   * @note This should be overridden to actually do the export.
   */
  public onExportModel(_model: Model, _isUpdate: boolean | undefined): HandlerResponse { }

  /** Called when a model should be deleted. */
  public onDeleteModel(_modelId: Id64String): HandlerResponse { }
   ...
   * @note This should be overridden to actually do the export.
   */
  public onExportElement(_element: Element, _isUpdate: boolean | undefined): HandlerResponse { }

  /** Called when an element should be deleted. */
  public onDeleteElement(_elementId: Id64String): HandlerResponse { }
   ...
   * @note This should be overridden to actually do the export.
   */
  public onExportElementUniqueAspect(_aspect: ElementUniqueAspect, _isUpdate: boolean | undefined): HandlerResponse { }

  /** Called when ElementMultiAspects should be exported.
   * @note This should be overridden to actually do the export.
   */
  public onExportElementMultiAspects(_aspects: ElementMultiAspect[]): HandlerResponse { }
   ...
   * @note This should be overridden to actually do the export.
   */
  public onExportRelationship(_relationship: Relationship, _isUpdate: boolean | undefined): HandlerResponse { }

  /** Called when a relationship should be deleted. */
  public onDeleteRelationship(_relInstanceId: Id64String): HandlerResponse { }
   ...
   * @note This should be overridden to actually do the export.
   */
  public onExportSchema(_schema: Schema): HandlerResponse { }
...
export class IModelExporter {
  ...
  public async exportFontByNumber(fontNumber: number): Promise<void> {
    ...
    if (undefined !== font) {
      await this.handler.onExportFont(font, isUpdate);
      return this.trackProgress();
    }
  }
