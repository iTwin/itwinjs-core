...
import {
  computeGraphemeOffsets, ComputeGraphemeOffsetsArgs, GeometricElement3d, IModelDb, produceTextAnnotationGeometry,
  SnapshotDb, TextAnnotation2d, TextAnnotation3d,
} from "@itwin/core-backend";
import {
  ComputeRangesForTextLayout, ComputeRangesForTextLayoutArgs,
  FindFontId, FindTextStyle, layoutTextBlock, LineLayout, RunLayout, TextBlockLayout, TextLayoutRanges
} from "@itwin/core-backend/lib/cjs/TextAnnotationLayout";
