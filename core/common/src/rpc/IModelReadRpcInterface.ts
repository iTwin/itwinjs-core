 ...
 * @public
 */
export class IModelNotFoundResponse extends RpcNotFoundResponse { // eslint-disable-line @typescript-eslint/no-deprecated
 ...
 * @internal
 */
export abstract class IModelReadRpcInterface extends RpcInterface { // eslint-disable-line @typescript-eslint/no-deprecated
