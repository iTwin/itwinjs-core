...
import { SerializedViewStateProps, ViewCreator3dHelperOptions, ViewStateLoadProps, ViewStateProps } from "../ViewProps";
...
export abstract class IModelReadRpcInterface extends RpcInterface {
  ...
  public async getDefaultViewState3dData(_iModelToken: IModelRpcProps, _options: ViewCreator3dHelperOptions): Promise<SerializedViewStateProps> { return this.forward(arguments); }
