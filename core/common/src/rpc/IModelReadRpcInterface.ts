...
export abstract class IModelReadRpcInterface extends RpcInterface {
  ...
  public async getDefaultViewState(_iModelToken: IModelRpcProps, _options?: ViewCreator3dOptions, _modelIds?: Id64String[]): Promise<ViewState> { return this.forward(arguments); }
