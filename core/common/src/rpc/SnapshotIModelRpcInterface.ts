 ...
 * @internal
 * @deprecated in 5.0 - will not be removed until 2026-06-13. Check [[IpcAppFunctions]] or [[CheckpointConnection]] for replacements.
 */
export abstract class SnapshotIModelRpcInterface extends RpcInterface {
  ...
  /**
   * @deprecated in 5.0 - will not be removed until 2026-06-13. Use [[IpcAppFunctions.openSnapshot]] in IPC applications, no replacement for Web applications.
   */
  ...
  /**
   * @deprecated in 5.0 - will not be removed until 2026-06-13. Use [[IpcAppFunctions.closeIModel]] in IPC applications, no replacement for Web applications.
   */
