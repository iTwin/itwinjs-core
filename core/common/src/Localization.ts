...
export class EmptyLocalizationClient implements LocalizationClient {
  ...
  public getLocalizedStringWithNamespace(key: string | string[]): string { return typeof(key) == "string" ? key : key[0]; }
  public getEnglishString(key: string | string[]): string { return typeof(key) == "string" ? key : key[0]; }
  public getLocalizedKeys(inputString: string): string { return inputString; }
  public async registerNamespace(): Promise<void> { return Promise.resolve(); }
  public unregisterNamespace(): void {}
  public getNamespace(): Promise<void> | undefined {return Promise.resolve(); }
