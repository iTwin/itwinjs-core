...
/** Properties of an [Element]($docs/bis/fundamentals/foundation/element-fundamentals)
 * @public
 * @extensions
 */
export interface ElementProps extends EntityProps {
  /** The Id of the [Model]($docs/bis/fundamentals/foundation/model-fundamentals.md) containing this element */
  model: Id64String;
  ...
  /** A [FederationGuid]($docs/bis/fundamentals/foundation/element-fundamentals.md#federationguid) assigned to this element.
