...
import { Id64, JsonUtils, assert, IndexMap, IndexedValue, Comparable, compare, compareNumbers, compareStrings, Disposable } from "@bentley/bentleyjs-core";
...
export abstract class RenderTexture extends Disposable {
  ...
  protected constructor(params: RenderTexture.Params) { super(); this.params = params; }
