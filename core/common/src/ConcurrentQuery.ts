...
export interface QueryPropertyMetaData {
   ...
   * @deprecated in 4.11 - will not be removed until 2026-06-13. Use extendedType instead
   */
  extendType: string;
...
export interface QueryOptions extends BaseReaderOptions {
   ...
   * @deprecated in 4.11 - will not be removed until 2026-06-13. Use ecsql function ec_classname to get class name instead.
   * */
