...
describe("AnalysisStyle", () => {
    ...
    roundTrip(
      {
        scalar: {
          channelName: "scalars",
          range: [1, 2],
          thematicSettings: { stepCount: 42, colorMix: 0.5 },
        },
      },
      "input"
    );
    roundTrip(
      {
        scalar: {
          channelName: "scalars",
          range: [0, 1],
          thematicSettings: ThematicGradientSettings.defaults.toJSON(),
        },
      },
    ...
    expectClone(
      {
        scalar: {
          channelName: "s",
          range: [-5, 15],
          thematicSettings: { stepCount: 1234 },
        },
      },
      {
        scalar: {
  ...
  it("accepts legacy JSON representation", () => {
    ...
    roundTrip(
      {
        scalarChannelName: "scalar",
        scalarRange: [1, 2],
        scalarThematicSettings: { stepCount: 6 },
      },
      {
        scalar: {
          channelName: "scalar",
          range: [1, 2],
          thematicSettings: { stepCount: 6 },
        },
      }
    );
