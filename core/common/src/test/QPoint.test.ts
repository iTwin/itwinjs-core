...
describe("QPoint", () => {
  it("quantizes to range", () => {
    ...
    expectQPoint3d(
      range.high,
      qparams,
      QPoint3d.fromScalars(0xffff, 0xffff, 0xffff),
      0
    );
    ...
    expectQPoint3d(
      center,
      qparams,
      QPoint3d.fromScalars(0x8000, 0x8000, 0x8000),
      0.08
    );
    ...
    expectQPoint3d(
      range.high,
      qparams,
      QPoint3d.fromScalars(0xffff, 0xffff, 0),
      0
    );
    ...
    expectQPoint3d(
      center,
      qparams,
      QPoint3d.fromScalars(0x8000, 0x8000, 0),
      0.002
    );
  });
