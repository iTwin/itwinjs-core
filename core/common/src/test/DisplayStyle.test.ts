  ...
  describe("whiteOnWhiteReversal", () => {
    it("round-trips through JSON", () => {
      function test(
        ...
        const styleProps = {
          styles: props ? { whiteOnWhiteReversal: props } : {},
        };
  ...
  describe("planarClipMasks", () => {
    ...
    it("initializes from JSON", () => {
      function expectMasks(
        json: DisplayStylePlanarClipMaskProps[] | undefined,
      ...
      expectMasks(
        [makeProps(5, "0x1"), makeProps(1, "0x5"), makeProps(3, "0x3")],
        [
          ["0x1", makeSettings(5)],
          ["0x5", makeSettings(1)],
          ["0x3", makeSettings(3)],
    ...
    it("synchronizes JSON and in-memory representations", () => {
      ...
      expectMasks(
        [makeProps(1, "0x1")],
        (map) => map.set("0x1", makeSettings(2)),
        [["0x1", makeSettings(2)]],
        [makeProps(2, "0x1")]
      );
...
describe("DisplayStyleSettings overrides", () => {
  ...
  const iModelProps: DisplayStyle3dSettingsProps = {
    ...
    thematic: {
      ...
      sensorSettings: {
        distanceCutoff: 12,
        sensors: [{ position: [10, 20, 30], value: 0.5 }],
      },
    },
    planProjections: {
      "0x6": {
  ...
  it("creates selective overrides", () => {
    ...
    roundTrip(
      ...
      { ...baseProps, ...mapProps, ...iTwinProps, ...iModelProps, viewflags }
    );
  });
