...
describe("WhiteOnWhiteReversalSettings", () => {
  ...
  it("compares", () => {
    function test(
      expectEqual: boolean,
      x: WhiteOnWhiteReversalSettings,
      y: WhiteOnWhiteReversalSettings
    ): void {
    ...
    const b = WhiteOnWhiteReversalSettings.fromJSON({
      ignoreBackgroundColor: false,
    });
    const c = WhiteOnWhiteReversalSettings.fromJSON({
      ignoreBackgroundColor: true,
    });
    const d = WhiteOnWhiteReversalSettings.fromJSON({
      ignoreBackgroundColor: true,
    });
