...
describe("Geodetic Settings", () => {
  ...
  it("round-trips GeodeticTransform through JSON", () => {
    ...
    roundTrip(
      {
        method: "Geocentric",
        geocentric: { delta: { x: 12.0, y: 32.3, z: 54.1 } },
      },
      "input"
    );
    roundTrip(
  ...
  it("round-trips GeodeticTransformPath through JSON", () => {
    const roundTrip = (
      input: GeodeticTransformPathProps | undefined,
      expected: GeodeticTransformPathProps | "input"
    ) => {
  ...
  it("round-trips Horizontal CRS Extent through JSON", () => {
    ...
    roundTrip(
      {
        southWest: { latitude: -90.0, longitude: 45.6 },
        northEast: { latitude: 90.0, longitude: 58.7 },
      },
      "input"
    );
    roundTrip(
      {
        southWest: { latitude: 12.1, longitude: -190.1 },
        northEast: { latitude: 14.56, longitude: -158.7 },
      },
      "input"
    );
    ...
    const cartoPoint = Carto2DDegrees.fromJSON({
      latitude: 23.4,
      longitude: 123.4,
    });
    ...
    const extent1 = HorizontalCRSExtent.fromJSON({
      southWest: { latitude: 12.1, longitude: 45.6 },
      northEast: { latitude: 14.56, longitude: 58.7 },
    });
    ...
    const extent2 = HorizontalCRSExtent.fromJSON({
      southWest: { latitude: 12.1, longitude: 45.6 },
      northEast: { latitude: 10.56, longitude: 58.7 },
    });
    ...
    const cartoPoint2 = Carto2DDegrees.fromJSON({
      latitude: 23.4,
      longitude: 123.4,
    });
    const cartoPoint3 = Carto2DDegrees.fromJSON({
      latitude: 23.400000000001,
      longitude: 123.40000000001,
    });
