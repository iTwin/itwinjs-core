...
describe("Solar Calculations", () => {
  ...
  it("should compare as expected", () => {
    const philadelphia = Cartographic.fromJSON({isDegrees: true, longitude: -75.17035, latitude: 39.954927, height: 0.0});
    ...
    const algeria = Cartographic.fromJSON({isDegrees: true, longitude: 2.54882812, latitude: 27.761329, height: 0.0});
    ...
    const melbourne = Cartographic.fromJSON({isDegrees: true, longitude: 145.371093, latitude: -37.8575, height: 0.0});
