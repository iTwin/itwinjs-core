...
describe("Solar Calculations", () => {
  ...
  it("should compare as expected", () => {
    const philadelphia = Cartographic.fromJSON({longitude: {degrees: -75.17035}, latitude: {degrees: 39.954927}, height: 0.0});
    ...
    const algeria = Cartographic.fromJSON({longitude: {degrees: 2.54882812}, latitude: {degrees: 27.761329}, height: 0.0});
    ...
    const melbourne = Cartographic.fromJSON({longitude: {degrees: 145.371093}, latitude: {degrees: -37.8575}, height: 0.0});
