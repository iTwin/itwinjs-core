...
/** Parameters for Thicken operation
 * @alpha
 */
...
/** Parameters for Hollow operation
 * @alpha
 */
...
/** Parameters for Round operation
 * @alpha
 */
...
/** Info provided to BRepGeometryFunction.
 * @alpha
 */
 ...
 * See IModelDb.createBRepGeometry
 * @alpha
 */
