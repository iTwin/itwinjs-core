 ...
 * @public
 */
export class CartographicRectangle extends Range2d {
  ...
  public static createZero(): CartographicRectangle {
    return new this(0, 0, 0, 0);
  }

  /** Create a rectangle encompassing all points on the surface of the Earth. */
  public static createMaximum(): CartographicRectangle {
    return new this(-Angle.piRadians, -Angle.piOver2Radians, Angle.piRadians, Angle.piOver2Radians);
  }
   ...
   * @note If `north` is less than `south`, they will be swapped.
   */
  public static fromRadians(west: number, south: number, east: number, north: number, result?: CartographicRectangle): CartographicRectangle {
    result = result ?? this.createZero();
   ...
   * @note If `north` is less than `south`, they will be swapped.
   */
  public static fromDegrees(west: number, south: number, east: number, north: number, result?: CartographicRectangle): CartographicRectangle {
    const mult = Angle.radiansPerDegree;
    return this.fromRadians(west * mult, south * mult, east * mult, north * mult, result);
  }
