 ...
 * @public
 * @extensions
 * @deprecated in 5.0.0 - will not be removed until 2026-06-13. Use [IModelDb.fonts]($backend)
 */
 ...
 * @public
 * @deprecated in 5.0.0 - will not be removed until 2026-06-13. Use [IModelDb.fonts]($backend) instead.
 */
