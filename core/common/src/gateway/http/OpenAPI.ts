...
/** An OpenAPI-compatible description of a Gateway protocol. */
export class GatewayOpenAPIDescription {
  /** The protocol for this description. */
  public readonly protocol: GatewayHttpProtocol;

  /** The OpenAPI paths object for the protocol. */
  public get paths(): OpenAPIPaths {
    const paths: OpenAPIPaths = {};

    this.protocol.configuration.gateways().forEach((gateway) => {
      GatewayOperation.forEach(gateway, (operation) => {
  ...
  /** Creates an OpenAPI description of a gateway operation. */
  public constructor(protocol: GatewayHttpProtocol) {
  ...
  private generateDescription(operation: GatewayOperation): OpenAPIPathItem {
