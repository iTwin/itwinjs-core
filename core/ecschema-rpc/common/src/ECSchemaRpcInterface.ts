 ...
 * @internal
 */
export abstract class ECSchemaRpcInterface extends RpcInterface { // eslint-disable-line @typescript-eslint/no-deprecated
   ...
   */
  @RpcOperation.allowResponseCaching(RpcResponseCacheControl.Immutable) // eslint-disable-line @typescript-eslint/no-deprecated
