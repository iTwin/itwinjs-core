...
import { LowAndHighXY, Range1d, Range2d, Vector3d } from "@itwin/core-geometry";
import { OctEncodedNormal, QParams2d, QPoint2d, QPoint3d, Quantization } from "@itwin/core-common";
import { CloneableRealityMeshParams, RealityMeshParams, RealityMeshParamsBuilder } from "../../render/RealityMeshParams";
...
onmessage = function(e) {
  ...
  const result: CloneableUpsampledRealityMeshParams = {
    mesh,
    heightRange: {
      low: upsampled.heightRange.low,
      high: upsampled.heightRange.high,
    },
  };
