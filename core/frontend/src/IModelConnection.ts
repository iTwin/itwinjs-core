...
export abstract class IModelConnection extends IModel {
  ...
  */
   ...
   * @deprecated in 5.0.0 - will not be removed until 2026-06-13. If you need font Ids on the front-end for some reason, write an Ipc method that queries [IModelDb.fonts]($backend).
   */
  ...
  /** @internal
   * @deprecated in 4.8 - will not be removed until 2026-06-13. Use AccuSnap.doSnapRequest.
   */
   ...
   * @deprecated in 4.11 - will not be removed until 2026-06-13. Use [[IModelConnection.getMassProperties]].
   */
...
export class SnapshotConnection extends IModelConnection {
   ...
   * @deprecated in 4.10 - will not be removed until 2026-06-13. Use [[CheckpointConnection.openRemote]].
   */
...
export namespace IModelConnection {
  ...
  export class Views {
     ...
     * @deprecated in 4.2 - will not be removed until 2026-06-13. Create a ViewState to your own specifications.
     */
