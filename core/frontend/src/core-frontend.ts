...
export {
  ...
  type MapLayerAccessClientResolver, type MapLayerAccessClientResolverArgs,
  type MapLayerAuthRequest, type MapLayerAuthResponse, type MapLayerRequestAuthenticator,
