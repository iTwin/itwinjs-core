...
export {
  ...
  type MapLayerRequest, type MapLayerResponse, type MapLayerRequestFailure, type MapLayerRequestListener, type MapLayerResponseListener, type MapLayerRequestListenerOptions,
