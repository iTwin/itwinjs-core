...
describe("IModelConnection", () => {
  describe("displayed extents", () => {
    ...
    beforeEach(
      () =>
        (imodel = createBlankConnection(undefined, undefined, defaultExtents))
    );
    ...
    it("is initialized to project extents", () => {
      ...
      expect(imodel.displayedExtents.isAlmostEqual(imodel.projectExtents)).to.be
        .true;
    });
    ...
    it("expands", () => {
      ...
      /* eslint-disable-next-line deprecation/deprecation */
      expect(
        imodel.displayedExtents.isAlmostEqual(new Range3d(0, -1, 0, 2, 1, 1))
      ).to.be.true;
      /* eslint-disable-next-line deprecation/deprecation */
      imodel.expandDisplayedExtents(new Range3d(-100, 0, 0, 0, 0, 100));
      /* eslint-disable-next-line deprecation/deprecation */
      expect(
        imodel.displayedExtents.isAlmostEqual(
          new Range3d(-100, -1, 0, 2, 1, 100)
        )
      ).to.be.true;
    });
