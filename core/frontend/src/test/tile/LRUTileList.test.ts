...
describe("LRUTileList", () => {
  ...
  it("updates when selected tiles change", () => {
    ...
    list.markSelectedForUser(vp1, [t1, t2]);
    list.expectOrder(t3, t4, s, t1, t2);
    expect(t1.userIds).not.to.be.undefined;
    expect(t2.userIds).not.to.be.undefined;
    expect(t3.userIds).to.be.undefined;
    expect(t4.userIds).to.be.undefined;

    list.markSelectedForUser(vp2, [t1, t4]);
    list.expectOrder(t3, s, t2, t1, t4);
    expect(t1.userIds).not.to.be.undefined;
    expect(t2.userIds).not.to.be.undefined;
    expect(t3.userIds).to.be.undefined;
    expect(t4.userIds).not.to.be.undefined;

    list.clearSelectedForUser(vp1);
    list.expectOrder(t3, t2, s, t1, t4);
    expect(t1.userIds).not.to.be.undefined;
    expect(t2.userIds).to.be.undefined;
    expect(t3.userIds).to.be.undefined;
    expect(t4.userIds).not.to.be.undefined;

    list.markSelectedForUser(vp1, [t3, t4, t2]);
    list.expectOrder(s, t1, t3, t4, t2);
    expect(t1.userIds).not.to.be.undefined;
    expect(t2.userIds).not.to.be.undefined;
    expect(t3.userIds).not.to.be.undefined;
    expect(t4.userIds).not.to.be.undefined;

    list.clearSelectedForUser(vp2);
    list.expectOrder(t1, s, t3, t4, t2);
    expect(t1.userIds).to.be.undefined;
    expect(t2.userIds).not.to.be.undefined;
    expect(t3.userIds).not.to.be.undefined;
    expect(t4.userIds).not.to.be.undefined;
  ...
  it("disposes", () => {
    ...
    for (const tile of tiles) {
      expectUnlinked(tile);
      expect(tile.userIds).to.be.undefined;
