...
describe("FlashSettings", () => {
  ...
  it("clones", () => {
    ...
    settings = clone(settings, { duration: BeDuration.fromSeconds(1), litMode: FlashMode.Hilite }, {
      duration: BeDuration.fromSeconds(1),
      litMode: FlashMode.Hilite,
      maxIntensity: 1,
    });

    clone(settings, { duration: BeDuration.fromSeconds(2), maxIntensity: 0.2 }, {
      duration: BeDuration.fromSeconds(2),
      maxIntensity: 0.2,
      litMode: FlashMode.Hilite,
    });
  });
