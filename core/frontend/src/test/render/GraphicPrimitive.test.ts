...
describe("GraphicPrimitive", () => {
  class Builder extends GraphicBuilder {
    ...
    public addLineString(points: Point3d[]) {
      this.primitive = { type: "linestring", points };
    }
    public addLineString2d(points: Point2d[], zDepth: number) {
      this.primitive = { type: "linestring2d", points, zDepth };
    }
    public addPointString(points: Point3d[]) {
      this.primitive = { type: "pointstring", points };
    }
    public addPointString2d(points: Point2d[], zDepth: number) {
      this.primitive = { type: "pointstring2d", points, zDepth };
    }
    public addShape(points: Point3d[]) {
      this.primitive = { type: "shape", points };
    }
    public addShape2d(points: Point2d[], zDepth: number) {
    ...
    public addPolyface(polyface: Polyface, filled: boolean) {
      this.primitive = { type: "polyface", polyface, filled };
    }
    public addSolidPrimitive(solidPrimitive: SolidPrimitive) {
