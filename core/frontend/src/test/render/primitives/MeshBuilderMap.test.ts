...
describe("MeshBuilderMap Tests", () => {
  ...
  it("constructor", () => {
    ...
    const map = new MeshBuilderMap(tolerance, range, is2d, new GeometryOptions(GenerateEdges.No), undefined);
  ...
  it("createFromGeometries", () => {
    ...
    const map = MeshBuilderMap.createFromGeometries(
      geomList,
      tolerance,
      range,
      is2d,
  ...
  it("loadGeometry", () => {
    ...
    const map2 = new MeshBuilderMap(
      tolerance,
      range,
      is2d,
      new GeometryOptions(GenerateEdges.No, undefined, SurfacesOnly.Yes),
      undefined
    );
  ...
  it("loadPolyfacePrimitiveList", () => {
    ...
    expect(map.size).to.equal(1);
    const builder = map.getBuilder(
      pfPrim.displayParams,
      Mesh.PrimitiveType.Mesh,
      pfPrim.indexedPolyface.normalCount > 0,
      pfPrim.isPlanar
    );
  ...
  it("loadIndexedPolyface", () => {
    ...
    const emptyloopGeom = Geometry.createFromLoop(
      emptyLoop,
      Transform.createIdentity(),
      loopRange2,
      displayParams,
    ...
    map = new MeshBuilderMap(tolerance, range, is2d, new GeometryOptions(GenerateEdges.No), undefined);
  ...
  it("getKey", () => {
    ...
    map = new MeshBuilderMap(
      tolerance,
      range,
      is2d,
      new GeometryOptions(GenerateEdges.No, undefined, undefined, PreserveOrder.Yes),
      undefined
    );
  ...
  it("getBuilderFromKey", () => {
    ...
    const builder = map.getBuilderFromKey(key, {
    ...
    const builder3 = map.getBuilderFromKey(key, {
      quantizePositions: false,
      displayParams,
      type,
      range,
    ...
    const builder4 = map.getBuilderFromKey(key2, {
      quantizePositions: false,
      displayParams,
      type,
      range,
