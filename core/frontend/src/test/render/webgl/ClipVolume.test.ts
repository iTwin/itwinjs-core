...
describe("BlipVolume", async () => {
  ...
  it("should ignore empty ClipVectors", () => {
    ...
    expect(BlipVolume.create(clipVector)).to.be.undefined;
  ...
  it("should support single-primitive ClipVectors", () => {
    ...
    const clipVolume = BlipVolume.create(clipVector)!;
    expect(clipVolume).to.not.be.undefined;
