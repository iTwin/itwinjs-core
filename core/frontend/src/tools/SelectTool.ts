...
export class SelectionTool extends PrimitiveTool {
  ...
  private _selectionMethodValue: DialogItemValue = {
    value: SelectionMethod.Pick,
  };
  private _selectionModeValue: DialogItemValue = {
  ...
  private static _getMethodsDescription(): PropertyDescription {
    return {
      ...
      enum: {
        choices: [
          {
            label: SelectionTool.methodsMessage("Pick"),
            value: SelectionMethod.Pick,
          },
          {
            label: SelectionTool.methodsMessage("Line"),
            value: SelectionMethod.Line,
          },
          {
            label: SelectionTool.methodsMessage("Box"),
            value: SelectionMethod.Box,
          },
        ],
      },
    };
  ...
  private static _getModesDescription(): PropertyDescription {
    return {
      ...
      enum: {
        choices: [
          {
            label: SelectionTool.modesMessage("Replace"),
            value: SelectionMode.Replace,
          },
          {
            label: SelectionTool.modesMessage("Add"),
            value: SelectionMode.Add,
          },
          {
            label: SelectionTool.modesMessage("Remove"),
  ...
  protected initSelectTool(): void {
    ...
    this.initLocateElements(
      enableLocate,
      false,
      enableLocate ? "default" : IModelApp.viewManager.crossHairCursor,
  ...
  protected selectByPointsProcess(
    origin: Point3d,
    corner: Point3d,
    ev: BeButtonEvent,
  ...
  private syncSelectionMode(): void {
    ...
    if (this.wantToolSettings()) {
      const syncMode: DialogPropertySyncItem = {
