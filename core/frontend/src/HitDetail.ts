...
export class HitDetail {
  ...
  public async getToolTip(): Promise<HTMLElement | string> {
    let toolTipPromise = this.isElementHit
      ? IModelApp.viewManager.overrideElementToolTip(this)
      : IModelApp.viewManager.getDecorationToolTip(this);
...
export class SnapDetail extends HitDetail {
  ...
  public constructor(
    ...
    public heat: SnapHeat = SnapHeat.None,
    snapPoint?: XYZProps
  ) {
    super(
      from.testPoint,
