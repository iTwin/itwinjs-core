...
export class SnapDetail extends HitDetail {
  ...
  private static getSnapSpriteUrl(snapType: SnapMode): string {
    switch (snapType) {
      case SnapMode.Nearest: return `${IModelApp.assetsPath}sprites/SnapPointOn.png`;
      case SnapMode.NearestKeypoint: return `${IModelApp.assetsPath}sprites/SnapKeypoint.png`;
      case SnapMode.MidPoint: return `${IModelApp.assetsPath}sprites/SnapMidpoint.png`;
      case SnapMode.Center: return `${IModelApp.assetsPath}sprites/SnapCenter.png`;
      case SnapMode.Origin: return `${IModelApp.assetsPath}sprites/SnapOrigin.png`;
      case SnapMode.Bisector: return `${IModelApp.assetsPath}sprites/SnapBisector.png`;
      case SnapMode.Intersection: return `${IModelApp.assetsPath}sprites/SnapIntersection.png`;
    }
    return "";
  }
}
