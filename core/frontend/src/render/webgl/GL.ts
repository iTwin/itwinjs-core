...
export namespace GL {
  ...
  export namespace Texture {
    ...
    export enum DataType { // eslint-disable-line @typescript-eslint/no-shadow -- This name is unambiguous as it is qualified by the namespace...https://github.com/palantir/tslint/issues/3789
      Float = WebGLRenderingContext.FLOAT,
      UnsignedByte = WebGLRenderingContext.UNSIGNED_BYTE,
