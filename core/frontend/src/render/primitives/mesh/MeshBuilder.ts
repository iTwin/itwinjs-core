...
/** @internal */
export namespace MeshBuilder { // eslint-disable-line @typescript-eslint/no-redeclare
...
/** @internal */
export namespace MeshEdgeCreationOptions { // eslint-disable-line @typescript-eslint/no-redeclare
  export enum Type {
    NoEdges = 0x0000,
    SheetEdges = 0x0001 << 0,
