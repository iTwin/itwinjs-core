...
import {
  OctEncodedNormal, QParams2d, QParams3d, QPoint2d, QPoint2dBuffer, QPoint3d, QPoint3dBuffer, RenderTexture,
...
export class RealityMeshParamsBuilder {
  ...
  private readonly _q3d1 = new QPoint3d();
  private readonly _q2d = new QPoint2d();
  private readonly _q2d1 = new QPoint2d();
