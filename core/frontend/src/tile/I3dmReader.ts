...
import { BatchedTileIdMap, GltfReader, GltfReaderProps, GltfReaderResult, RealityTile, ShouldAbortReadGltf } from "./internal";
...
export class I3dmReader extends GltfReader {
  ...
  public static create(stream: ByteStream, iModel: IModelConnection, modelId: Id64String, is3d: boolean, range: ElementAlignedBox3d,
    system: RenderSystem, yAxisUp: boolean, isLeaf: boolean, isCanceled?: ShouldAbortReadGltf, idMap?: BatchedTileIdMap, deduplicateVertices=false, tile?: RealityTile): I3dmReader | undefined {
    ...
    return new I3dmReader(featureBinary, JSON.parse(featureStr), header.batchTableJson, props, iModel, modelId, is3d, system,
      range, isLeaf, isCanceled, idMap, deduplicateVertices, tile);
  }
  ...
  private constructor(private _featureBinary: Uint8Array, private _featureJson: any, private _batchTableJson: any, props: GltfReaderProps,
    ...
    private _isLeaf: boolean, shouldAbort?: ShouldAbortReadGltf, _idMap?: BatchedTileIdMap, deduplicateVertices=false, tile?: RealityTile) {
    super({
