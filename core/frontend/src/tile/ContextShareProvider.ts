...
export class ContextShareProvider {
  ...
  public static isProviderUrl(tilesetUrl: string): boolean {
    ...
    if (tilesetUrl.toLowerCase().includes("api.bentley.com/realitydata") || tilesetUrl.toLowerCase().includes("api.bentley.com/reality-management"))
      return true;
  ...
  public static getInfoFromUrl(tilesetUrl: string): {provider: RealityDataProvider, format: RealityDataFormat, id: string, iTwinId: string | undefined} {
    ...
    if (tilesetUrl.toLowerCase().includes("api.bentley.com/realitydata") || tilesetUrl.toLowerCase().includes("api.bentley.com/reality-management")) {
      ...
      if(tilesetUrl.toLowerCase().includes("reality-management")) {
        indexId = lcTilesetUrl.indexOf("reality-management/") + 19; // length of "reality-management/" = 19;
