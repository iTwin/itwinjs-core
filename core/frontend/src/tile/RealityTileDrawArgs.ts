...
export class RealityTileDrawArgs extends TileDrawArgs {
  ...
  public override get secondaryClassifiers() { return this._secondaryClassifiers;}

  public constructor(args: TileDrawArgs, worldToViewMap: Map4d, frustumPlanes: FrustumPlanes, public maxSelectionCount?: number, private _secondaryClassifiers?: Map<number, RenderPlanarClassifier>) {
