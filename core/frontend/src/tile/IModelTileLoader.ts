...
export class IModelTileLoader extends TileLoader {
  ...
  public get priority(): TileLoadPriority { return (BatchType.VolumeClassifier === this._batchType || BatchType.PlanarClassifier === this._batchType) ? TileLoadPriority.Classifier : TileLoadPriority.Primary; }
  public tileRequiresLoading(params: TileParams): boolean { return 0 !== params.maximumSize; }
