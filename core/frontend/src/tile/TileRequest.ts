...
export class TileRequest {
  ...
  /** The set of [[TileUser]]s that are awaiting the result of this request. When this becomes empty, the request is canceled because no tile user cares about it. */
