...
export class ArcGisFeatureJSON  {
  ...
  public readRenderGraphics(_source: string, context: CanvasRenderingContext2D) {
    ...
    this.readFeaturesFromObject(JSON.parse(_source), context);
  ...
  protected readFeaturesFromObject(object: any, context: CanvasRenderingContext2D, options?: EsriFeatureReadOptions) {
    if (object === undefined)
      return;

    // Parse geometries
    if (object.features === undefined) {
      this.readFeatureFromObject(object, context, options);

    } else {
      for (const feature of object.features) {
        if (feature !== undefined) {
          this.readFeatureFromObject(feature, context, options);
        }
      }
    }
  ...
  protected readFeatureFromObject(object: any, context: CanvasRenderingContext2D, options?: EsriFeatureReadOptions) {
    if (object === undefined)
      return;

    this.readGeometry(object.geometry, context, options);
  }

  protected readGeometry(object: any, context: CanvasRenderingContext2D, _options?: EsriFeatureReadOptions) {
    if (object === undefined)
      return undefined;
    ...
    if (typeof object.x === "number" && typeof object.y === "number") {
      ...
      context.drawImage(sampleIconImg,transPt.x, transPt.y, 16, 16);
