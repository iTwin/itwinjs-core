...
export interface ArcGisFeatureQueryUrlParams {
...
export class ArcGisFeatureQueryUrl {
  ...
  public constructor(baseUrl: string, layerIdx: number, params?: ArcGisFeatureQueryUrlParams) {
  ...
  public async toString() {
    ...
    if ( this.resultRecordCount !== undefined
      ...
      if (this.envelopeFilter !== undefined) {
        ...
        customParams = ArcGisFeatureQueryUrl.appendParam(customParams, "geometryType", "esriGeometryEnvelope");
        /*
...
*/
        customParams = ArcGisFeatureQueryUrl.appendParam(customParams, "geometry", `${this.envelopeFilter.xLow},${this.envelopeFilter.yLow},${this.envelopeFilter.xHigh},${this.envelopeFilter.yHigh}`);
        // customParams = ArcGisFeatureQueryUrl.appendParam(customParams, "geometry", `${bbox.xLow},${bbox.yLow},${bbox.xHigh},${bbox.yHigh}`);
        customParams = ArcGisFeatureQueryUrl.appendParam(customParams, "inSR", "102100");
    ...
    if (this.resultOffset !== undefined) {
      customParams = ArcGisFeatureQueryUrl.appendParam(customParams, "resultOffset", `${this.resultOffset}`);
    }

    if (this.resultRecordCount !== undefined) {
      customParams = ArcGisFeatureQueryUrl.appendParam(customParams, "resultRecordCount", `${this.resultRecordCount}`);
    }

    if (this.returnGeometry !== undefined) {
      customParams = ArcGisFeatureQueryUrl.appendParam(customParams, "returnGeometry", this.returnGeometry?"true":"false");
    }
