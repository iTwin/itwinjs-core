...
class CesiumTerrainProvider extends TerrainMeshProvider {
  ...
  public override getLogo(): HTMLTableRowElement {
    return IModelApp.makeLogoCard({ iconSrc: `${IModelApp.assetsPath}images/cesium-ion.svg`, heading: "Cesium Ion", notice: IModelApp.localization.getLocalizedString("iModelJs:BackgroundMap.CesiumWorldTerrainAttribution") });
  }
