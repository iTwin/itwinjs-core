...
import { BackgroundMapSettings, MapImagerySettings, MapImagerySettings2, MapLayerSettings } from "@bentley/imodeljs-common";
import { Viewport } from "../../Viewport";
import { ViewState } from "../../ViewState";
import { MapLayerImageryProvider, MapTileTreeReference, MapTileTreeReference2, TiledGraphicsProvider, TileTreeReference } from "../internal";
...
export class MapTiledGraphicsProvider2 implements TiledGraphicsProvider {
  public readonly backgroundMap: MapTileTreeReference2;
  public readonly overlayMap: MapTileTreeReference2;
  public readonly backgroundDrapeMap: MapTileTreeReference2;
  private readonly _detachFromDisplayStyle: VoidFunction[] = [];
  ...
  constructor(private readonly _vp: Viewport) {
    ...
    this.backgroundMap = new MapTileTreeReference2(mapSettings, mapImagery.backgroundBase, mapImagery.backgroundLayers, displayStyle.iModel, _vp.viewportId, false, false, () => displayStyle.overrideTerrainDisplay());
    this.overlayMap = new MapTileTreeReference2(mapSettings, undefined, mapImagery.overlayLayers, displayStyle.iModel, _vp.viewportId, true, false);
    this.backgroundDrapeMap = new MapTileTreeReference2(mapSettings, mapImagery.backgroundBase, mapImagery.backgroundLayers, displayStyle.iModel, _vp.viewportId, false, true);
    ...
    removals.push(displayStyle.settings.onMapImageryChanged2.addListener((imagery: Readonly<MapImagerySettings2>) => {
      this.backgroundMap.setBaseLayerSettings(imagery.backgroundBase);
      this.backgroundMap.setLayerSettings(imagery.backgroundLayers);
      this.backgroundDrapeMap.setBaseLayerSettings(mapImagery.backgroundBase);
      this.backgroundDrapeMap.setLayerSettings(mapImagery.backgroundLayers);
