...
export class AngleDescription extends FormattedQuantityDescription {
  constructor(name?: string, displayLabel?: string, iconSpec?: string) {
    ...
    super(
      ...
      displayLabel ? displayLabel : IModelApp.localizationClient.getLocalizedString("iModelJs:Properties.Angle"),
      iconSpec,
    );
  }
  ...
  public get parseError(): string { return IModelApp.localizationClient.getLocalizedString("iModelJs:Properties.UnableToParseAngle"); }
}
