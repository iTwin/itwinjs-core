...
export class AngleDescription extends FormattedQuantityDescription {
  constructor(name?: string, displayLabel?: string, iconSpec?: string) {
    ...
    super(
      ...
      displayLabel ? displayLabel : IModelApp.localizationProvider.getLocalizedString("iModelJs:Properties.Angle"),
      iconSpec,
    );
  }
  ...
  public get parseError(): string { return IModelApp.localizationProvider.getLocalizedString("iModelJs:Properties.UnableToParseAngle"); }
}
