...
export class LengthDescription extends FormattedQuantityDescription {
  constructor(name?: string, displayLabel?: string, iconSpec?: string) {
    ...
    super(
      ...
      displayLabel ? displayLabel : IModelApp.localizationProvider.getLocalizedString("iModelJs:Properties.Length"),
      iconSpec,
    );
  }
  ...
  public get parseError(): string { return IModelApp.localizationProvider.getLocalizedString("iModelJs:Properties.UnableToParseLength"); }
}
