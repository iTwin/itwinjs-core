  ...
  implements AuxCoordSystemProps
{
  ...
  public static createNew(
    ...
    return new AuxCoordSystemSpatialState(
      {
  ...
  public static isOriginInView(
    ...
    const inView = !(
      testPtView.x < 0 ||
      testPtView.x > screenRange.x ||
      testPtView.y < 0 ||
      testPtView.y > screenRange.y
    );
  ...
  implements AuxCoordSystem3dProps
{
  ...
  constructor(props: AuxCoordSystem3dProps, iModel: IModelConnection) {
    ...
    const angles = new YawPitchRollAngles(
      Angle.createDegrees(this.yaw),
      Angle.createDegrees(this.pitch),
      Angle.createDegrees(this.roll)
    );
