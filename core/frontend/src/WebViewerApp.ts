...
import { BentleyCloudRpcParams, RpcRoutingToken } from "@bentley/imodeljs-common";
...
//     if (opts.webViewerApp.authConfig) {
//       const auth = new BrowserAuthorizationClient(opts.webViewerApp.authConfig); // This needs to change
