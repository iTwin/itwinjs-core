...
export class AccuSnap implements Decorator {
  ...
  private showSnapSprite(): void {
    ...
    const crossSprite = IconSprites.getSpriteFromUrl(`${IModelApp.assetsPath}${snap.isHot ? "sprites/SnapCross.png" : "sprites/SnapUnfocused.png"}`);
  ...
  private showSnapError(out: LocateResponse, ev: BeButtonEvent) {
    ...
    switch (out.snapStatus) {
      case SnapStatus.FilteredByApp:
        errorSprite = IconSprites.getSpriteFromUrl(`${IModelApp.assetsPath}sprites/SnapAppFiltered.png`);
        break;
      ...
      case SnapStatus.NotSnappable:
        errorSprite = IconSprites.getSpriteFromUrl(`${IModelApp.assetsPath}sprites/SnapNotSnappable.png`);
