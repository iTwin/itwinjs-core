...
export class BackgroundMapGeometry {
  ...
  public async cartographicToDbFromGcs(cartographic: Cartographic, result?: Point3d): Promise<Point3d> {
    ...
    return (!this._iModel.noGcsDefined && undefined !== this._iModel.geographicCoordinateSystem && this.cartesianRange.containsPoint(db)) ? this._iModel.cartographicToSpatialFromGcs(cartographic) : db;
  }
