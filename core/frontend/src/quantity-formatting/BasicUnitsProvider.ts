...
import { BadUnit, BasicUnit, UnitConversion, UnitProps, UnitsProvider } from "@itwin/core-quantity";
...
const UNIT_DATA: UnitDefinition[] = [
  // Angles ( base unit radian )
  {
    ...
    system: "Units.SI",
    conversion: { numerator: 1.0, denominator: 1.0, offset: 0.0 },
    displayLabel: "rad",
  },
  // 1 rad = 180.0/PI °
  {
    ...
    phenomenon: "Units.ANGLE",
    system: "Units.METRIC",
    conversion: { numerator: 180.0, denominator: 3.1415926535897932384626433832795, offset: 0.0 },
    displayLabel: "°",
  },
  {
    ...
    phenomenon: "Units.ANGLE",
    system: "Units.METRIC",
    conversion: { numerator: 10800.0, denominator: 3.1415926535897932384626433832795, offset: 0.0 },
    displayLabel: "'",
  },
  {
    ...
    phenomenon: "Units.ANGLE",
    system: "Units.METRIC",
    conversion: { numerator: 648000.0, denominator: 3.1415926535897932384626433832795, offset: 0.0 },
    displayLabel: '"',
  },
  {
    name: "Units.GRAD",
    phenomenon: "Units.ANGLE",
    system: "Units.METRIC",
    conversion: { numerator: 200, denominator: 3.1415926535897932384626433832795, offset: 0.0 },
    displayLabel: "grad",
  },
  ...
  { name: "Units.S", phenomenon: "Units.TIME", system: "Units.SI", conversion: { numerator: 1.0, denominator: 1.0, offset: 0.0 }, displayLabel: "s" },
  {
    ...
    system: "Units.INTERNATIONAL",
    conversion: { numerator: 1.0, denominator: 60.0, offset: 0.0 },
    displayLabel: "min",
  },
  {
    name: "Units.HR",
    phenomenon: "Units.TIME",
    system: "Units.INTERNATIONAL",
    conversion: { numerator: 1.0, denominator: 3600.0, offset: 0.0 },
    displayLabel: "h",
  },
  {
    name: "Units.DAY",
    phenomenon: "Units.TIME",
    system: "Units.INTERNATIONAL",
    conversion: { numerator: 1.0, denominator: 86400.0, offset: 0.0 },
    displayLabel: "days",
  },
  {
    name: "Units.WEEK",
    phenomenon: "Units.TIME",
    system: "Units.INTERNATIONAL",
    conversion: { numerator: 1.0, denominator: 604800.0, offset: 0.0 },
    displayLabel: "weeks",
  },
  // 1 sec = 1/31536000.0 yr
  {
    ...
    phenomenon: "Units.TIME",
    system: "Units.INTERNATIONAL",
    conversion: { numerator: 1.0, denominator: 31536000.0, offset: 0.0 },
    displayLabel: "years",
  },
  ...
  },
  {
    ...
    phenomenon: "Units.LENGTH",
    system: "Units.METRIC",
    conversion: { numerator: 1000.0, denominator: 1.0, offset: 0.0 },
    displayLabel: "mm",
  },
  {
    name: "Units.CM",
    phenomenon: "Units.LENGTH",
    system: "Units.METRIC",
    conversion: { numerator: 100.0, denominator: 1.0, offset: 0.0 },
    displayLabel: "cm",
  },
  {
    name: "Units.DM",
    phenomenon: "Units.LENGTH",
    system: "Units.METRIC",
    conversion: { numerator: 10.0, denominator: 1.0, offset: 0.0 },
    displayLabel: "dm",
  },
  {
    name: "Units.KM",
    phenomenon: "Units.LENGTH",
    system: "Units.METRIC",
    conversion: { numerator: 1.0, denominator: 1000.0, offset: 0.0 },
    displayLabel: "km",
  },
  {
    name: "Units.UM",
    phenomenon: "Units.LENGTH",
    system: "Units.METRIC",
    conversion: { numerator: 1000000.0, denominator: 1.0, offset: 0.0 },
    displayLabel: "µm",
  },
  {
    name: "Units.MILLIINCH",
    phenomenon: "Units.LENGTH",
    system: "Units.USCUSTOM",
    conversion: { numerator: 1000.0, denominator: 0.0254, offset: 0.0 },
    displayLabel: "mil",
  },
  {
    name: "Units.MICROINCH",
    phenomenon: "Units.LENGTH",
    system: "Units.USCUSTOM",
    conversion: { numerator: 1000000.0, denominator: 0.0254, offset: 0.0 },
    displayLabel: "µin",
  },
  {
    name: "Units.MILLIFOOT",
    phenomenon: "Units.LENGTH",
    system: "Units.USCUSTOM",
    conversion: { numerator: 1000.0, denominator: 0.3048, offset: 0.0 },
    displayLabel: "mft",
  },
  {
    name: "Units.IN",
    phenomenon: "Units.LENGTH",
    system: "Units.USCUSTOM",
    conversion: { numerator: 1.0, denominator: 0.0254, offset: 0.0 },
    displayLabel: "in",
  },
  {
    name: "Units.FT",
    phenomenon: "Units.LENGTH",
    system: "Units.USCUSTOM",
    conversion: { numerator: 1.0, denominator: 0.3048, offset: 0.0 },
    displayLabel: "ft",
  },
  {
    name: "Units.CHAIN",
    phenomenon: "Units.LENGTH",
    system: "Units.USCUSTOM",
    conversion: { numerator: 1.0, denominator: 66.0 * 0.3048, offset: 0.0 },
    displayLabel: "chain",
  },
  {
    name: "Units.YRD",
    phenomenon: "Units.LENGTH",
    system: "Units.USCUSTOM",
    conversion: { numerator: 1.0, denominator: 0.9144, offset: 0.0 },
    displayLabel: "yd",
  },
  {
    name: "Units.MILE",
    phenomenon: "Units.LENGTH",
    system: "Units.USCUSTOM",
    conversion: { numerator: 1.0, denominator: 1609.344, offset: 0.0 },
    displayLabel: "mi",
  },
  {
    name: "Units.US_SURVEY_FT",
    phenomenon: "Units.LENGTH",
    system: "Units.USSURVEY",
    conversion: { numerator: 3937.0, denominator: 1200.0, offset: 0.0 },
    displayLabel: "ft (US Survey)",
  },
  {
    name: "Units.US_SURVEY_YRD",
    phenomenon: "Units.LENGTH",
    system: "Units.USSURVEY",
    conversion: { numerator: 3937.0, denominator: 3.0 * 1200.0, offset: 0.0 },
    displayLabel: "yrd (US Survey)",
  },
  {
    name: "Units.US_SURVEY_IN",
    phenomenon: "Units.LENGTH",
    system: "Units.USSURVEY",
    conversion: { numerator: 3937.0, denominator: 100.0, offset: 0.0 },
    displayLabel: "in (US Survey)",
  },
  {
    name: "Units.US_SURVEY_MILE",
    phenomenon: "Units.LENGTH",
    system: "Units.USSURVEY",
    conversion: { numerator: 3937.0, denominator: 5280.0 * 1200.0, offset: 0.0 },
    displayLabel: "mi (US Survey)",
  },
  {
    name: "Units.US_SURVEY_CHAIN",
    phenomenon: "Units.LENGTH",
    system: "Units.USSURVEY",
    conversion: { numerator: 1.0, denominator: 20.11684, offset: 0.0 },
    displayLabel: "chain (US Survey)",
  },
  // conversion => specified unit to base unit of m²
  {
    name: "Units.SQ_FT",
    ...
    system: "Units.USCUSTOM",
    conversion: { numerator: 1.0, denominator: 0.09290304, offset: 0.0 },
    displayLabel: "ft²",
  },
  {
    name: "Units.SQ_US_SURVEY_FT",
    phenomenon: "Units.AREA",
    system: "Units.USCUSTOM",
    conversion: { numerator: 15499969.0, denominator: 1440000, offset: 0.0 },
    displayLabel: "ft² (US Survey)",
  },
  {
    name: "Units.SQ_M",
  ...
  // conversion => specified unit to base unit m³
  {
    ...
    system: "Units.USCUSTOM",
    conversion: { numerator: 1.0, denominator: 0.028316847, offset: 0.0 },
    displayLabel: "ft³",
  },
  {
    name: "Units.CUB_US_SURVEY_FT",
    phenomenon: "Units.VOLUME",
    system: "Units.USSURVEY",
    conversion: { numerator: 1, denominator: 0.0283170164937591, offset: 0.0 },
    displayLabel: "ft³",
  },
  {
    name: "Units.CUB_YRD",
    phenomenon: "Units.VOLUME",
    system: "Units.USCUSTOM",
    conversion: { numerator: 1.0, denominator: 0.76455486, offset: 0.0 },
    displayLabel: "yd³",
  },
  {
    name: "Units.CUB_M",
