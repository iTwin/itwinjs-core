 ...
 * @see [[ElementLocateManager]]
  */
   ...
   * @deprecated in 5.0 - will not be removed until 2026-06-13. Use [[mapTileTreeRefs]] instead.
   */
  ...
  * @deprecated in 5.0 - will not be removed until 2026-06-13. Use the overload accepting a ReadImageToCanvasOptions.
  */
