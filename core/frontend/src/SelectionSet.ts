...
export interface SelectAddEvent {
   ...
   * @deprecated in 5.0 - will not be removed until 2026-06-13. Use the [[additions]] attribute instead.
   */
  added: Id64Arg;
...
export interface SelectRemoveEvent {
   ...
   * @deprecated in 5.0 - will not be removed until 2026-06-13. Use the [[removals]] attribute instead.
   */
  removed: Id64Arg;
...
export class HiliteSet {
   ...
   * @deprecated in 5.0 - will not be removed until 2026-06-13. Use [[add]], [[remove]], [[replace]] instead.
   */
...
export class SelectionSet {
   ...
   * @see [[isSelected]]
   * @deprecated in 5.0 - will not be removed until 2026-06-13. Use `SelectionSet.elements.has(elemId)` instead.
   */
