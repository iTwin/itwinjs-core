...
- Enhance text display performance by implementing texture atlases which store multiple glyphs within tiles.
...
- Change tentative cross to canvas decorator.
...
- Add option to enable all hidden subcategories when enabling display of a category.
...
- Analysis mesh import from JSON
- doc fixes
- docs
