...
const unitData: UnitDefinition[] = [
  // Angles ( base unit radian )
  {
    ...
    displayLabel: "rad",
    altDisplayLabels: ["radian"],
  },
  {
    name: "Units.REVOLUTION",
    phenomenon: "Units.ANGLE",
    system: "Units.METRIC",
    conversion: { numerator: 1.0, denominator: 6.283185307179586, offset: 0.0 },
    displayLabel: "r",
    altDisplayLabels: ["rev"],
  },
  // 1 rad = 180.0/PI °
  {
    name: "Units.ARC_DEG",
  ...
  },
  {
    ...
    displayLabel: "mi",
    altDisplayLabels: ["mile", "Miles", "Mile"],
  },

  {
    ...
    phenomenon: "Units.LENGTH",
    system: "Units.BOBUS",
    conversion: { numerator: 1.0, denominator: 0.0254, offset: 0.025 },
    displayLabel: "bi",
    altDisplayLabels: [],
  },
  ...
  },
  {
    ...
    altDisplayLabels: ["chains (US Survey)"],
  },
  // conversion => specified unit to base unit of m²
  {
    name: "Units.SQ_FT",
