...
describe("Numeric Formats tests:", () => {
  it("Feet to 4 Decimal places w/trailing zeros ", async () => {
    ...
    const testQuantityData = [
      {
        magnitude: -12.5416666666667,
        unit: { name: "Units.FT", label: "ft", contextId: "Units.LENGTH" },
        result: "-12.5417 ft",
      },
      {
        magnitude: 12.5416666666667,
      ...
      {
        magnitude: 3000.99999999,
        unit: { name: "Units.FT", label: "ft", contextId: "Units.LENGTH" },
        result: "3,001.0000 ft",
      },
      {
        magnitude: 1.05,
        unit: { name: "Units.FT", label: "ft", contextId: "Units.LENGTH" },
      ...
      },
      {
        magnitude: 12345789,
        unit: { name: "Units.FT", label: "FT", contextId: "Units.LENGTH" },
        result: "12,345,789.0000 FT",
      },
      {
        magnitude: 10000000,
        unit: { name: "Units.FT", label: "FT", contextId: "Units.LENGTH" },
        result: "10,000,000.0000 FT",
      },
      {
        magnitude: 100000,
        unit: { name: "Units.FT", label: "FT", contextId: "Units.LENGTH" },
        result: "100,000.0000 FT",
      },
      {
        magnitude: 0.0,
        unit: { name: "Units.FT", label: "ft", contextId: "Units.LENGTH" },
  ...
  it("Feet in scientific notation zero normalized", async () => {
    ...
    const testQuantityData = [
      ...
      {
        magnitude: 5027745120,
        unit: { name: "Units.FT", label: "ft", contextId: "Units.LENGTH" },
        result: "0.5028e10 ft",
      },
      {
        magnitude: 0.0000000105,
        unit: { name: "Units.FT", label: "ft", contextId: "Units.LENGTH" },
        result: "0.105e-7 ft",
      },
      {
  ...
  it("Imperial Station Formatting", async () => {
    ...
    const testQuantityData = [
      ...
      {
        magnitude: 123456.789,
        unit: { name: "Units.FT", label: "ft", contextId: "Units.LENGTH" },
        result: "1234+56.79",
      },
      {
        magnitude: 1234567890,
        unit: { name: "Units.FT", label: "ft", contextId: "Units.LENGTH" },
        result: "12345678+90.00",
      },
      {
        magnitude: 3001.99999999,
        unit: { name: "Units.FT", label: "ft", contextId: "Units.LENGTH" },
        result: "30+02.00",
      },
      {
