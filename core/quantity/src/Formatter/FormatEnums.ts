...
/**
 * @beta
 * @deprecated in 4.10 - will not be removed until 2026-06-13. ScientificType is now a string enum and doesn't need a serialization method. You can access the enum directly.
*/
...
/**
 * @beta
 * @deprecated in 4.10 - will not be removed until 2026-06-13. ShowSignOption is now a string enum and doesn't need a serialization method. You can access the enum directly.
*/
...
/** @beta
 *  @deprecated in 4.10 - will not be removed until 2026-06-13. FormatType is now a string enum and doesn't need a serialization method. You can access the enum directly.
*/
