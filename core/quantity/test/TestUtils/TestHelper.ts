...
const unitData: UnitDefinition[] = [
  ...
  { name: "Units.BOGUS.IN", unitFamily: "Units.LENGTH", system: "Units.BOBUS", conversion: { numerator: 1.0, denominator: 0.0254, offset: 0.025 }, displayLabel: "bi", altDisplayLabels: [] },
