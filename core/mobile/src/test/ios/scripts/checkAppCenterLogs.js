...
function writeToConsole(loglevel, logEntry) {
  if (logEntry !== "") {
    if (loglevel === "INFO") console.info(logEntry);
    else if (loglevel === "ERROR") console.error(logEntry);
    else if (loglevel === "WARN") console.warn(logEntry);
    else if (loglevel === "DEBUG") console.debug(logEntry);
    else if (loglevel === "TRACE") console.trace(logEntry);
