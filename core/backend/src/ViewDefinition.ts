...
export class ModelSelector extends DefinitionElement {
  ...
  /** @deprecated in 5.9.0 - might be removed in next major version. Use ModelSelector.insert(txn, ...) instead. */
...
export class CategorySelector extends DefinitionElement {
  ...
  /** @deprecated in 5.9.0 - might be removed in next major version. Use CategorySelector.insert(txn, ...) instead. */
...
export class SpatialViewDefinition extends ViewDefinition3d {
  ...
  /** @deprecated in 5.9.0 - might be removed in next major version. Use SpatialViewDefinition.insertWithCamera(txn, ...) instead. */
...
export class OrthographicViewDefinition extends SpatialViewDefinition {
  ...
  /** @deprecated in 5.9.0 - might be removed in next major version. Use OrthographicViewDefinition.insert(txn, ...) instead. */
...
export class DrawingViewDefinition extends ViewDefinition2d {
  ...
  /** @deprecated in 5.9.0 - might be removed in next major version. Use DrawingViewDefinition.insert(txn, ...) instead. */
...
export class SheetViewDefinition extends ViewDefinition2d {
  ...
  /** @deprecated in 5.9.0 - might be removed in next major version. Use SheetViewDefinition.insert(txn, ...) instead. */
