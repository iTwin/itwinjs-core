...
export class IModelHost {
   ...
   * @deprecated in 4.10 - will not be removed until 2026-06-13. When opening a snapshot by file name, ensure to pass already resolved path. Using a key to open a snapshot is now deprecated.
   */
