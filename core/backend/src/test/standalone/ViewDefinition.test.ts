...
function createNewModelAndCategory(rwIModel: IModelDb, parent?: Id64String) {
  const modelId = IModelTestUtils.createAndInsertPhysicalPartition(
    rwIModel,
...
describe("ViewDefinition", () => {
  ...
  it("create SpatialViewDefinition and throw errors on bad input", () => {
    ...
    const props: SpatialViewDefinitionProps = {
      ...basicProps,
      modelSelectorId,
      categorySelectorId,
      displayStyleId,
    ...
    viewDefinitionId = SpatialViewDefinition.insertWithCamera(
      iModel,
      IModel.dictionaryId,
      "default",
      modelSelectorId,
