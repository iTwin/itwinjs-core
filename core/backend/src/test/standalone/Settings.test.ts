...
describe("Settings", () => {
  ...
  it("settings priorities", () => {
    ...
    expect(() =>
      IModelHost.appWorkspace.settings.addDictionary("iModel", SettingsPriority.iModel, imodel1Settings)
  ...
  it("read settings file", () => {
    ...
    expect(() => iModelSettings.addFile(settingFileName, SettingsPriority.application)).to.throw(
      "Use IModelHost.appSettings"
    );
