...
describe("ExternalSource", () => {
  it("should create elements and relationships like an iModel Connector would", () => {
    ...
    iModelDb.relationships.insertInstance({
      classFullName: ExternalSourceGroupGroupsSources.classFullName,
      sourceId: group1,
      targetId: modelA,
    });
    iModelDb.relationships.insertInstance({
  ...
  function insertExternalSourceAttachment(
    iModelDb: IModelDb,
    masterModel: Id64String,
    attachedModel: Id64String,
    label: string
  ): Id64String {
