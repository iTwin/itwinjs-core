...
describe("DeleteDefinitionElements", () => {
  ...
  it("should delete if not used", async () => {
    ...
    const viewId = iModelDb.elements.queryElementIdByCode(
      OrthographicViewDefinition.createCode(iModelDb, definitionModelId, "Orthographic View")
    )!;
    ...
    const drawingViewId = iModelDb.elements.queryElementIdByCode(
      DrawingViewDefinition.createCode(iModelDb, definitionModelId, "Drawing View")
    )!;
    ...
    const renderMaterialId = iModelDb.elements.queryElementIdByCode(
      RenderMaterialElement.createCode(iModelDb, definitionModelId, "RenderMaterial")
    )!;
    ...
    const unusedRenderMaterialId = RenderMaterialElement.insert(iModelDb, definitionModelId, "Unused RenderMaterial", {
