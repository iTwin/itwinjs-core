...
```sql
SELECT ECInstanceId, ec_classname(ECClassId) as Name, i, l, d, b, dt, s, bin, p2d, p3d FROM aps.TestElement WHERE i < 102
```
...
| ECInstanceId | Name                      | i   | l    | d   | b    | dt                      | s    | bin                                | p2d                          | p3d                                        |
| ------------ | ------------------------- | --- | ---- | --- | ---- | ----------------------- | ---- | ---------------------------------- | ---------------------------- | ------------------------------------------ |
...
```sql
SELECT ECInstanceId, ec_classname(ECClassId) as Name, i, l, d, b, dt, s, bin, p2d, p3d FROM aps.TestElement WHERE i != 105
```
...
```sql
SELECT ECInstanceId, ec_classname(ECClassId) as Name, i, l, d, b, dt, s, bin, p2d, p3d FROM aps.TestElement WHERE i = 104
```
...
```sql
SELECT ECInstanceId, ec_classname(ECClassId) as Name, i, l, d, b, dt, s, bin, p2d, p3d FROM aps.TestElement WHERE i > 107
```
...
```sql
SELECT ECInstanceId, ec_classname(ECClassId) as Name, i, l, d, b, dt, s, bin, p2d, p3d FROM aps.TestElement WHERE i >= 106
```
