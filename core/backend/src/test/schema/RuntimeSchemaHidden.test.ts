...
import type { RuntimeSchemaContext } from "@itwin/ecschema-metadata";
 ...
 * corresponding RuntimeSchema, RuntimeClass, and RuntimeProperty objects.
 */
describe("RuntimeSchema hidden flags", () => {
  before(async () => {
