  ...
  const completionTest = async (incompleteGCS: GeographicCRSProps, completeCRS: GeographicCRSProps) => {
    ...
    if (response.geographicCRS !== undefined) {
      ...
      if (completeCRS.horizontalCRS!.projection!.falseEasting !== undefined) {
        ...
        assert.isTrue(
          Math.abs(response.geographicCRS.horizontalCRS!.projection!.falseEasting! - completeCRS.horizontalCRS!.projection!.falseEasting) <
      ...
      if (completeCRS.horizontalCRS!.projection!.falseNorthing !== undefined) {
        ...
        assert.isTrue(
          Math.abs(response.geographicCRS.horizontalCRS!.projection!.falseNorthing! - completeCRS.horizontalCRS!.projection!.falseNorthing) <
            Geometry.smallMetricDistance,
        );
      }
      ...
      assert.isTrue(
        response.geographicCRS.horizontalCRS!.datum!.ellipsoid !== undefined && completeCRS.horizontalCRS!.datum!.ellipsoid !== undefined,
      );
      ...
      if (response.geographicCRS.additionalTransform !== undefined) {
        ...
        assert.isTrue(
          Math.abs(
            response.geographicCRS.additionalTransform.helmert2DWithZOffset!.rotDeg - completeCRS.additionalTransform!.helmert2DWithZOffset!.rotDeg,
        ...
        assert.isTrue(
          Math.abs(
            response.geographicCRS.additionalTransform.helmert2DWithZOffset!.scale - completeCRS.additionalTransform!.helmert2DWithZOffset!.scale,
