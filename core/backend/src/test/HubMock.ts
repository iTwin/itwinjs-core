...
export class HubMock {
  ...
  public static async getMyBriefcaseIds(arg: IModelIdArg): Promise<number[]> {
    ...
    return this.findLocalHub(arg.iModelId).getBriefcaseIds(requestContext.accessToken ?? ""); // TODO: Definitely want some default besides empty string. Find best way to get userId here and in acquireNewBriefcaseid
  }
