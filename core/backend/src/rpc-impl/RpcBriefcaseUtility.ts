...
export interface DownloadAndOpenArgs {
  activity: RpcActivity; // eslint-disable-line @typescript-eslint/no-deprecated
...
export class RpcBriefcaseUtility {
  ...
  public static async openWithTimeout(activity: RpcActivity, tokenProps: IModelRpcOpenProps, syncMode: SyncMode, timeout: number = 1000): Promise<IModelConnectionProps> { // eslint-disable-line @typescript-eslint/no-deprecated
