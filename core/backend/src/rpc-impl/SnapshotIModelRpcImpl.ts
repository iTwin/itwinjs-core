...
import type {
  IModelConnectionProps, IModelRpcProps, SnapshotOpenOptions} from "@itwin/core-common";
import { IModelNotFoundResponse, RpcInterface, RpcManager, SnapshotIModelRpcInterface,
