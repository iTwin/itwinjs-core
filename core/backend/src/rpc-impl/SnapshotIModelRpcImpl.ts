...
import { RpcInterface, RpcManager, IModel, IModelToken, SnapshotIModelRpcInterface } from "@bentley/imodeljs-common";
...
export class SnapshotIModelRpcImpl extends RpcInterface implements SnapshotIModelRpcInterface {
  ...
  public async openSnapshot(fileName: string): Promise<IModel> { return IModelDb.openSnapshot(fileName); }

  public async closeSnapshot(iModelToken: IModelToken): Promise<boolean> {
