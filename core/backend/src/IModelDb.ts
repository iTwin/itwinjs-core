...
export abstract class IModelDb extends IModel {
  ...
  public static get activeEditCommand(): boolean { return IModelDb._activeEditCommand === undefined || IModelDb._allowEditCommandOperation; }
