...
export abstract class IModelDb extends IModel {
  ...
  public static get isOperationAllowed(): boolean { return IModelDb._activeEditCommand === undefined || IModelDb._allowEditCommandOperation; }
  ...
  */
  ...
  public restartTxnSession(): void {
    if (!IModelDb.isOperationAllowed)
      throw new IModelError(IModelStatus.BadRequest, "Cannot restart transaction session during an active edit command");
