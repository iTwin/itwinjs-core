...
export class ChannelRootAspect extends ElementUniqueAspect {
   ...
   * @deprecated in 4.0 - will not be removed until 2026-06-13. Use [[ChannelControl.makeChannelRoot]]. This method does not enforce the rule that channels may not nest and is therefore dangerous.
   */
