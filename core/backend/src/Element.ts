...
export class Element extends Entity {
   ...
   * @note In order to clone/transform an element, all referenced elements must have been previously cloned and remapped within the [IModelCloneContext]($backend).
