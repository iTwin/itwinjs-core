...
export class CodeSpecs {
   ...
   * @note If successful, this method will assign a valid CodeSpecId to the supplied CodeSpec
   * @throws IModelError if the insertion fails
   * @deprecated in 5.9.0 - might be removed in next major version. Use CodeSpecs.insert(txn, codeSpec) instead.
   */
   ...
   * @returns The Id of the persistent CodeSpec.
   * @throws IModelError if the insertion fails
   * @deprecated in 5.9.0 - might be removed in next major version. Use CodeSpecs.insert(txn, ...) instead.
   */
   ...
   * @param codeSpec The codeSpec holding Json properties values to update.
   * @throws if unable to update the codeSpec.
   * @deprecated in 5.9.0 - might be removed in next major version. Use CodeSpecs.updateProperties(txn, codeSpec) instead.
   */
