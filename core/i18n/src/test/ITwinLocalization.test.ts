...
describe("ITwinLocalization", () => {
  ...
  describe("#constructor", () => {
    ...
    it("set default language as english", async () => {
      itwinLocalization = new ITwinLocalization({
        initOptions: { defaultNS: "Default", lng: "en" },
      });
      await itwinLocalization.initialize([]);
    ...
    it("set default language as NOT english", async () => {
      itwinLocalization = new ITwinLocalization({
        initOptions: { defaultNS: "Default", lng: "de" },
      });
      await itwinLocalization.initialize([]);
    ...
    it("set fallback language as NOT english", async () => {
      itwinLocalization = new ITwinLocalization({
        initOptions: { defaultNS: "Default", fallbackLng: "de" },
      });
      await itwinLocalization.initialize([]);
  ...
  describe("#getLocalizedKeys", () => {
    before(async () => {
      ...
      germanLocalization = new ITwinLocalization({
        initOptions: { lng: "de" },
      });
    ...
    describe("Default Namespace", () => {
      it("first level string", () => {
        ...
        assert.equal(
          germanLocalization.getLocalizedKeys("hi %{FirstTrivial}"),
          "hi First level string (default german)"
        );
      });
      ...
      it("second level string", () => {
        ...
        assert.equal(
          localization.getLocalizedKeys("bye %{SecondTrivial.Test2}"),
          "bye Second level string 2 (default)"
        );
        assert.equal(
          germanLocalization.getLocalizedKeys("%{SecondTrivial.Test1}"),
          "Second level string 1 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedKeys("bye %{SecondTrivial.Test2}"),
          "bye Second level string 2 (default german)"
        );
      });
      ...
      it("first level string with keys", () => {
        ...
        assert.equal(
          localization.getLocalizedKeys("bye %{FirstSubstitution2}"),
          "bye First level {{str1}} and {{str2}} (default)"
        );
        assert.equal(
          germanLocalization.getLocalizedKeys("%{FirstSubstitution1}"),
          "First level {{str}} (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedKeys("bye %{FirstSubstitution2}"),
          "bye First level {{str1}} and {{str2}} (default german)"
        );
      });

      it("second level string with keys", () => {
        assert.equal(
          localization.getLocalizedKeys("%{SecondSubstitution.Test1}"),
          "Substitute {{varA}} and {{varB}} (default)"
        );
        assert.equal(
          localization.getLocalizedKeys("hi %{SecondSubstitution.Test2}"),
          "hi Reverse substitute {{varB}} and {{varA}} (default)"
        );
        assert.equal(
          germanLocalization.getLocalizedKeys("%{SecondSubstitution.Test1}"),
          "Substitute {{varA}} and {{varB}} (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedKeys("hi %{SecondSubstitution.Test2}"),
          "hi Reverse substitute {{varB}} and {{varA}} (default german)"
        );
      });
      ...
      it("second level missing key doesn't find a value", () => {
        assert.equal(
          localization.getLocalizedKeys("hi %{SecondTrivial.MissingString}"),
          "hi SecondTrivial.MissingString"
        );
        assert.equal(
          localization.getLocalizedKeys("%{MissingKeyObject.MissingString}"),
          "MissingKeyObject.MissingString"
        );
      });
    });
    ...
    describe("Given Namespace", () => {
      ...
      it("second level string", () => {
        assert.equal(
          localization.getLocalizedKeys("%{Default:SecondTrivial.Test1}"),
          "Second level string 1 (default)"
        );
        assert.equal(
          localization.getLocalizedKeys("bye %{Default:SecondTrivial.Test2}"),
          "bye Second level string 2 (default)"
        );
        assert.equal(localization.getLocalizedKeys("%{Test:SecondTrivial.Test1}"), "Second level string 1 (test)");
        assert.equal(
          localization.getLocalizedKeys("bye %{Test:SecondTrivial.Test2}"),
          "bye Second level string 2 (test)"
        );
      });
      ...
      it("first level string with keys", () => {
        ...
        assert.equal(
          localization.getLocalizedKeys("bye %{Default:FirstSubstitution2}"),
          "bye First level {{str1}} and {{str2}} (default)"
        );
        assert.equal(localization.getLocalizedKeys("%{Test:FirstSubstitution1}"), "First level {{str}} (test)");
        assert.equal(
          localization.getLocalizedKeys("bye %{Test:FirstSubstitution2}"),
          "bye First level {{str1}} and {{str2}} (test)"
        );
      });

      it("second level string with keys", () => {
        assert.equal(
          localization.getLocalizedKeys("%{Default:SecondSubstitution.Test1}"),
          "Substitute {{varA}} and {{varB}} (default)"
        );
        assert.equal(
          localization.getLocalizedKeys("hi %{Default:SecondSubstitution.Test2}"),
          "hi Reverse substitute {{varB}} and {{varA}} (default)"
        );
        assert.equal(
          localization.getLocalizedKeys("%{Test:SecondSubstitution.Test1}"),
          "Substitute {{varA}} and {{varB}} (test)"
        );
        assert.equal(
          localization.getLocalizedKeys("hi %{Test:SecondSubstitution.Test2}"),
          "hi Reverse substitute {{varB}} and {{varA}} (test)"
        );
      });
      ...
      it("second level missing key doesn't find a value", () => {
        assert.equal(
          localization.getLocalizedKeys("hi %{Default:SecondTrivial.MissingString}"),
          "hi SecondTrivial.MissingString"
        );
        assert.equal(
          localization.getLocalizedKeys("%{Default:MissingKeyObject.MissingString}"),
          "MissingKeyObject.MissingString"
        );
        assert.equal(
          localization.getLocalizedKeys("hi %{Test:SecondTrivial.MissingString}"),
          "hi SecondTrivial.MissingString"
        );
        assert.equal(
          localization.getLocalizedKeys("%{Test:MissingKeyObject.MissingString}"),
          "MissingKeyObject.MissingString"
        );
      });
    });
  ...
  describe("#getLocalizedString", () => {
    ...
    describe("Default Namespace", () => {
      ...
      it("more than two fallback keys succeeds", () => {
        assert.equal(
          localization.getLocalizedString(["FirstTrivial", "NotExist1", "NotExist2"]),
          "First level string (default)"
        );
        assert.equal(
          localization.getLocalizedString(["NotExist1", "FirstTrivial", "NotExist2"]),
          "First level string (default)"
        );
        assert.equal(
          localization.getLocalizedString(["NotExist1", "NotExist2", "FirstTrivial"]),
          "First level string (default)"
        );
        assert.equal(
          localization.getLocalizedString(["1", "2", "3", "4", "5", "FirstTrivial"]),
          "First level string (default)"
        );
      });
      ...
      it("second level with no substitution with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["NotExist", "SecondTrivial.Test1"]),
          "Second level string 1 (default)"
        );
        assert.equal(
          localization.getLocalizedString(["SecondTrivial.Test2", "NotExist"]),
          "Second level string 2 (default)"
        );
      });

      it("first level with substitution", () => {
        assert.equal(
          localization.getLocalizedString("FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (default)"
        );
        assert.equal(
          localization.getLocalizedString("FirstSubstitution1", {
            str: "CUSTOM2",
          }),
          "First level CUSTOM2 (default)"
        );
        assert.equal(
          localization.getLocalizedString("FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (default)"
        );
      });

      it("first level with substitution with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["NotExist", "FirstSubstitution1"], {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (default)"
        );
        assert.equal(
          localization.getLocalizedString(["FirstSubstitution1", "NotExist"], {
            str: "CUSTOM2",
          }),
          "First level CUSTOM2 (default)"
        );
        assert.equal(
          localization.getLocalizedString(["NotExist", "FirstSubstitution2"], {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (default)"
      ...
      it("second level with substitution", () => {
        assert.equal(
          localization.getLocalizedString("SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default)"
        );
        assert.equal(
          localization.getLocalizedString("SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (default)"
        );
      });

      it("second level with substitution with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["NotExist", "SecondSubstitution.Test1"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default)"
        ...
        assert.equal(
          localization.getLocalizedString(["SecondSubstitution.Test2", "NotExist"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (default)"
      ...
      it("second level missing key doesn't find a value", () => {
        ...
        assert.equal(
          localization.getLocalizedString(["NotExist", "MissingKeyObject.MissingString"]),
          "MissingKeyObject.MissingString"
        );
      });
    ...
    describe("Default Namespace (German)", () => {
      ...
      it("first level with no substitution with fallback keys", () => {
        assert.equal(
          germanLocalization.getLocalizedString(["FirstTrivial", "NotExist"]),
          "First level string (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString(["NotExist", "FirstTrivial"]),
          "First level string (default german)"
        );
      });
      ...
      it("second level with no substitution", () => {
        assert.equal(
          germanLocalization.getLocalizedString("SecondTrivial.Test1"),
          "Second level string 1 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("SecondTrivial.Test2"),
          "Second level string 2 (default german)"
        );
      });

      it("second level with no substitution with fallback keys", () => {
        assert.equal(
          germanLocalization.getLocalizedString(["NotExist", "SecondTrivial.Test1"]),
          "Second level string 1 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString(["SecondTrivial.Test2", "NotExist"]),
          "Second level string 2 (default german)"
        );
      });
      ...
      it("first level with substitution", () => {
        assert.equal(
          germanLocalization.getLocalizedString("FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("FirstSubstitution1", {
            str: "CUSTOM2",
          }),
          "First level CUSTOM2 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (default german)"
        );
      });

      it("first level with substitution with fallback keys", () => {
        assert.equal(
          germanLocalization.getLocalizedString(["NotExist", "FirstSubstitution1"], { str: "CUSTOM1" }),
          "First level CUSTOM1 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString(["FirstSubstitution1", "NotExist"], { str: "CUSTOM2" }),
          "First level CUSTOM2 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString(["NotExist", "FirstSubstitution2"], {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (default german)"
      ...
      it("second level with substitution", () => {
        assert.equal(
          germanLocalization.getLocalizedString("SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (default german)"
        );
      });

      it("second level with substitution with fallback keys", () => {
        assert.equal(
          germanLocalization.getLocalizedString(["NotExist", "SecondSubstitution.Test1"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default german)"
        ...
        assert.equal(
          germanLocalization.getLocalizedString(["SecondSubstitution.Test2", "NotExist"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (default german)"
      ...
      it("second level missing key doesn't find a value", () => {
        assert.equal(
          germanLocalization.getLocalizedString("SecondTrivial.MissingString"),
          "SecondTrivial.MissingString"
        );
        assert.equal(
          germanLocalization.getLocalizedString("MissingKeyObject.MissingString"),
          "MissingKeyObject.MissingString"
        );
      });
    });
    ...
    describe("Given Namespace", () => {
      ...
      it("first level with no substitution with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["Default:FirstTrivial", "Not:NotExist"]),
          "First level string (default)"
        );
        assert.equal(
          localization.getLocalizedString(["Default:NotExist", "Test:FirstTrivial"]),
          "First level string (test)"
        );
      });
      ...
      it("second level with no substitution with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["Test:NotExist", "Default:SecondTrivial.Test1"]),
          "Second level string 1 (default)"
        );
        assert.equal(
          localization.getLocalizedString(["Test:SecondTrivial.Test2", "NotExist"]),
          "Second level string 2 (test)"
        );
      });

      it("first level with substitution", () => {
        assert.equal(
          localization.getLocalizedString("Default:FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (default)"
        );
        ...
        assert.equal(
          localization.getLocalizedString("Default:FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (default)"
        ...
        assert.equal(
          localization.getLocalizedString("Test:FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (test)"
        );
        assert.equal(
          localization.getLocalizedString("Test:FirstSubstitution1", {
            str: "CUSTOM2",
          }),
          "First level CUSTOM2 (test)"
        );
        assert.equal(
          localization.getLocalizedString("Test:FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (test)"
        );
      });

      it("first level with substitution with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["Test:NotExist", "Default:FirstSubstitution1"], { str: "CUSTOM1" }),
          "First level CUSTOM1 (default)"
        );
        assert.equal(
          localization.getLocalizedString(["Test:FirstSubstitution1", "Default:NotExist"], { str: "CUSTOM2" }),
          "First level CUSTOM2 (test)"
        );
        assert.equal(
          localization.getLocalizedString(["Test:NotExist", "Default:FirstSubstitution2"], {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (default)"
      ...
      it("second level with substitution", () => {
        assert.equal(
          localization.getLocalizedString("Default:SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default)"
        ...
        assert.equal(
          localization.getLocalizedString("Default:SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (default)"
        ...
        assert.equal(
          localization.getLocalizedString("Test:SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (test)"
        );
        assert.equal(
          localization.getLocalizedString("Test:SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (test)"
        );
      });

      it("second level with substitution with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["Test:NotExist", "Default:SecondSubstitution.Test1"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default)"
        ...
        assert.equal(
          localization.getLocalizedString(["Test:SecondSubstitution.Test2", "Default:NotExist"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (test)"
      ...
      it("second level missing key doesn't find a value", () => {
        assert.equal(
          localization.getLocalizedString("Test:SecondTrivial.MissingString"),
          "SecondTrivial.MissingString"
        );
        assert.equal(
          localization.getLocalizedString("Test:MissingKeyObject.MissingString"),
          "MissingKeyObject.MissingString"
        );
      });
    ...
    describe("Given Namespace (German)", () => {
      it("first level with no substitution", () => {
        assert.equal(
          germanLocalization.getLocalizedString("Default:FirstTrivial"),
          "First level string (default german)"
        );
      ...
      it("second level with no substitution", () => {
        assert.equal(
          germanLocalization.getLocalizedString("Default:SecondTrivial.Test1"),
          "Second level string 1 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("Default:SecondTrivial.Test2"),
          "Second level string 2 (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("Test:SecondTrivial.Test1"),
          "Second level string 1 (german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("Test:SecondTrivial.Test2"),
          "Second level string 2 (german)"
        );
      });

      it("first level with substitution", () => {
        assert.equal(
          germanLocalization.getLocalizedString("Default:FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (default german)"
        );
        ...
        assert.equal(
          germanLocalization.getLocalizedString("Default:FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (default german)"
        ...
        assert.equal(
          germanLocalization.getLocalizedString("Test:FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("Test:FirstSubstitution1", {
            str: "CUSTOM2",
          }),
          "First level CUSTOM2 (german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("Test:FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (german)"
        );
      });

      it("second level with substitution", () => {
        assert.equal(
          germanLocalization.getLocalizedString("Default:SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default german)"
        ...
        assert.equal(
          germanLocalization.getLocalizedString("Default:SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (default german)"
        ...
        assert.equal(
          germanLocalization.getLocalizedString("Test:SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("Test:SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (german)"
        );
      });
      ...
      it("second level missing key doesn't find a value", () => {
        assert.equal(
          germanLocalization.getLocalizedString("Test:SecondTrivial.MissingString"),
          "SecondTrivial.MissingString"
        );
        assert.equal(
          germanLocalization.getLocalizedString("Test:MissingKeyObject.MissingString"),
          "MissingKeyObject.MissingString"
        );
      });
    });
    ...
    describe("With Options", () => {
      ...
      it("returnDetails and returnObjects throws error", () => {
        assert.throws(() => {
          localization.getLocalizedString("X", {
            returnDetails: true,
            returnObjects: true,
          });
        }, "Translation key must map to a string, but the given options will result in an object");
      ...
      it("default value", () => {
        assert.equal(
          localization.getLocalizedString("Missing", {
      ...
      it("override fallback language", () => {
        ...
        assert.equal(
          germanLocalization.getLocalizedString("OnlyEnglish", {
            fallbackLng: "de",
          }),
          "OnlyEnglish"
        );
  ...
  describe("#getLocalizedString with namespace passed in as an option", () => {
    ...
    describe("Keys Without Namespaces", () => {
      it("first level with no substitution", () => {
        assert.equal(
          localization.getLocalizedString("FirstTrivial", { ns: "Default" }),
          "First level string (default)"
        );
        assert.equal(localization.getLocalizedString("FirstTrivial", { ns: "Test" }), "First level string (test)");
      });
      ...
      it("first level with no substitution with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["FirstTrivial", "NotExist"], {
            ns: "Default",
          }),
          "First level string (default)"
        );
        assert.equal(
          localization.getLocalizedString(["NotExist", "FirstTrivial"], {
            ns: "Test",
          }),
          "First level string (test)"
        );
      ...
      it("second level with no substitution", () => {
        assert.equal(
          localization.getLocalizedString("SecondTrivial.Test1", {
            ns: "Default",
          }),
          "Second level string 1 (default)"
        );
        assert.equal(
          localization.getLocalizedString("SecondTrivial.Test2", {
            ns: "Default",
          }),
          "Second level string 2 (default)"
        );
      ...
      it("first level missing key doesn't find a value", () => {
        assert.equal(
          localization.getLocalizedString("MissingKeyString", {
            ns: "Default",
          }),
          "MissingKeyString"
        );
      ...
      it("second level missing key doesn't find a value", () => {
        assert.equal(
          localization.getLocalizedString("SecondTrivial.MissingString", {
            ns: "Test",
          }),
          "SecondTrivial.MissingString"
        );
        assert.equal(
          localization.getLocalizedString("MissingKeyObject.MissingString", {
            ns: "Test",
          }),
          "MissingKeyObject.MissingString"
        );
    ...
    describe("Keys Without Namespaces (German)", () => {
      it("first level with no substitution", () => {
        assert.equal(
          germanLocalization.getLocalizedString("FirstTrivial", {
            ns: "Default",
          }),
          "First level string (default german)"
        );
        assert.equal(
          germanLocalization.getLocalizedString("FirstTrivial", { ns: "Test" }),
          "First level string (german)"
        );
      });
      ...
      it("first level missing key doesn't find a value", () => {
        assert.equal(
          germanLocalization.getLocalizedString("MissingKeyString", {
            ns: "Default",
          }),
          "MissingKeyString"
        );
      ...
      it("second level missing key doesn't find a value", () => {
        ...
        assert.equal(
          germanLocalization.getLocalizedString("MissingKeyObject.MissingString", { ns: "Test" }),
          "MissingKeyObject.MissingString"
        );
      });
    });
    ...
    describe("Keys With Namespaces", () => {
      it("key with same namespace works", () => {
        assert.equal(
          localization.getLocalizedString("Default:FirstTrivial", {
            ns: "Default",
          }),
          "First level string (default)"
        );
        assert.equal(
          localization.getLocalizedString("Test:SecondTrivial.Test1", {
            ns: "Test",
          }),
          "Second level string 1 (test)"
        );
      ...
      it("key with different namespace overrides given namespace", () => {
        assert.equal(
          localization.getLocalizedString("Test:FirstTrivial", {
            ns: "Default",
          }),
          "First level string (test)"
        );
      ...
      it("key with same namespace works with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["NotExist:FirstTrivial", "Default:FirstTrivial"], { ns: "Default" }),
          "First level string (default)"
        );
        assert.equal(
          localization.getLocalizedString(["NotExist:FirstTrivial", "Test:FirstTrivial"], { ns: "Test" }),
          "First level string (test)"
        );
      });
      ...
      it("key with different namespace overrides given namespace with fallback keys", () => {
        assert.equal(
          localization.getLocalizedString(["NotExist:FirstTrivial", "Test:FirstTrivial"], { ns: "Default" }),
          "First level string (test)"
        );
        assert.equal(
          localization.getLocalizedString(["NotExist:FirstTrivial", "Default:FirstTrivial"], { ns: "Test" }),
          "First level string (default)"
        );
      });
      ...
      it("missing key does not find a value", () => {
        assert.equal(
          germanLocalization.getLocalizedString("Default:MissingKeyString", {
            ns: "Default",
          }),
          "MissingKeyString"
        );
        assert.equal(
          germanLocalization.getLocalizedString(["Missing1", "MissingKeyObject.MissingString"], { ns: "Test" }),
          "MissingKeyObject.MissingString"
        );
      });
    });
    ...
    describe("Nonexisting Namespace", () => {
      it("first level fails", () => {
        assert.equal(
          localization.getLocalizedString("FirstTrivial", {
            ns: "Nonexisting",
          }),
          "FirstTrivial"
        );
      ...
      it("second level fails", () => {
        ...
        assert.equal(
          localization.getLocalizedString("Missing.String", {
            ns: "Nonexisting",
          }),
          "Missing.String"
        );
      ...
      it("empty string namespace falls back to default namespace", () => {
        ...
        assert.equal(
          localization.getLocalizedString("SecondTrivial.Test1", { ns: "" }),
          "Second level string 1 (default)"
        );
      });
      ...
      it("fallback key fails", () => {
        ...
        assert.equal(
          localization.getLocalizedString(["NotExist", "Missing.String"], {
            ns: "Nonexisting",
          }),
          "Missing.String"
        );
      ...
      it("providing key with invalid namespace fails", () => {
        assert.equal(
          localization.getLocalizedString("Nonexisting2:FirstTrivial", {
            ns: "Nonexisting1",
          }),
          "FirstTrivial"
        );
  ...
  describe("#getEnglishString", () => {
    ...
    describe("Given Namespace", () => {
      ...
      it("first level with no substitution with fallback keys", () => {
        assert.equal(
          localization.getEnglishString("Default", ["FirstTrivial", "NotExist"]),
          "First level string (default)"
        );
      ...
      it("second level with no substitution", () => {
        assert.equal(
          localization.getEnglishString("Default", "SecondTrivial.Test1"),
          "Second level string 1 (default)"
        );
        assert.equal(
          localization.getEnglishString("Default", "SecondTrivial.Test2"),
          "Second level string 2 (default)"
        );
      ...
      it("second level with no substitution with fallback keys", () => {
        assert.equal(
          localization.getEnglishString("Default", ["NotExist", "SecondTrivial.Test1"]),
          "Second level string 1 (default)"
        );
        assert.equal(
          localization.getEnglishString("Test", ["SecondTrivial.Test2", "NotExist"]),
          "Second level string 2 (test)"
        );
      });
      ...
      it("first level with substitution", () => {
        assert.equal(
          localization.getEnglishString("Default", "FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (default)"
        );
        ...
        assert.equal(
          localization.getEnglishString("Default", "FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (default)"
        ...
        assert.equal(
          localization.getEnglishString("Test", "FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (test)"
        );
        ...
        assert.equal(
          localization.getEnglishString("Test", "FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (test)"
      ...
      it("first level with substitution with fallback keys", () => {
        assert.equal(
          localization.getEnglishString("Default", ["NotExist", "FirstSubstitution1"], { str: "CUSTOM1" }),
          "First level CUSTOM1 (default)"
        );
        assert.equal(
          localization.getEnglishString("Test", ["FirstSubstitution1", "NotExist"], { str: "CUSTOM2" }),
          "First level CUSTOM2 (test)"
        );
        assert.equal(
          localization.getEnglishString("Test", ["NotExist", "FirstSubstitution2"], {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (test)"
      ...
      it("second level with substitution", () => {
        assert.equal(
          localization.getEnglishString("Default", "SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default)"
        ...
        assert.equal(
          localization.getEnglishString("Default", "SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (default)"
        ...
        assert.equal(
          localization.getEnglishString("Test", "SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (test)"
        ...
        assert.equal(
          localization.getEnglishString("Test", "SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (test)"
      ...
      it("second level with substitution with fallback keys", () => {
        assert.equal(
          localization.getEnglishString("Default", ["NotExist", "SecondSubstitution.Test1"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default)"
        ...
        assert.equal(
          localization.getEnglishString("Test", ["SecondSubstitution.Test2", "NotExist"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (test)"
      ...
      it("second level missing key doesn't find a value", () => {
        assert.equal(
          localization.getEnglishString("Test", "SecondTrivial.MissingString"),
          "SecondTrivial.MissingString"
        );
        assert.equal(
          localization.getEnglishString("Test", "MissingKeyObject.MissingString"),
          "MissingKeyObject.MissingString"
        );
      });
    });
    ...
    describe("Given Namespace with German default language returns English strings", () => {
      ...
      it("first level with no substitution with fallback keys", () => {
        assert.equal(
          germanLocalization.getEnglishString("Default", ["FirstTrivial", "NotExist"]),
          "First level string (default)"
        );
        assert.equal(
          germanLocalization.getEnglishString("Test", ["NotExist", "FirstTrivial"]),
          "First level string (test)"
        );
      });
      ...
      it("second level with no substitution", () => {
        assert.equal(
          germanLocalization.getEnglishString("Default", "SecondTrivial.Test1"),
          "Second level string 1 (default)"
        );
        assert.equal(
          germanLocalization.getEnglishString("Default", "SecondTrivial.Test2"),
          "Second level string 2 (default)"
        );
        assert.equal(
          germanLocalization.getEnglishString("Test", "SecondTrivial.Test1"),
          "Second level string 1 (test)"
        );
        assert.equal(
          germanLocalization.getEnglishString("Test", "SecondTrivial.Test2"),
          "Second level string 2 (test)"
        );
      });
      ...
      it("second level with no substitution with fallback keys", () => {
        assert.equal(
          germanLocalization.getEnglishString("Default", ["NotExist", "SecondTrivial.Test1"]),
          "Second level string 1 (default)"
        );
        assert.equal(
          germanLocalization.getEnglishString("Test", ["SecondTrivial.Test2", "NotExist"]),
          "Second level string 2 (test)"
        );
      });
      ...
      it("first level with substitution", () => {
        assert.equal(
          germanLocalization.getEnglishString("Default", "FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (default)"
        );
        ...
        assert.equal(
          germanLocalization.getEnglishString("Default", "FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (default)"
        ...
        assert.equal(
          germanLocalization.getEnglishString("Test", "FirstSubstitution1", {
            str: "CUSTOM1",
          }),
          "First level CUSTOM1 (test)"
        );
        ...
        assert.equal(
          germanLocalization.getEnglishString("Test", "FirstSubstitution2", {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (test)"
      ...
      it("first level with substitution with fallback keys", () => {
        assert.equal(
          germanLocalization.getEnglishString("Default", ["NotExist", "FirstSubstitution1"], { str: "CUSTOM1" }),
          "First level CUSTOM1 (default)"
        );
        assert.equal(
          germanLocalization.getEnglishString("Test", ["FirstSubstitution1", "NotExist"], { str: "CUSTOM2" }),
          "First level CUSTOM2 (test)"
        );
        assert.equal(
          germanLocalization.getEnglishString("Test", ["NotExist", "FirstSubstitution2"], {
            str1: "CUSTOM1",
            str2: "CUSTOM2",
          }),
          "First level CUSTOM1 and CUSTOM2 (test)"
      ...
      it("second level with substitution", () => {
        assert.equal(
          germanLocalization.getEnglishString("Default", "SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default)"
        ...
        assert.equal(
          germanLocalization.getEnglishString("Default", "SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (default)"
        ...
        assert.equal(
          germanLocalization.getEnglishString("Test", "SecondSubstitution.Test1", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (test)"
        ...
        assert.equal(
          germanLocalization.getEnglishString("Test", "SecondSubstitution.Test2", {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (test)"
      ...
      it("second level with substitution with fallback keys", () => {
        assert.equal(
          germanLocalization.getEnglishString("Default", ["NotExist", "SecondSubstitution.Test1"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Substitute Variable1 and Variable2 (default)"
        ...
        assert.equal(
          germanLocalization.getEnglishString("Test", ["SecondSubstitution.Test2", "NotExist"], {
            varA: "Variable1",
            varB: "Variable2",
          }),
          "Reverse substitute Variable2 and Variable1 (test)"
      ...
      it("second level missing key doesn't find a value", () => {
        assert.equal(
          germanLocalization.getEnglishString("Test", "SecondTrivial.MissingString"),
          "SecondTrivial.MissingString"
        );
        assert.equal(
          germanLocalization.getEnglishString("Test", "MissingKeyObject.MissingString"),
          "MissingKeyObject.MissingString"
        );
      });
    });
    ...
    describe("With Options", () => {
      it("returnDetails throws error", () => {
        assert.throws(() => {
          localization.getEnglishString("Default", "X", {
            returnDetails: true,
          });
        }, "Translation key must map to a string, but the given options will result in an object");
      });
      ...
      it("default value", () => {
        assert.equal(
          localization.getEnglishString("Default", "Missing", {
            defaultValue: "default",
          }),
          "default"
        );
      ...
      it("english takes priority over fallback language", () => {
        assert.equal(
          germanLocalization.getEnglishString("Default", "OnlyEnglish", {
            fallbackLng: "de",
          }),
          "Hello"
        );
      ...
      it("given namespace overrides namespace translation option", () => {
        assert.equal(
          localization.getEnglishString("Default", "FirstTrivial", {
            ns: "Test",
          }),
          "First level string (default)"
        );
