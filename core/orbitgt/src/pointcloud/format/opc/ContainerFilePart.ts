...
export class ContainerFilePart {
  ...
  public rangeCheck(checkOffset: ALong, checkSize: ALong): void {
    ...
    ASystem.assertNot(
      ...
      "Range offset " + checkOffset.toString() + " falls before part " + this._offset.toString() + ".." + extent.toString(),
    );
    ASystem.assertNot(
      extent.sub(checkOffset).isNegative(),
      "Range offset " + checkOffset.toString() + " falls after part " + this._offset.toString() + ".." + extent.toString(),
    );
    ASystem.assertNot(checkSize.isNegative(), "Range size " + checkSize.toString() + " is negative");
    ASystem.assertNot(
      extent.sub(checkExtent).isNegative(),
      "Range extent " + checkExtent.toString() + " falls after part " + this._offset.toString() + ".." + extent.toString(),
    );
  }
}
