...
export class Axis {
  ...
  public toString(): string {
    return "[Axis:code=" + this._code + ",name='" + this._axisName + "',orientation='" + this._axisOrientation + "',abbreviation='" +
      this._abbreviation + "',unit=" + this._unitCode + ",order=" + this._order + "]";
  }
}
