...
export class ObliqueStereographic extends OperationMethod {
  ...
  public forward(sourceCRS: CRS, source: Coordinate, targetCRS: CRS, target: Coordinate): void {
    ...
    const B: float64 = 1.0 + ObliqueStereographic.sin(chi) * ObliqueStereographic.sin(this._chi0) +
      ObliqueStereographic.cos(chi) * ObliqueStereographic.cos(this._chi0) * ObliqueStereographic.cos(lambda - this._lambda0);
    ...
    const N: float64 = this._fn +
      2.0 * this._R * this._k0 *
        (ObliqueStereographic.sin(chi) * ObliqueStereographic.cos(this._chi0) -
          ObliqueStereographic.cos(chi) * ObliqueStereographic.sin(this._chi0) * ObliqueStereographic.cos(lambda - this._lambda0)) /
        B;
    /* Save the position */
    target.setX(E);
    target.setY(N);
