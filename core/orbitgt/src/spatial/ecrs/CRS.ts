...
export class CRS {
     ...
     */
    public constructor(code: int32, name: string, area: int32, type: int32, csCode: int32, datum: Datum, baseCRS: CRS, projection: Operation, transformationsToWGS: AList<Operation>) {
    ...
    public static createCompound(code: int32, name: string, area: int32, horizontalCRS: CRS, verticalCRS: CRS): CRS {
        ...
        /* Make the CRS */
        let crs: CRS = new CRS(code, name, area, CRS.COMPOUND, 0/*csCode*/, null/*datum*/, null/*baseCRS*/, null/*projection*/, null/*transformationsToWGS*/);
    ...
    public toWGSi(source: Coordinate, wgsTransformationIndex: int32): Coordinate {
        ...
        /* Get the transformation from the local datum to the WGS datum */
        let localToWGS: Operation = (wgsTransformationIndex < 0) ? this.getTransformationToWGS() : this.getTransformationsToWGS().get(wgsTransformationIndex);
        //        if (localToWGS==null)
        //        {
        //            /* We cannot transform */
    ...
    public isCompatible(other: CRS): boolean {
        ...
        if (this.isGeoCentric() || this.isGeoGraphic()) {
            ...
            if (Operation.isCompatibleOperation(other.getTransformationToWGS(), this.getTransformationToWGS()) == false) return false;
            return true;
        }
        /* Projected? */
