...
export class Operation {
  ...
  public toString(): string {
    return "[Operation:code=" + this._code + ",name='" + this._name + "',type=" + this._type + ",sourceCRS=" + this._sourceCRScode + ",targetCRS=" +
      this._targetCRScode + ",area=" + this._areaOfUse + ",method=" + this._method + "]";
  }
