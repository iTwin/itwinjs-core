...
export class Capabilities {
  ...
  public get maxRenderType(): RenderType {
    return this._maxRenderType;
  }
  public get maxDepthType(): DepthType {
    return this._maxDepthType;
  }
  public get maxTextureSize(): number {
    return this._maxTextureSize;
  }
  public get maxTexSizeAllow(): number {
    return this._maxTexSizeAllow;
  }
  public get supportsCreateImageBitmap(): boolean {
    return this._supportsCreateImageBitmap;
  }
  ...
  public get maxFragTextureUnits(): number {
    return this._maxFragTextureUnits;
  }
  public get maxVertTextureUnits(): number {
    return this._maxVertTextureUnits;
  }
  public get maxVertAttribs(): number {
    return this._maxVertAttribs;
  }
  public get maxVertUniformVectors(): number {
    return this._maxVertUniformVectors;
  }
  public get maxVaryingVectors(): number {
    return this._maxVaryingVectors;
  }
  public get maxFragUniformVectors(): number {
    return this._maxFragUniformVectors;
  }
  public get maxAntialiasSamples(): number {
    return this._maxAntialiasSamples;
  }
  public get isWebGL2(): boolean {
    return this._isWebGL2;
  }
  public get driverBugs(): GraphicsDriverBugs {
    return this._driverBugs;
  }
  ...
  public get supportsNonPowerOf2Textures(): boolean {
    return false;
  }
  ...
  public get supportsTextureFloatLinear(): boolean {
    return this._isWebGL2 || this.queryExtensionObject<OES_texture_float_linear>("OES_texture_float_linear") !== undefined;
  }
  ...
  public get supportsTextureHalfFloatLinear(): boolean {
    return this._isWebGL2 || this.queryExtensionObject<OES_texture_half_float_linear>("OES_texture_half_float_linear") !== undefined;
  }
  ...
  public get supportsVertexArrayObjects(): boolean {
    return this._isWebGL2 || this.queryExtensionObject<OES_vertex_array_object>("OES_vertex_array_object") !== undefined;
  }
  ...
  public get supportsDisjointTimerQuery(): boolean {
    return (this._isWebGL2 && this.queryExtensionObject<any>("EXT_disjoint_timer_query_webgl2") !== undefined) ||
      this.queryExtensionObject<any>("EXT_disjoint_timer_query") !== undefined;
  }
  public get supportsStandardDerivatives(): boolean {
    return this._isWebGL2 || this.queryExtensionObject<OES_standard_derivatives>("OES_standard_derivatives") !== undefined;
  }

  public get supportsMRTTransparency(): boolean {
    return this.maxColorAttachments >= 2;
  }
  public get supportsMRTPickShaders(): boolean {
    return this.maxColorAttachments >= 3;
  }
  ...
  public get supportsAntiAliasing(): boolean {
    return this._isWebGL2 && this.maxAntialiasSamples > 1;
  }
  ...
  public init(gl: WebGLContext, disabledExtensions?: WebGLExtensionName[]): WebGLRenderCompatibilityInfo {
    ...
    if (allowFloatRender && undefined !== this.queryExtensionObject("EXT_float_blend") && this.isTextureRenderable(gl, gl.FLOAT)) {
      ...
      this._maxRenderType = (hfExt !== undefined && this.isTextureRenderable(gl, hfExt.HALF_FLOAT_OES))
        ? RenderType.TextureHalfFloat
        : RenderType.TextureUnsignedByte;
    }
    ...
    this._maxDepthType = this._isWebGL2 || this.queryExtensionObject("WEBGL_depth_texture") !== undefined
