  ...
  public toJSON(
    ...
    if (standalone) {
      ...
      if (includeSchemaVersion)
        // check flag to see if we should output version
    ...
    if (undefined !== this.label) itemJson.label = this.label;
    if (undefined !== this.description) itemJson.description = this.description;
