...
export class JsonParser extends AbstractParser<UnknownObject> {
  ...
  public parseSchema(): SchemaProps {
    ...
    if (typeof this._rawSchema.name !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `An ECSchema has an invalid 'name' attribute. It should be of type 'string'.`
      );

    if (undefined === this._rawSchema.$schema)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ECSchema ${this._schemaName} is missing the required '$schema' attribute.`
      );
    if (typeof this._rawSchema.$schema !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ECSchema ${this._schemaName} has an invalid '$schema' attribute. It should be of type 'string'.`
      );

    if (undefined === this._rawSchema.version)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ECSchema ${this._schemaName} is missing the required 'version' attribute.`
      );
    if (typeof this._rawSchema.version !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ECSchema ${this._schemaName} has an invalid 'version' attribute. It should be of type 'string'.`
      );
    ...
    if (undefined !== this._rawSchema.alias) {
      if (typeof this._rawSchema.alias !== "string")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The ECSchema ${this._schemaName} has an invalid 'alias' attribute. It should be of type 'string'.`
        );
    }
    ...
    if (undefined !== this._rawSchema.label) {
      if (typeof this._rawSchema.label !== "string")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The ECSchema ${this._schemaName} has an invalid 'label' attribute. It should be of type 'string'.`
        );
    }
    ...
    if (undefined !== this._rawSchema.description) {
      if (typeof this._rawSchema.description !== "string")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The ECSchema ${this._schemaName} has an invalid 'description' attribute. It should be of type 'string'.`
        );
    }
  ...
  public *getReferences(): Iterable<SchemaReferenceProps> {
    if (undefined !== this._rawSchema.references) {
      if (!Array.isArray(this._rawSchema.references))
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The schema ${this._rawSchema.name} has an invalid 'references' attribute. It should be of type 'object[]'.`
        );
  ...
  private checkSchemaReference(
    ...
    if (!isObject(jsonObj))
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The schema ${this._schemaName} has an invalid 'references' attribute. It should be of type 'object[]'.`
      );
    if (undefined === jsonObj.name)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The schema ${this._schemaName} has an invalid 'references' attribute. One of the references is missing the required 'name' attribute.`
      );
    if (typeof jsonObj.name !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The schema ${this._schemaName} has an invalid 'references' attribute. One of the references has an invalid 'name' attribute. It should be of type 'string'.`
      );
    if (undefined === jsonObj.version)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The schema ${this._schemaName} has an invalid 'references' attribute. One of the references is missing the required 'version' attribute.`
      );
    if (typeof jsonObj.version !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The schema ${this._schemaName} has an invalid 'references' attribute. One of the references has an invalid 'version' attribute. It should be of type 'string'.`
      );
  ...
  public *getItems(): Iterable<[string, string, UnknownObject]> {
    ...
    if (undefined !== items) {
      if (!isObject(items) || Array.isArray(items))
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The schema ${this._schemaName} has an invalid 'items' attribute. It should be of type 'object'.`
        );
      ...
      for (const itemName in items) {
        ...
        if (!isObject(item))
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `A SchemaItem in ${this._schemaName} is an invalid JSON object.`
          );

        if (!ECName.validate(itemName))
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECName,
            `A SchemaItem in ${this._schemaName} has an invalid 'name' attribute. '${itemName}' is not a valid ECName.`
          );

        if (undefined === item.schemaItemType)
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `The SchemaItem ${this._schemaName}.${itemName} is missing the required 'schemaItemType' attribute.`
          );
        if (typeof item.schemaItemType !== "string")
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `The SchemaItem ${this._schemaName}.${itemName} has an invalid 'schemaItemType' attribute. It should be of type 'string'.`
          );
  ...
  private checkSchemaItemProps(jsonObj: UnknownObject): void {
    if (undefined !== jsonObj.description) {
      if (typeof jsonObj.description !== "string")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The SchemaItem ${this._currentItemFullName} has an invalid 'description' attribute. It should be of type 'string'.`
        );
    }
    ...
    if (undefined !== jsonObj.label) {
      if (typeof jsonObj.label !== "string")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The SchemaItem ${this._currentItemFullName} has an invalid 'label' attribute. It should be of type 'string'.`
        );
    }
  }
  ...
  public *getProperties(
    ...
    if (undefined !== properties) {
      if (!Array.isArray(properties))
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The ECClass ${itemName} has an invalid 'properties' attribute. It should be of type 'object[]'.`
        );
      ...
      for (const property of properties as unknown[]) {
        if (!isObject(property))
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `An ECProperty in ${itemName} is an invalid JSON object.`
          );

        if (undefined === property.name)
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `An ECProperty in ${itemName} is missing the required 'name' attribute.`
          );
        if (typeof property.name !== "string")
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `An ECProperty in ${itemName} has an invalid 'name' attribute. It should be of type 'string'.`
          );

        if (undefined === property.type)
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `The ECProperty ${itemName}.${property.name} does not have the required 'type' attribute.`
          );
        if (typeof property.type !== "string")
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `The ECProperty ${itemName}.${property.name} has an invalid 'type' attribute. It should be of type 'string'.`
          );
        if (!this.isValidPropertyType(property.type))
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `The ECProperty ${itemName}.${property.name} has an invalid 'type' attribute. '${property.type}' is not a valid type.`
          );
  ...
  private checkClassProps(jsonObj: UnknownObject): void {
    ...
    if (undefined !== jsonObj.modifier) {
      if (typeof jsonObj.modifier !== "string")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The ECClass ${this._currentItemFullName} has an invalid 'modifier' attribute. It should be of type 'string'.`
        );
    }
    ...
    if (undefined !== jsonObj.baseClass) {
      if (typeof jsonObj.baseClass !== "string")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The ECClass ${this._currentItemFullName} has an invalid 'baseClass' attribute. It should be of type 'string'.`
        );
    }
    if (undefined !== jsonObj.customAttributes) {
      if (!Array.isArray(jsonObj.customAttributes)) {
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The ECClass ${this._currentItemFullName} has an invalid 'customAttributes' attribute. It should be of type 'array'.`
        );
      }
    }
  }
  ...
  public parseEntityClass(jsonObj: UnknownObject): EntityClassProps {
    ...
    if (undefined !== jsonObj.mixins) {
      if (!Array.isArray(jsonObj.mixins))
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The ECEntityClass ${this._currentItemFullName} has an invalid 'mixins' attribute. It should be of type 'string[]'.`
        );
  ...
  public parseMixin(jsonObj: UnknownObject): MixinProps {
    ...
    if (undefined === jsonObj.appliesTo)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Mixin ${this._currentItemFullName} is missing the required 'appliesTo' attribute.`
      );
    if (typeof jsonObj.appliesTo !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Mixin ${this._currentItemFullName} has an invalid 'appliesTo' attribute. It should be of type 'string'.`
      );
  ...
  public parseCustomAttributeClass(
    ...
    if (typeof jsonObj.appliesTo !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The CustomAttributeClass ${this._currentItemFullName} has an invalid 'appliesTo' attribute. It should be of type 'string'.`
      );
  ...
  public parseRelationshipClass(
    ...
    if (typeof jsonObj.strength !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The RelationshipClass ${this._currentItemFullName} has an invalid 'strength' attribute. It should be of type 'string'.`
      );
    ...
    if (typeof jsonObj.strengthDirection !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The RelationshipClass ${this._currentItemFullName} has an invalid 'strengthDirection' attribute. It should be of type 'string'.`
      );

    if (undefined === jsonObj.source)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The RelationshipClass ${this._currentItemFullName} is missing the required source constraint.`
      );
    if (!isObject(jsonObj.source))
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The RelationshipClass ${this._currentItemFullName} has an invalid source constraint. It should be of type 'object'.`
      );
    ...
    if (undefined === jsonObj.target)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The RelationshipClass ${this._currentItemFullName} is missing the required target constraint.`
      );
    if (!isObject(jsonObj.target))
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The RelationshipClass ${this._currentItemFullName} has an invalid target constraint. It should be of type 'object'.`
      );
  ...
  private checkRelationshipConstraintProps(
    ...
    if (typeof jsonObj.multiplicity !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ${constraintName} has an invalid 'multiplicity' attribute. It should be of type 'string'.`
      );
    ...
    if (typeof jsonObj.roleLabel !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ${constraintName} has an invalid 'roleLabel' attribute. It should be of type 'string'.`
      );
    ...
    if (undefined === jsonObj.constraintClasses)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ${constraintName} is missing the required 'constraintClasses' attribute.`
      );
    if (!Array.isArray(jsonObj.constraintClasses))
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ${constraintName} has an invalid 'constraintClasses' attribute. It should be of type 'string[]'.`
      );
  ...
  public parseEnumeration(jsonObj: UnknownObject): EnumerationProps {
    ...
    if (undefined === jsonObj.type)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Enumeration ${this._currentItemFullName} is missing the required 'type' attribute.`
      );
    if (typeof jsonObj.type !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Enumeration ${this._currentItemFullName} has an invalid 'type' attribute. It should be of type 'string'.`
      );

    const isValidEnumerationType = (type: string): boolean => {
      type = type.toLowerCase();
      return type === "int" || type === "integer" || type === "string";
    };
    if (!isValidEnumerationType(jsonObj.type))
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Enumeration ${this._currentItemFullName} has an invalid 'type' attribute. It should be either "int" or "string".`
      );
    ...
    if (undefined !== jsonObj.isStrict) {
      ...
      if (typeof jsonObj.isStrict !== "boolean")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Enumeration ${this._currentItemFullName} has an invalid 'isStrict' attribute. It should be of type 'boolean'.`
        );
    }
    ...
    if (undefined === jsonObj.enumerators)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Enumeration ${this._currentItemFullName} is missing the required 'enumerators' attribute.`
      );
    if (!Array.isArray(jsonObj.enumerators))
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Enumeration ${this._currentItemFullName} has an invalid 'enumerators' attribute. It should be of type 'object[]'.`
      );
    ...
    for (const enumerator of jsonObj.enumerators) {
      ...
      if (!expectedType.includes(receivedType))
        ...
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Enumeration ${this._currentItemFullName} has an incompatible type. It must be "${expectedType}", not "${receivedType}".`
        );
      ...
      if (typeof enumerator.name !== "string")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Enumeration ${this._currentItemFullName} has an enumerator with an invalid 'name' attribute. It should be of type 'string'.`
        );
      ...
      if (undefined !== enumerator.label) {
        if (typeof enumerator.label !== "string")
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `The Enumeration ${this._currentItemFullName} has an enumerator with an invalid 'label' attribute. It should be of type 'string'.`
          );
      }
      ...
      if (undefined !== enumerator.description) {
        if (typeof enumerator.description !== "string")
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `The Enumeration ${this._currentItemFullName} has an enumerator with an invalid 'description' attribute. It should be of type 'string'.`
          );
      }
    }
  ...
  public parseKindOfQuantity(jsonObj: UnknownObject): KindOfQuantityProps {
    ...
    if (typeof jsonObj.relativeError !== "number")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The KindOfQuantity ${this._currentItemFullName} has an invalid 'relativeError' attribute. It should be of type 'number'.`
      );
    ...
    if (typeof jsonObj.persistenceUnit !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The KindOfQuantity ${this._currentItemFullName} has an invalid 'persistenceUnit' attribute. It should be of type 'string'.`
      );
  ...
  public parsePropertyCategory(jsonObj: UnknownObject): PropertyCategoryProps {
    ...
    if (undefined !== jsonObj.priority) {
      ...
      if (typeof jsonObj.priority !== "number")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The PropertyCategory ${this._currentItemFullName} has an invalid 'priority' attribute. It should be of type 'number'.`
        );
    }
  ...
  public parseUnit(jsonObj: UnknownObject): SchemaItemUnitProps {
    ...
    if (undefined === jsonObj.phenomenon)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Unit ${this._currentItemFullName} does not have the required 'phenomenon' attribute.`
      );
    if (typeof jsonObj.phenomenon !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Unit ${this._currentItemFullName} has an invalid 'phenomenon' attribute. It should be of type 'string'.`
      );

    if (undefined === jsonObj.unitSystem)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Unit ${this._currentItemFullName} does not have the required 'unitSystem' attribute.`
      );
    if (typeof jsonObj.unitSystem !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Unit ${this._currentItemFullName} has an invalid 'unitSystem' attribute. It should be of type 'string'.`
      );

    if (undefined === jsonObj.definition)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Unit ${this._currentItemFullName} does not have the required 'definition' attribute.`
      );
    if (typeof jsonObj.definition !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Unit ${this._currentItemFullName} has an invalid 'definition' attribute. It should be of type 'string'.`
      );
    ...
    if (undefined !== jsonObj.numerator) {
      if (typeof jsonObj.numerator !== "number")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Unit ${this._currentItemFullName} has an invalid 'numerator' attribute. It should be of type 'number'.`
        );
    }
    ...
    if (undefined !== jsonObj.denominator) {
      if (typeof jsonObj.denominator !== "number")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Unit ${this._currentItemFullName} has an invalid 'denominator' attribute. It should be of type 'number'.`
        );
    }
    ...
    if (undefined !== jsonObj.offset) {
      if (typeof jsonObj.offset !== "number")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Unit ${this._currentItemFullName} has an invalid 'offset' attribute. It should be of type 'number'.`
        );
    }
  ...
  public parseInvertedUnit(jsonObj: UnknownObject): InvertedUnitProps {
    ...
    if (undefined === jsonObj.invertsUnit)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The InvertedUnit ${this._currentItemFullName} does not have the required 'invertsUnit' attribute.`
      );
    if (typeof jsonObj.invertsUnit !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The InvertedUnit ${this._currentItemFullName} has an invalid 'invertsUnit' attribute. It should be of type 'string'.`
      );

    if (undefined === jsonObj.unitSystem)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The InvertedUnit ${this._currentItemFullName} does not have the required 'unitSystem' attribute.`
      );
    if (typeof jsonObj.unitSystem !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The InvertedUnit ${this._currentItemFullName} has an invalid 'unitSystem' attribute. It should be of type 'string'.`
      );
  ...
  public parseConstant(jsonObj: UnknownObject): ConstantProps {
    ...
    if (undefined === jsonObj.phenomenon)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Constant ${this._currentItemFullName} does not have the required 'phenomenon' attribute.`
      );
    if (typeof jsonObj.phenomenon !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Constant ${this._currentItemFullName} has an invalid 'phenomenon' attribute. It should be of type 'string'.`
      );

    if (undefined === jsonObj.definition)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Constant ${this._currentItemFullName} does not have the required 'definition' attribute.`
      );
    if (typeof jsonObj.definition !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Constant ${this._currentItemFullName} has an invalid 'definition' attribute. It should be of type 'string'.`
      );
    ...
    if (undefined !== jsonObj.numerator) {
      if (typeof jsonObj.numerator !== "number")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Constant ${this._currentItemFullName} has an invalid 'numerator' attribute. It should be of type 'number'.`
        );
    }
    ...
    if (undefined !== jsonObj.denominator) {
      if (typeof jsonObj.denominator !== "number")
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Constant ${this._currentItemFullName} has an invalid 'denominator' attribute. It should be of type 'number'.`
        );
    }
  ...
  public parsePhenomenon(jsonObj: UnknownObject): PhenomenonProps {
    ...
    if (undefined === jsonObj.definition)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Phenomenon ${this._currentItemFullName} does not have the required 'definition' attribute.`
      );
    if (typeof jsonObj.definition !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Phenomenon ${this._currentItemFullName} has an invalid 'definition' attribute. It should be of type 'string'.`
      );
  ...
  public parseFormat(jsonObj: UnknownObject): SchemaItemFormatProps {
    ...
    if (undefined === jsonObj.type)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Format ${this._currentItemFullName} does not have the required 'type' attribute.`
      );
    if (typeof jsonObj.type !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
    ...
    if (undefined !== jsonObj.formatTraits) {
      if (
        ...
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Format ${this._currentItemFullName} has an invalid 'formatTraits' attribute. It should be of type 'string' or 'string[]'.`
        );
    }
    ...
    if (undefined !== jsonObj.composite) {
      ...
      if (undefined === jsonObj.composite.units)
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Format ${this._currentItemFullName} has an invalid 'Composite' attribute. It should have 1-4 units.`
        );
      if (!Array.isArray(jsonObj.composite.units))
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The Format ${this._currentItemFullName} has a Composite with an invalid 'units' attribute. It should be of type 'object[]'.`
        );
      ...
      for (let i = 0; i < jsonObj.composite.units.length; i++) {
        ...
        if (undefined === jsonObj.composite.units[i].name)
          // required
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `The Format ${this._currentItemFullName} has a Composite with an invalid 'units' attribute. The object at position ${i} is missing the required 'name' attribute.`
          );
  ...
  private checkPropertyTypename(jsonObj: UnknownObject): void {
    ...
    if (typeof jsonObj.typeName !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ECProperty ${this._currentItemFullName}.${propName} has an invalid 'typeName' attribute. It should be of type 'string'.`
      );
  }
  ...
  private checkPrimitiveOrEnumPropertyBaseProps(
    ...
    if (undefined !== jsonObj.minValue && typeof jsonObj.minValue !== "number")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The ECProperty ${this._currentItemFullName}.${propName} has an invalid 'minValue' attribute. It should be of type 'number'.`
      );
  ...
  public parseNavigationProperty(
    ...
    if (undefined === jsonObj.relationshipName)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Navigation Property ${fullname} is missing the required 'relationshipName' property.`
      );
    if (typeof jsonObj.relationshipName !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Navigation Property ${fullname} has an invalid 'relationshipName' property. It should be of type 'string'.`
      );

    if (undefined === jsonObj.direction)
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Navigation Property ${fullname} is missing the required 'direction' property.`
      );
    if (typeof jsonObj.direction !== "string")
      throw new ECObjectsError(
        ECObjectsStatus.InvalidECJson,
        `The Navigation Property ${fullname} has an invalid 'direction' property. It should be of type 'string'.`
      );
  ...
  public getRelationshipConstraintCustomAttributeProviders(
    ...
    const targetCustomAttributes = this.getCustomAttributeProviders(
      jsonObj.target as UnknownObject,
  ...
  private *getCustomAttributeProviders(
    ...
    if (undefined !== jsonObj.customAttributes) {
      if (!Array.isArray(jsonObj.customAttributes))
        throw new ECObjectsError(
          ECObjectsStatus.InvalidECJson,
          `The ${type} ${name} has an invalid 'customAttributes' attribute. It should be of type 'object[]'.`
        );
      ...
      for (const instance of jsonObj.customAttributes) {
        ...
        if (undefined === instance.className)
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `A CustomAttribute in ${name}.customAttributes is missing the required 'className' attribute.`
          );
        if (typeof instance.className !== "string")
          throw new ECObjectsError(
            ECObjectsStatus.InvalidECJson,
            `A CustomAttribute in ${name}.customAttributes has an invalid 'className' attribute. It should be of type 'string'.`
          );
