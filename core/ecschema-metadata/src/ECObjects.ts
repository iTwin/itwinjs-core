...
export enum SchemaMatchType {
   ...
   * @deprecated in 4.10 - will not be removed until 2026-06-13. Use Exact instead.
   */
  Identical,
 ...
 * @beta
 * @deprecated in 4.6.0 - will not be removed until 2026-06-13. SchemaItemType is a string enum so just use it directly
 */
