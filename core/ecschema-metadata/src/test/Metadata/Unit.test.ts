...
describe("Unit", () => {
  ...
  describe("deserialization", () => {
    ...
    it("sync - should succeed with fully defined", () => {
      ...
      assert.strictEqual(
        phen,
        ecSchema.getItemSync<Phenomenon>(unit!.phenomenon!.name)
      );
      ...
      assert.strictEqual(
        unitSystem,
        ecSchema.getItemSync<UnitSystem>(unit!.unitSystem!.name)
      );
    ...
    it("async - should throw for missing phenomenon", async () => {
      await expect(
        Schema.fromJson(
          createSchemaJson(missingPhenomenonJson),
          new SchemaContext()
        )
      ).to.be.rejectedWith(
        ECObjectsError,
    ...
    it("async - should throw for invalid phenomenon", async () => {
      await expect(
        Schema.fromJson(
          createSchemaJson(invalidPhenomenonJson),
          new SchemaContext()
        )
      ).to.be.rejectedWith(
        ECObjectsError,
    ...
    it("async - should throw for missing unit system", async () => {
      await expect(
        Schema.fromJson(
          createSchemaJson(missingUnitSystemJson),
          new SchemaContext()
        )
      ).to.be.rejectedWith(
        ECObjectsError,
    ...
    it("async - should throw for invalid unit system", async () => {
      await expect(
        Schema.fromJson(
          createSchemaJson(invalidUnitSystemJson),
          new SchemaContext()
        )
      ).to.be.rejectedWith(
        ECObjectsError,
    ...
    it("async - should throw for missing definition", async () => {
      await expect(
        Schema.fromJson(
          createSchemaJson(missingDefinitionJson),
          new SchemaContext()
        )
      ).to.be.rejectedWith(
        ECObjectsError,
    ...
    it("async - should throw for invalid definition", async () => {
      await expect(
        Schema.fromJson(
          createSchemaJson(invalidDefinitionJson),
          new SchemaContext()
        )
      ).to.be.rejectedWith(
        ECObjectsError,
    ...
    it("async - should throw for invalid numerator", async () => {
      await expect(
        Schema.fromJson(
          createSchemaJson(invalidNumeratorJson),
          new SchemaContext()
        )
      ).to.be.rejectedWith(
        ECObjectsError,
    ...
    it("async - should throw for invalid denominator", async () => {
      await expect(
        Schema.fromJson(
          createSchemaJson(invalidDenominatorJson),
          new SchemaContext()
        )
      ).to.be.rejectedWith(
        ECObjectsError,
    ...
    it("async - should throw for invalid offset", async () => {
      await expect(
        Schema.fromJson(
          createSchemaJson(invalidOffsetJson),
          new SchemaContext()
        )
      ).to.be.rejectedWith(
        ECObjectsError,
