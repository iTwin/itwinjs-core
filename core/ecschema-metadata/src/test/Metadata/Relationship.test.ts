...
describe("RelationshipClass", () => {
  it("should get fullName", async () => {
    ...
    const relClass = await schema.getTypedItem("TestRelationship", RelationshipClass);
  ...
  describe("deserialization", () => {
    ...
    it("should succeed with fully defined relationship", async () => {
      ...
      const sourceBaseEntity = await schema.getTypedItem("SourceBaseEntity", EntityClass);
      assert.isDefined(sourceBaseEntity);
      const targetBaseEntity = await schema.getTypedItem("TargetBaseEntity", EntityClass);
      assert.isDefined(targetBaseEntity);
      const sourceEntity = await schema.getTypedItem("TestSourceEntity", EntityClass);
      assert.isDefined(sourceEntity);
      const targetEntity = await schema.getTypedItem("TestTargetEntity", EntityClass);
  ...
  describe("toXml", () => {
    ...
    it("Serialization with one custom attribute defined in ref schema, only class name", async () => {
      ...
      const relClass = await testSchema.getTypedItem("TestRelationship", RelationshipClass) as RelationshipClass;
