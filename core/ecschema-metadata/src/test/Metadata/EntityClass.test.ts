...
describe("EntityClass", () => {
  describe("type safety checks", () => {
    ...
    it("EntityClass type should work with getItem/Sync", async () => {
      expect(await ecSchema.getItem("TestEntityClass", EntityClass)).toBeInstanceOf(EntityClass);
      expect(ecSchema.getItemSync("TestEntityClass", EntityClass)).toBeInstanceOf(EntityClass);
    });

    it("EntityClass type should reject for other item types on getItem/Sync", async () => {
      expect(await ecSchema.getItem("TestPhenomenon", EntityClass)).toBeUndefined();
      expect(ecSchema.getItemSync("TestPhenomenon", EntityClass)).toBeUndefined();
    });
  });
  ...
  describe("deserialization", () => {
    ...
    it("should throw for invalid baseClass", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The ECClass TestSchema.TestEntityClass has an invalid 'baseClass' attribute. It should be of type 'string'.`);
    });

    it("should throw for invalid mixins", async () => {
      let json: any = createSchemaJson({ mixins: 0, schema: "TestSchema" });
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The ECEntityClass TestSchema.TestEntityClass has an invalid 'mixins' attribute. It should be of type 'string[]'.`);
    ...
    it("should throw for invalid properties", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The ECClass TestSchema.TestEntityClass has an invalid 'properties' attribute. It should be of type 'object[]'.`);

      json = createSchemaJson({
        properties: [0],
      });
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `An ECProperty in TestSchema.TestEntityClass is an invalid JSON object.`);
    });
    ...
    it("should throw for property with missing name", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `An ECProperty in TestSchema.TestEntityClass is missing the required 'name' attribute.`);
    });
    ...
    it("should throw for property with invalid name", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `An ECProperty in TestSchema.TestEntityClass has an invalid 'name' attribute. It should be of type 'string'.`);
    });
    ...
    it("should throw for property with missing type", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The ECProperty TestSchema.TestEntityClass.badProp does not have the required 'type' attribute.`);
    });
    ...
    it("should throw for property with invalid type", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The ECProperty TestSchema.TestEntityClass.badProp has an invalid 'type' attribute. It should be of type 'string'.`);
    });
    ...
    it("should throw for property with missing typeName", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The ECProperty TestSchema.TestEntityClass.badProp is missing the required 'typeName' attribute.`);
    });
    ...
    it("should throw for property with invalid typeName", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The ECProperty TestSchema.TestEntityClass.badProp has an invalid 'typeName' attribute. It should be of type 'string'.`);
    });
    ...
    it("should throw for property with invalid category", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The ECProperty TestSchema.TestEntityClass.testProp has an invalid 'category' attribute. It should be of type 'string'.`);
    });
    ...
    it("should throw for property with invalid kindOfQuantity", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The ECProperty TestSchema.TestEntityClass.testProp has an invalid 'kindOfQuantity' attribute. It should be of type 'string'.`);
    });
    ...
    it("should throw for navigation property with missing relationshipName", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The Navigation Property TestSchema.TestEntityClass.testNavProp is missing the required 'relationshipName' property.`);
    });
    ...
    it("should throw for navigation property with invalid relationshipName", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The Navigation Property TestSchema.TestEntityClass.testNavProp has an invalid 'relationshipName' property. It should be of type 'string'.`);
    });
    ...
    it("should throw for navigation property with nonexistent relationship", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `Unable to locate SchemaItem BadSchema.ThisDoesNotExist.`);
    });
    ...
    it("should throw for navigation property with missing direction", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The Navigation Property TestSchema.TestEntityClass.testNavProp is missing the required 'direction' property.`);
    });
    ...
    it("should throw for navigation property with invalid direction", async () => {
      ...
      await expectAsyncToThrow(async () => Schema.fromJson(json, new SchemaContext()), ECSchemaError, `The Navigation Property TestSchema.TestEntityClass.testNavProp has an invalid 'direction' property. It should be of type 'string'.`);
    });
  });
