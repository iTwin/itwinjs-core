...
describe("Property", () => {
  ...
  describe("toJSON", () => {
    ...
    it("should include kindOfQuantity", async () => {
      ...
      const testProp = new MockProperty("ValidProp");
      await testProp.fromJSON(propertyJson);
      expect(testProp.toJSON()).to.include({
        kindOfQuantity: "TestSchema.TestKoQ",
      });
    });
        ...
        properties: [
          {
            ...
            typeName: "int",
            name: "TestProp",
            customAttributes: [{ className: "TestSchema.CaClass1" }],
          },
        ],
      },
      MrMixin: {
      ...
      TestClass: {
        ...
        properties: [
          ...
          },
          {
            ...
            name: "TestProp2",
            typeName: "string",
            customAttributes: [{ className: "TestSchema.CaClass2" }],
          },
          {
            type: "PrimitiveProperty",
            name: "TestProp3",
...
describe("NavigationProperty (Deserialization not fully implemented)", () => {
  ...
  describe("isProperty", async () => {
    ...
    it("should return true if object is of Property type", async () => {
      ...
      const enumProperty = new EnumerationProperty(
        testClass,
        "B",
        new DelayedPromiseWithProps(testEnum.key, async () => testEnum)
      );
      ...
      const enumArrayProperty = new EnumerationArrayProperty(
        testClass,
        "F",
        new DelayedPromiseWithProps(testEnum.key, async () => testEnum)
      );
