...
describe("ECClass", () => {
  ...
  describe("adding and deleting properties from classes", () => {
    ...
    it("should delete for different kinds of properties", async () => {
      ...
      const structProp = await (entityClass as ECClass as MutableClass).createStructProperty(
        "StructProp",
  ...
  describe("get inherited custom attributes", () => {
    it("class only has local custom attributes, no base classes", async () => {
      ...
      const testInheritanceCA = (inheritedCustomAttributes: CustomAttributeSet) => {
        expect(inheritedCustomAttributes.get("TestSchema.CustomAttribute0")).to.be.equals(
          localCustomAttributes!.get("TestSchema.CustomAttribute0")
        );
        expect(inheritedCustomAttributes.get("TestSchema.CustomAttribute1")).to.be.equals(
          localCustomAttributes!.get("TestSchema.CustomAttribute1")
        );
        expect(inheritedCustomAttributes.get("TestSchema.CustomAttribute2")).to.be.equals(
          localCustomAttributes!.get("TestSchema.CustomAttribute2")
        );
        expect(inheritedCustomAttributes.get("TestSchema.CustomAttribute3")).to.be.equals(
      ...
      const schemaJson = {
        ...
        items: {
          ...
          TestClass: {
            ...
            customAttributes: [{ className: "TestSchema.TestCAClass0" }, { className: "TestSchema.TestCAClass1" }],
          },
        },
      };
    ...
    it("class has multiple branches of inheritance", async () => {
      ...
      const testInheritanceCA = (inheritedCustomAttributes: CustomAttributeSet) => {
        ...
        expect(inheritedCustomAttributes.get("TestSchema.TestSecondMixinCAClass0")).to.be.equals(
          testSecondMixinCAClass0
        );
        expect(inheritedCustomAttributes.get("TestSchema.TestSecondMixinCAClass1")).to.be.equals(
          testSecondMixinCAClass1
        );
      };
