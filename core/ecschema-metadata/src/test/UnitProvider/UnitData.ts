...
export const UNIT_EXTRA_DATA = [
  ...
  { name: "Units.MILE", altDisplayLabels: ["mile", "Miles", "Mile"] },
  {
    ...
    altDisplayLabels: ["ft", "SF", "USF", "ft (US Survey)"],
  },
  {
    name: "Units.US_SURVEY_YRD",
    altDisplayLabels: ["USY", "yards (US Survey)"],
  },
  {
    name: "Units.US_SURVEY_IN",
    altDisplayLabels: ["USI", "inches (US Survey)"],
  },
  {
    name: "Units.US_SURVEY_MILE",
    altDisplayLabels: ["miles (US Survey)", "mile (US Survey)", "USM"],
  },
