...
- Fix bugs in bspline curve extendRange functions
- AuxData support for Polyfaces
- doc fixes
...
- Fix error due to floating-point precision issues in Map4d.createVectorFrustum.
