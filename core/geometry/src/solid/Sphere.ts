...
export class Sphere extends SolidPrimitive implements UVSurface {
  ...
  private constructor(localToWorld: Transform, latitudeSweep: AngleSweep, capped: boolean) {
    ...
    this.latitudeSweep = latitudeSweep ? latitudeSweep : AngleSweep.createFullLatitude();
  }
  public clone(): Sphere {
  ...
  public cloneVectorZ(): Vector3d { return this.localToWorld.matrix.columnZ(); }
  /** return (a copy of) the sphere's angle sweep. */
  public cloneLatitudeSweep(): AngleSweep { return this.latitudeSweep.clone(); }
   ...
   */
  public cloneLocalToWorld(): Transform { return this.localToWorld.clone(); }
