...
export class PlaneByOriginAndVectors4d {
  ...
  public static createOriginAndVectors(
    ...
    vectorU: Point4d,
    vectorV: Point4d,
    result?: PlaneByOriginAndVectors4d
  ...
  public setOriginAndVectorsXYZW(
    x0: number,
    y0: number,
    z0: number,
    w0: number,
  ...
  public static createOriginAndVectorsXYZW(
    x0: number,
    y0: number,
    z0: number,
    w0: number,
    ...
    if (result) return result.setOriginAndVectorsXYZW(x0, y0, z0, w0, ux, uy, uz, uw, vx, vy, vz, vw);
    return new PlaneByOriginAndVectors4d(
      Point4d.create(x0, y0, z0, w0),
      Point4d.create(ux, uy, uz, uw),
      Point4d.create(vx, vy, vz, uw)
    );
  }
  /** create from origin point, (u=1,v=0) point, and (u=0,v=1) point. */
  public static createOriginAndTargets3d(
    origin: Point3d,
    targetU: Point3d,
    targetV: Point3d,
    result?: PlaneByOriginAndVectors4d
  ): PlaneByOriginAndVectors4d {
    return PlaneByOriginAndVectors4d.createOriginAndVectorsXYZW(
      origin.x,
      origin.y,
      origin.z,
      1.0,
