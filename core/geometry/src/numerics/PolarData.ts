...
export class PolarData {
  ...
  public static createMixedScalars(
  ...
  public static solveFromScalars(known: PolarData): PolarData[] {
    ...
    if (known.x !== undefined) {
    ...
    } else if (known.y !== undefined) {
      // and we already know x is undefined .....
      ...
      if (known.theta !== undefined) {
        result.push(
          PolarData.createMixedScalars(
            ConstraintState.singlePoint,
            known.r * known.theta.cos(),
            known.r * known.theta.sin(),
            known.r,
            known.theta
          )
        );
