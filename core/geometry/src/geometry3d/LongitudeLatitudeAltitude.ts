...
export class LongitudeLatitudeNumber implements BeJSONFunctions {
  ...
  public toJSON(): any {
    return {
      latitude: this._latitude.toJSON(),
      longitude: this._longitude.toJSON(),
      h: this._altitude,
    };
  }
  ...
  public isAlmostEqual(other: LongitudeLatitudeNumber): boolean {
    return (
      this._latitude.isAlmostEqual(other._latitude) &&
