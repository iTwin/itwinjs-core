  ...
  implements BeJSONFunctions
{
  ...
  public static create(
    ...
    if (result) {
      if (normal.normalize(result._normal) === undefined) return undefined;
  ...
  public static createXYZUVW(
    ...
    if (magU < Geometry.smallMetricDistance) return undefined;
    if (result) {
    ...
    return new Plane3dByOriginAndUnitNormal(
      ...
      Vector3d.create(ux / magU, uy / magU, uz / magU)
    );
  }
