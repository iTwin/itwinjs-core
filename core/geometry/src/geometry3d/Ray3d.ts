...
export class Ray3d implements BeJSONFunctions {
  ...
  public cloneInverseTransformed(transform: Transform, result?: Ray3d): Ray3d | undefined {
    ...
    assert(undefined !== origin, "Ray3d.cloneInverseTransformed: origin should be defined");
    ...
    assert(undefined !== direction, "Ray3d.cloneInverseTransformed: direction should be defined");
