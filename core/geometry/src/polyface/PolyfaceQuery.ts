 ...
 */
  ...
  */
  ...
  /** @deprecated in 4.x - will not be removed until 2026-06-13. Use [[sweepLineStringToFacetsXYReturnSweptFacets]] instead. */
   ...
   * Find segments (within the linestring) which project to facets.
    ...
    * @deprecated in 4.x - will not be removed until 2026-06-13. Use [[PolyfaceQuery.sweepLineStringToFacets]] to get further options.
    */
