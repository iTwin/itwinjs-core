...
describe("CurveExtendMode", () => {
  it("HelloWorld", () => {
    ...
    ck.testExactNumber(
      ...
      CurveExtendOptions.resolveVariantCurveExtendParameterToCurveExtendMode(false, 0)
    );
    ck.testExactNumber(
      CurveExtendMode.OnCurve,
      CurveExtendOptions.resolveVariantCurveExtendParameterToCurveExtendMode(true, 0)
    );
    ck.testExactNumber(
      CurveExtendMode.None,
      CurveExtendOptions.resolveVariantCurveExtendParameterToCurveExtendMode(CurveExtendMode.None, 0)
    );
    ck.testExactNumber(
      CurveExtendMode.None,
      CurveExtendOptions.resolveVariantCurveExtendParameterToCurveExtendMode(CurveExtendMode.None, 1)
    );
    ...
    ck.testExactNumber(
      CurveExtendMode.OnTangent,
      CurveExtendOptions.resolveVariantCurveExtendParameterToCurveExtendMode(qTangentNone, 0)
    );
    ck.testExactNumber(
      CurveExtendMode.None,
      CurveExtendOptions.resolveVariantCurveExtendParameterToCurveExtendMode(qTangentNone, 1)
    );

    const qNoneTangent: [CurveExtendMode, CurveExtendMode] = [CurveExtendMode.None, CurveExtendMode.OnTangent];
    ck.testExactNumber(
      CurveExtendMode.None,
      CurveExtendOptions.resolveVariantCurveExtendParameterToCurveExtendMode(qNoneTangent, 0)
    );
    ck.testExactNumber(
      CurveExtendMode.OnTangent,
      CurveExtendOptions.resolveVariantCurveExtendParameterToCurveExtendMode(qNoneTangent, 1)
    );
