...
import { PointString3d } from "../../curves";
...
function exercisePointString3d(ck: Checker, lsA: PointString3d) {
  ...
  ck.testUndefined(lsA.pointAt(-1), "verify out of range point string index");
...
describe("PointString3d", () => {
  it("HelloWorld", () => {
    ...
    // create with var-args point array.
    ...
    it("reverseInPlace", () => {
      ...
      const ls0 = PointString3d.create(
        ...
        Point3d.create(3, 3, 3),
        Point3d.create(4, 4, 4),
      );
      const ls1 = PointString3d.create(
        Point3d.create(4, 4, 4),
        Point3d.create(3, 3, 3),
        Point3d.create(2, 2, 2),
        Point3d.create(1, 1, 1),
      ...
      ls1.reverseInPlace();
      ck.testPoint3d(ls0.pointAt(0)!, ls1.pointAt(0)!);
