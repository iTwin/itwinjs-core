...
export class SimpleFactory {
  ...
  public static createDefaultLineSegment3d(
    select: number
  ): g.LineSegment3d | undefined {
    if (select === 0)
      return g.LineSegment3d.create(
        g.Point3d.create(0, 0, 0),
        g.Point3d.create(1, 0, 0)
      );
    if (select === 1)
      return g.LineSegment3d.create(
        SimpleFactory._point1[0],
  ...
  public static createDefaultLineString3d(
    select: number
  ): g.LineString3d | undefined {
    if (select === 0)
  ...
  public static createDefaultPointString3d(
    select: number
  ): g.PointString3d | undefined {
    if (select === 0)
  ...
  public static createDefaultAngleSweep(
    select: number
  ): g.AngleSweep | undefined {
  ...
  public static createDefaultMatrix3d(select: number): g.Matrix3d | undefined {
    ...
    if (select === 2)
      return g.Matrix3d.createRotationAroundVector(
        SimpleFactory._vector2[0],
        g.Angle.createDegrees(15.23123122)
      )!;
    return undefined;
  }

  public static createDefaultPlane3dByOriginAndUnitNormal(
    select: number
  ): g.Plane3dByOriginAndUnitNormal | undefined {
    if (select === 0) return g.Plane3dByOriginAndUnitNormal.createXYPlane();
    if (select === 1)
      return g.Plane3dByOriginAndUnitNormal.create(
        g.Point3d.create(1, 2, 3),
        g.Vector3d.create(2, 4, -1)
      )!;
    if (select === 2)
      return g.Plane3dByOriginAndUnitNormal.create(
        SimpleFactory._point2[0],
        SimpleFactory._vector2[1]
      );
    return undefined;
  }

  public static createDefaultPlane3dByOriginAndVectors(
    select: number
  ): g.Plane3dByOriginAndVectors | undefined {
    if (select === 0)
      return g.Plane3dByOriginAndVectors.createOriginAndVectorsXYZ(
        0,
        0,
        0,
        1,
  ...
  public static createDefaultTransform(
    select: number
    ...
    if (select === 3)
      return g.Transform.createOriginAndMatrix(
        g.Point3d.create(-1, 2, 3),
        g.Matrix3d.createRotationAroundVector(
          g.Vector3d.create(4, 2, -1),
          g.Angle.createDegrees(30)
        )
      );
    return undefined;
  }

  public static createDefaultYawPitchRollAngles(
    select: number
  ): g.YawPitchRollAngles | undefined {
    switch (select) {
      case 0:
