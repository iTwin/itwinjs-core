...
function clipMeshToRange(
  range: Range3d,
  mesh: Polyface
): { inside: Polyface | undefined; outside: Polyface | undefined } {
  ...
  return {
    inside: clipBuilders.claimPolyface(0, true),
    outside: clipBuilders.claimPolyface(1, true),
  };
}
