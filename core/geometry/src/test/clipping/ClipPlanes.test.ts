...
import { Clipper, ClipPlaneContainment, ClipStatus, ClipUtilities } from "../../clipping/ClipUtils.js";
...
import { AnnounceNumberNumberCurvePrimitive, CurvePrimitive } from "../../curve/CurvePrimitive.js";
...
import { IndexedXYZCollectionPolygonOps, Point3dArrayPolygonOps, PolygonOps } from "../../geometry3d/PolygonOps.js";
    ...
    if (clip) { // Should never fail
      ...
      for (let i = 2; i < 15; i++) {
        ...
        if (Checker.noisy.clipPlane) {
          ...
          GeometryCoreTestIO.consoleLog({ "expected crossings: ": numExpectedCrossings });
