...
describe("HalfEdgeGraphSearch", () => {
  it("collectConnectedComponentsWithExteriorParityMasks", () => {
    ...
    node10.clearMaskAroundEdge(HalfEdgeMask.BOUNDARY_EDGE);
    node12.clearMaskAroundEdge(HalfEdgeMask.BOUNDARY_EDGE);
    node14.clearMaskAroundEdge(HalfEdgeMask.BOUNDARY_EDGE);
