...
function formatNodeForDump(he: HalfEdge): string {
  const o = {
    id: he.id,
    psm: [he.facePredecessor.id, he.faceSuccessor.id, he.edgeMate.id, HalfEdge.nodeToMaskString(he)],
  };
...
function checkCounts(
  ...
  if (
    !ck.testExactNumber(numVertices, numVerticesA, "numVertices") ||
