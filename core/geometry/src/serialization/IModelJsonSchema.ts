...
export namespace IModelJson {
  ...
  export interface CurveCollectionProps extends PlanarRegionProps {
     ...
     * @deprecated in 5.x - will not be removed until after 2026-06-13. Instead use bagOfCurves, which has correct capitalization and type. The old name has never been persisted.
    */
  ...
  export interface ConeProps extends AxesProps {
     ...
     * @deprecated in 5.x - will not be removed until after 2026-06-13. This property has never been written. Optional axes are specified by an AxesProps.
     */
    vectorX?: XYZProps;
    /**
