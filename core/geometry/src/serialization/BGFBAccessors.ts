 ...
 */
static addEdgeMateIndex(builder: flatbuffers.Builder, edgeMateIndexOffset: flatbuffers.Offset) {
 ...
 * @returns flatbuffers.Offset
 */
static createEdgeMateIndexVector(builder: flatbuffers.Builder, data: number[] | Uint8Array): flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addInt32(data[i]);
  }
 ...
 * @param number numElems
 */
static startEdgeMateIndexVector(builder: flatbuffers.Builder, numElems: number) {
  builder.startVector(4, numElems, 4);
}
