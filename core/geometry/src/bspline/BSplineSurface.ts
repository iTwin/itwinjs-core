...
export enum UVSelect {
   ...
   * @deprecated in 4.x - will not be removed until 2026-06-13. Use vDirection instead.
   */
  VDirection = 1,
  /** index of v direction */
...
export abstract class BSpline2dNd extends GeometryQuery {
  ...
  */
  ...
  /**
   * sum poles by the weights in the basisBuffer, using poles for given span
   * @deprecated in 4.x - will not be removed until 2026-06-13. Use sumPoleBufferDerivativesForSpan instead.
   */
...
export class BSplineSurface3d extends BSpline2dNd implements BSplineSurface3dQuery, UVSurface {
  ...
  public getPointGridJSON(): PackedPointGrid {
    const result = {
      ...
      weighStyle: WeightStyle.WeightsAlreadyAppliedToCoordinates, // @deprecated in 4.x - will not be removed until 2026-06-13. Use weightStyle instead.
