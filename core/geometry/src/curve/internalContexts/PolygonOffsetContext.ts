...
export class OffsetOptions {
  ...
  /** Convert variant input into OffsetOptions. If OffsetOptions are input, a reference is returned. */
...
export class CurveChainWireOffsetContext {
  ...
  public static createSingleOffsetPrimitiveXY(g: CurvePrimitive, offsetDistance: number | OffsetOptions): CurvePrimitive | CurvePrimitive[] | undefined {
    ...
    } else {  // resort to running a B-spline through offset stroke points
      // START HERE:
    }
    return undefined;
  }
