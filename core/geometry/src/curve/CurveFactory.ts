...
export class CurveFactory {
  ...
  public static createMiteredPipeSections(centerline: IndexedXYZCollection, sectionData: number | XAndY | Arc3d): Arc3d[] {
    ...
    if (sectionData instanceof Arc3d) {
      ...
      // dotProduct is positive if and only if sectionData normal and startTangent lie in the same half-space
   ...
   * @param initialSection profile curve to be swept. As noted above, this should be on a plane perpendicular to the first segment
   *   of the centerline.
