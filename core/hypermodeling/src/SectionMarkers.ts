...
import type { BeButtonEvent, Cluster, DecorateContext, MarkerImage, ScreenViewport} from "@itwin/core-frontend";
import {
  BeButton, IModelApp, InputSource, Marker, MarkerSet, ViewClipTool,
