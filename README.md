...
- [Node](https://nodejs.org/en/): an installation of the latest security patch of Node.js. Supported releases are 12.x, 14.x, 16.x, and 18.x. The Node installation also includes the **npm** package manager.
